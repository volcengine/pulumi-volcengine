...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"volcengine_iam_policy_project":                               {Tok: resourceType(volcengineIamMod, "PolicyProject")},
			"volcengine_iam_security_config":                              {Tok: resourceType(volcengineIamMod, "SecurityConfig")},
			"volcengine_iam_allowed_ip_address":                           {Tok: resourceType(volcengineIamMod, "AllowedIpAddress")},
			...
			"volcengine_iam_oauth_provider":                               {Tok: resourceType(volcengineIamMod, "OauthProvider")},
			"volcengine_iam_oidc_provider_client":                         {Tok: resourceType(volcengineIamMod, "OidcProviderClient")},
			"volcengine_iam_service_linked_role":                          {Tok: resourceType(volcengineIamMod, "ServiceLinkedRole")},
			...
			"volcengine_iam_oidc_provider_thumbprint":                     {Tok: resourceType(volcengineIamMod, "OidcProviderThumbprint")},
			"volcengine_iam_tag":                                          {Tok: resourceType(volcengineIamMod, "Tag")},
			...
			"volcengine_iam_oidc_provider":                                {Tok: resourceType(volcengineIamMod, "OidcProvider")},
			...
			"volcengine_vpc_user_cidr_block_associate":                    {Tok: resourceType(volcengineVpcMod, "UserCidrBlockAssociate")},
			...
			"volcengine_rds_postgresql_instance_ssl":                      {Tok: resourceType(volcengineRdsPostgresqlMod, "InstanceSsl")},
			"volcengine_rds_postgresql_restore_backup":                    {Tok: resourceType(volcengineRdsPostgresqlMod, "RestoreBackup")},
			"volcengine_rds_postgresql_parameter_template":                {Tok: resourceType(volcengineRdsPostgresqlMod, "ParameterTemplate")},
			"volcengine_rds_postgresql_data_backup":                       {Tok: resourceType(volcengineRdsPostgresqlMod, "DataBackup")},
			"volcengine_rds_postgresql_schema":                            {Tok: resourceType(volcengineRdsPostgresqlMod, "Schema")},
			"volcengine_rds_postgresql_database_endpoint":                 {Tok: resourceType(volcengineRdsPostgresqlMod, "DatabaseEndpoint")},
			"volcengine_rds_postgresql_allowlist":                         {Tok: resourceType(volcengineRdsPostgresqlMod, "Allowlist")},
			"volcengine_rds_postgresql_allowlist_version_upgrade":         {Tok: resourceType(volcengineRdsPostgresqlMod, "AllowlistVersionUpgrade")},
			"volcengine_rds_postgresql_replication_slot":                  {Tok: resourceType(volcengineRdsPostgresqlMod, "ReplicationSlot")},
			"volcengine_rds_postgresql_instance":                          {Tok: resourceType(volcengineRdsPostgresqlMod, "Instance")},
			"volcengine_rds_postgresql_backup_policy":                     {Tok: resourceType(volcengineRdsPostgresqlMod, "BackupPolicy")},
			"volcengine_rds_postgresql_account":                           {Tok: resourceType(volcengineRdsPostgresqlMod, "Account")},
			"volcengine_rds_postgresql_backup_download":                   {Tok: resourceType(volcengineRdsPostgresqlMod, "BackupDownload")},
			"volcengine_rds_postgresql_instance_state":                    {Tok: resourceType(volcengineRdsPostgresqlMod, "State")},
			...
			"volcengine_rds_postgresql_endpoint_public_address":           {Tok: resourceType(volcengineRdsPostgresqlMod, "EndpointPublicAddress")},
			...
			"volcengine_nlb_network_load_balancer":                        {Tok: resourceType(volcengineNlbMod, "NetworkLoadBalancer")},
			"volcengine_nlb_backend_server":                               {Tok: resourceType(volcengineNlbMod, "BackendServer")},
			"volcengine_nlb_tag":                                          {Tok: resourceType(volcengineNlbMod, "Tag")},
			"volcengine_nlb_server_group":                                 {Tok: resourceType(volcengineNlbMod, "ServerGroup")},
			"volcengine_nlb_listener":                                     {Tok: resourceType(volcengineNlbMod, "Listener")},
			...
			"volcengine_health_check_log_project":                         {Tok: resourceType(volcengineClbMod, "HealthCheckLogProject")},
			"volcengine_clb_rule":                                         {Tok: resourceType(volcengineClbMod, "Rule")},
			"volcengine_access_log":                                       {Tok: resourceType(volcengineClbMod, "AccessLog")},
			...
			"volcengine_health_check_log_topic":                           {Tok: resourceType(volcengineClbMod, "HealthCheckLogTopic")},
			...
			"volcengine_tls_account":                                      {Tok: resourceType(volcengineTlsMod, "Account")},
			"volcengine_tls_rule_applier":                                 {Tok: resourceType(volcengineTlsMod, "RuleApplier")},
			"volcengine_tls_alarm_content_template":                       {Tok: resourceType(volcengineTlsMod, "AlarmContentTemplate")},
			...
			"volcengine_tls_alarm_webhook_integration":                    {Tok: resourceType(volcengineTlsMod, "AlarmWebhookIntegration")},
			"volcengine_tls_trace_instance":                               {Tok: resourceType(volcengineTlsMod, "TraceInstance")},
			"volcengine_tls_tag_resource":                                 {Tok: resourceType(volcengineTlsMod, "TagResource")},
			"volcengine_tls_rule_bound_host_group":                        {Tok: resourceType(volcengineTlsMod, "RuleBoundHostGroup")},
			"volcengine_tls_download_task":                                {Tok: resourceType(volcengineTlsMod, "DownloadTask")},
			...
			"volcengine_tls_shard":                                        {Tok: resourceType(volcengineTlsMod, "Shard")},
			"volcengine_tls_tag":                                          {Tok: resourceType(volcengineTlsMod, "Tag")},
			...
			"volcengine_tos_bucket_lifecycle":                             {Tok: resourceType(volcengineTosMod, "BucketLifecycle")},
			"volcengine_tos_bucket_transfer_acceleration":                 {Tok: resourceType(volcengineTosMod, "BucketTransferAcceleration")},
			"volcengine_tos_bucket_object_lock_configuration":             {Tok: resourceType(volcengineTosMod, "BucketObjectLockConfiguration")},
			"volcengine_tos_bucket_notification":                          {Tok: resourceType(volcengineTosMod, "BucketNotification")},
			"volcengine_tos_bucket":                                       {Tok: resourceType(volcengineTosMod, "Bucket")},
			"volcengine_tos_bucket_cors":                                  {Tok: resourceType(volcengineTosMod, "BucketCors")},
			"volcengine_tos_bucket_realtime_log":                          {Tok: resourceType(volcengineTosMod, "BucketRealtimeLog")},
			"volcengine_tos_bucket_encryption":                            {Tok: resourceType(volcengineTosMod, "BucketEncryption")},
			"volcengine_tos_bucket_logging":                               {Tok: resourceType(volcengineTosMod, "BucketLogging")},
			"volcengine_tos_bucket_customdomain":                          {Tok: resourceType(volcengineTosMod, "BucketCustomdomain")},
			"volcengine_tos_bucket_website":                               {Tok: resourceType(volcengineTosMod, "BucketWebsite")},
			"volcengine_tos_bucket_access_monitor":                        {Tok: resourceType(volcengineTosMod, "BucketAccessMonitor")},
			"volcengine_tos_bucket_request_payment":                       {Tok: resourceType(volcengineTosMod, "BucketRequestPayment")},
			"volcengine_tos_bucket_rename":                                {Tok: resourceType(volcengineTosMod, "BucketRename")},
			"volcengine_tos_bucket_mirror_back":                           {Tok: resourceType(volcengineTosMod, "BucketMirrorBack")},
			"volcengine_tos_bucket_inventory":                             {Tok: resourceType(volcengineTosMod, "BucketInventory")},
			"volcengine_tos_bucket_replication":                           {Tok: resourceType(volcengineTosMod, "BucketReplication")},
			...
			"volcengine_kms_asymmetric_signature":                         {Tok: resourceType(volcengineKmsMod, "AsymmetricSignature")},
			"volcengine_kms_secret_backup":                                {Tok: resourceType(volcengineKmsMod, "SecretBackup")},
			"volcengine_kms_key_primary_region":                           {Tok: resourceType(volcengineKmsMod, "KeyPrimaryRegion")},
			"volcengine_kms_keyring":                                      {Tok: resourceType(volcengineKmsMod, "Keyring")},
			"volcengine_kms_replicate_key":                                {Tok: resourceType(volcengineKmsMod, "ReplicateKey")},
			"volcengine_kms_asymmetric_ciphertext":                        {Tok: resourceType(volcengineKmsMod, "AsymmetricCiphertext")},
			"volcengine_kms_cancel_key_deletion":                          {Tok: resourceType(volcengineKmsMod, "CancelKeyDeletion")},
			"volcengine_kms_secret_rotate":                                {Tok: resourceType(volcengineKmsMod, "SecretRotate")},
			...
			"volcengine_kms_key_material":                                 {Tok: resourceType(volcengineKmsMod, "KeyMaterial")},
			"volcengine_kms_ciphertext":                                   {Tok: resourceType(volcengineKmsMod, "Ciphertext")},
			"volcengine_kms_secret":                                       {Tok: resourceType(volcengineKmsMod, "Secret")},
			"volcengine_kms_cancel_secret_deletion":                       {Tok: resourceType(volcengineKmsMod, "CancelSecretDeletion")},
			"volcengine_kms_secret_restore":                               {Tok: resourceType(volcengineKmsMod, "SecretRestore")},
			...
			"volcengine_kms_re_encrypt":                                   {Tok: resourceType(volcengineKmsMod, "ReEncrypt")},
			...
			"volcengine_privatelink_vpc_gateway_endpoint":                 {Tok: resourceType(volcenginePrivatelinkMod, "VpcGatewayEndpoint")},
			...
			"volcengine_vmp_silence_policy":                               {Tok: resourceType(volcengineVmpMod, "SilencePolicy")},
			"volcengine_vmp_contact_group":                                {Tok: resourceType(volcengineVmpMod, "ContactGroup")},
			"volcengine_vmp_alerting_rule_enable_disable":                 {Tok: resourceType(volcengineVmpMod, "AlertingRuleEnableDisable")},
			...
			"volcengine_vmp_silence_policy_enable_disable":                {Tok: resourceType(volcengineVmpMod, "SilencePolicyEnableDisable")},
			"volcengine_vmp_alerting_rule":                                {Tok: resourceType(volcengineVmpMod, "AlertingRule")},
			"volcengine_vmp_integration_task_enable":                      {Tok: resourceType(volcengineVmpMod, "IntegrationTaskEnable")},
			...
			"volcengine_vmp_integration_task":                             {Tok: resourceType(volcengineVmpMod, "IntegrationTask")},
			...
			"volcengine_alb_health_log":                                   {Tok: resourceType(volcengineAlbMod, "HealthLog")},
			...
			"volcengine_alb_access_log":                                   {Tok: resourceType(volcengineAlbMod, "AccessLog")},
			...
			"volcengine_alb_replace_certificate":                          {Tok: resourceType(volcengineAlbMod, "ReplaceCertificate")},
			"volcengine_alb_customized_cfg":                               {Tok: resourceType(volcengineAlbMod, "CustomizedCfg")},
			"volcengine_alb_tls_access_log":                               {Tok: resourceType(volcengineAlbMod, "TlsAccessLog")},
			...
			"volcengine_nat_ip":                                           {Tok: resourceType(volcengineNatMod, "Ip")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"volcengine_iam_identity_providers":                            {Tok: dataSourceType(volcengineIamMod, "IdentityProviders")},
			"volcengine_iam_security_configs":                              {Tok: dataSourceType(volcengineIamMod, "SecurityConfigs")},
			"volcengine_iam_allowed_ip_addresses":                          {Tok: dataSourceType(volcengineIamMod, "AllowedIpAddresses")},
			"volcengine_iam_users":                                         {Tok: dataSourceType(volcengineIamMod, "Users")},
			"volcengine_iam_account_summaries":                             {Tok: dataSourceType(volcengineIamMod, "AccountSummaries")},
			"volcengine_iam_user_groups":                                   {Tok: dataSourceType(volcengineIamMod, "UserGroups")},
			"volcengine_iam_oauth_providers":                               {Tok: dataSourceType(volcengineIamMod, "OauthProviders")},
			"volcengine_iam_login_profiles":                                {Tok: dataSourceType(volcengineIamMod, "LoginProfiles")},
			"volcengine_iam_user_policy_attachments":                       {Tok: dataSourceType(volcengineIamMod, "UserPolicyAttachments")},
			"volcengine_iam_roles":                                         {Tok: dataSourceType(volcengineIamMod, "Roles")},
			"volcengine_iam_tags":                                          {Tok: dataSourceType(volcengineIamMod, "Tags")},
			...
			"volcengine_iam_caller_identities":                             {Tok: dataSourceType(volcengineIamMod, "CallerIdentities")},
			"volcengine_iam_access_key_last_useds":                         {Tok: dataSourceType(volcengineIamMod, "AccessKeyLastUseds")},
			"volcengine_iam_entities_policies":                             {Tok: dataSourceType(volcengineIamMod, "EntitiesPolicies")},
			"volcengine_iam_oidc_providers":                                {Tok: dataSourceType(volcengineIamMod, "OidcProviders")},
			"volcengine_iam_saml_providers":                                {Tok: dataSourceType(volcengineIamMod, "SamlProviders")},
			"volcengine_iam_user_group_attachments":                        {Tok: dataSourceType(volcengineIamMod, "UserGroupAttachments")},
			"volcengine_iam_role_policy_attachments":                       {Tok: dataSourceType(volcengineIamMod, "RolePolicyAttachments")},
			"volcengine_iam_group_users":                                   {Tok: dataSourceType(volcengineIamMod, "GroupUsers")},
			...
			"volcengine_rds_postgresql_instance_ssls":                      {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceSsls")},
			"volcengine_rds_postgresql_regions":                            {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Regions")},
			"volcengine_rds_postgresql_instance_price_details":             {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstancePriceDetails")},
			"volcengine_rds_postgresql_parameter_templates":                {Tok: dataSourceType(volcengineRdsPostgresqlMod, "ParameterTemplates")},
			"volcengine_rds_postgresql_parameter_template_apply_diffs":     {Tok: dataSourceType(volcengineRdsPostgresqlMod, "ParameterTemplateApplyDiffs")},
			"volcengine_rds_postgresql_instance_parameters":                {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceParameters")},
			"volcengine_rds_postgresql_data_backups":                       {Tok: dataSourceType(volcengineRdsPostgresqlMod, "DataBackups")},
			"volcengine_rds_postgresql_schemas":                            {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Schemas")},
			"volcengine_rds_postgresql_instance_backup_wal_logs":           {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceBackupWalLogs")},
			"volcengine_rds_postgresql_zones":                              {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Zones")},
			"volcengine_rds_postgresql_database_endpoints":                 {Tok: dataSourceType(volcengineRdsPostgresqlMod, "DatabaseEndpoints")},
			"volcengine_rds_postgresql_allowlists":                         {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Allowlists")},
			"volcengine_rds_postgresql_replication_slots":                  {Tok: dataSourceType(volcengineRdsPostgresqlMod, "ReplicationSlots")},
			"volcengine_rds_postgresql_planned_events":                     {Tok: dataSourceType(volcengineRdsPostgresqlMod, "PlannedEvents")},
			"volcengine_rds_postgresql_instances":                          {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Instances")},
			"volcengine_rds_postgresql_backup_policys":                     {Tok: dataSourceType(volcengineRdsPostgresqlMod, "BackupPolicies")},
			"volcengine_rds_postgresql_accounts":                           {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Accounts")},
			"volcengine_rds_postgresql_instance_specs":                     {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceSpecs")},
			"volcengine_rds_postgresql_backup_downloads":                   {Tok: dataSourceType(volcengineRdsPostgresqlMod, "BackupDownloads")},
			"volcengine_rds_postgresql_instance_tasks":                     {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceTasks")},
			"volcengine_rds_postgresql_engine_version_parameters":          {Tok: dataSourceType(volcengineRdsPostgresqlMod, "EngineVersionParameters")},
			"volcengine_rds_postgresql_instance_backup_detacheds":          {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceBackupDetacheds")},
			"volcengine_rds_postgresql_instance_recoverable_times":         {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceRecoverableTimes")},
			"volcengine_rds_postgresql_databases":                          {Tok: dataSourceType(volcengineRdsPostgresqlMod, "Databases")},
			"volcengine_rds_postgresql_instance_parameter_logs":            {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceParameterLogs")},
			"volcengine_rds_postgresql_instance_price_differences":         {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstancePriceDifferences")},
			"volcengine_rds_postgresql_instance_failover_logs":             {Tok: dataSourceType(volcengineRdsPostgresqlMod, "InstanceFailoverLogs")},
			...
			"volcengine_nlb_network_load_balancers":                        {Tok: dataSourceType(volcengineNlbMod, "NetworkLoadBalancers")},
			"volcengine_nlb_tags":                                          {Tok: dataSourceType(volcengineNlbMod, "Tags")},
			"volcengine_nlb_server_group_attributes":                       {Tok: dataSourceType(volcengineNlbMod, "ServerGroupAttributes")},
			"volcengine_nlb_network_load_balancer_attributes":              {Tok: dataSourceType(volcengineNlbMod, "NetworkLoadBalancerAttributes")},
			"volcengine_nlb_server_groups":                                 {Tok: dataSourceType(volcengineNlbMod, "ServerGroups")},
			"volcengine_nlb_listeners":                                     {Tok: dataSourceType(volcengineNlbMod, "Listeners")},
			"volcengine_nlb_zones":                                         {Tok: dataSourceType(volcengineNlbMod, "Zones")},
			"volcengine_nlb_listener_healths":                              {Tok: dataSourceType(volcengineNlbMod, "ListenerHealths")},
			...
			"volcengine_health_check_log_projects":                         {Tok: dataSourceType(volcengineClbMod, "HealthCheckLogProjects")},
			...
			"volcengine_listener_healths":                                  {Tok: dataSourceType(volcengineClbMod, "ListenerHealths")},
			...
			"volcengine_health_check_log_topics":                           {Tok: dataSourceType(volcengineClbMod, "HealthCheckLogTopics")},
			...
			"volcengine_tls_accounts":                                      {Tok: dataSourceType(volcengineTlsMod, "Accounts")},
			"volcengine_tls_rule_appliers":                                 {Tok: dataSourceType(volcengineTlsMod, "RuleAppliers")},
			"volcengine_tls_log_cursors":                                   {Tok: dataSourceType(volcengineTlsMod, "LogCursors")},
			"volcengine_tls_host_group_rules":                              {Tok: dataSourceType(volcengineTlsMod, "HostGroupRules")},
			"volcengine_tls_alarm_content_templates":                       {Tok: dataSourceType(volcengineTlsMod, "AlarmContentTemplates")},
			...
			"volcengine_tls_log_searches":                                  {Tok: dataSourceType(volcengineTlsMod, "LogSearches")},
			"volcengine_tls_alarm_webhook_integrations":                    {Tok: dataSourceType(volcengineTlsMod, "AlarmWebhookIntegrations")},
			"volcengine_tls_trace_instances":                               {Tok: dataSourceType(volcengineTlsMod, "TraceInstances")},
			"volcengine_tls_tag_resources":                                 {Tok: dataSourceType(volcengineTlsMod, "TagResources")},
			"volcengine_tls_rule_bound_host_groups":                        {Tok: dataSourceType(volcengineTlsMod, "RuleBoundHostGroups")},
			"volcengine_tls_download_tasks":                                {Tok: dataSourceType(volcengineTlsMod, "DownloadTasks")},
			"volcengine_tls_kafka_consumers":                               {Tok: dataSourceType(volcengineTlsMod, "KafkaConsumers")},
			"volcengine_tls_describe_traces":                               {Tok: dataSourceType(volcengineTlsMod, "DescribeTraces")},
			"volcengine_tls_check_points":                                  {Tok: dataSourceType(volcengineTlsMod, "CheckPoints")},
			"volcengine_tls_consumer_groups":                               {Tok: dataSourceType(volcengineTlsMod, "ConsumerGroups")},
			"volcengine_tls_search_traces":                                 {Tok: dataSourceType(volcengineTlsMod, "SearchTraces")},
			"volcengine_tls_log_contexts":                                  {Tok: dataSourceType(volcengineTlsMod, "LogContexts")},
			"volcengine_tls_schedule_sql_tasks":                            {Tok: dataSourceType(volcengineTlsMod, "ScheduleSqlTasks")},
			"volcengine_tls_download_urls":                                 {Tok: dataSourceType(volcengineTlsMod, "DownloadUrls")},
			"volcengine_tls_log_histograms":                                {Tok: dataSourceType(volcengineTlsMod, "LogHistograms")},
			...
			"volcengine_tls_tags":                                          {Tok: dataSourceType(volcengineTlsMod, "Tags")},
			...
			"volcengine_kms_macs":                                          {Tok: dataSourceType(volcengineKmsMod, "Macs")},
			"volcengine_kms_asymmetric_signatures":                         {Tok: dataSourceType(volcengineKmsMod, "AsymmetricSignatures")},
			"volcengine_kms_mac_verifications":                             {Tok: dataSourceType(volcengineKmsMod, "MacVerifications")},
			"volcengine_kms_regions":                                       {Tok: dataSourceType(volcengineKmsMod, "Regions")},
			"volcengine_kms_secret_versions":                               {Tok: dataSourceType(volcengineKmsMod, "SecretVersions")},
			"volcengine_kms_keyrings":                                      {Tok: dataSourceType(volcengineKmsMod, "Keyrings")},
			"volcengine_kms_asymmetric_ciphertexts":                        {Tok: dataSourceType(volcengineKmsMod, "AsymmetricCiphertexts")},
			"volcengine_kms_public_keys":                                   {Tok: dataSourceType(volcengineKmsMod, "PublicKeys")},
			"volcengine_kms_keys":                                          {Tok: dataSourceType(volcengineKmsMod, "Keys")},
			"volcengine_kms_key_materials":                                 {Tok: dataSourceType(volcengineKmsMod, "KeyMaterials")},
			"volcengine_kms_asymmetric_plaintexts":                         {Tok: dataSourceType(volcengineKmsMod, "AsymmetricPlaintexts")},
			"volcengine_kms_ciphertexts":                                   {Tok: dataSourceType(volcengineKmsMod, "Ciphertexts")},
			"volcengine_kms_secrets":                                       {Tok: dataSourceType(volcengineKmsMod, "Secrets")},
			"volcengine_kms_plaintexts":                                    {Tok: dataSourceType(volcengineKmsMod, "Plaintexts")},
			"volcengine_kms_re_encrypts":                                   {Tok: dataSourceType(volcengineKmsMod, "ReEncrypts")},
			"volcengine_kms_data_keys":                                     {Tok: dataSourceType(volcengineKmsMod, "DataKeys")},
			"volcengine_kms_asymmetric_verifications":                      {Tok: dataSourceType(volcengineKmsMod, "AsymmetricVerifications")},
			...
			"volcengine_privatelink_vpc_gateway_endpoints":                 {Tok: dataSourceType(volcenginePrivatelinkMod, "VpcGatewayEndpoints")},
			...
			"volcengine_vmp_silence_policies":                              {Tok: dataSourceType(volcengineVmpMod, "SilencePolicies")},
			"volcengine_vmp_contact_groups":                                {Tok: dataSourceType(volcengineVmpMod, "ContactGroups")},
			"volcengine_vmp_alert_samples":                                 {Tok: dataSourceType(volcengineVmpMod, "AlertSamples")},
			...
			"volcengine_vmp_integration_tasks":                             {Tok: dataSourceType(volcengineVmpMod, "IntegrationTasks")},
			...
			"volcengine_alb_listener_healths":                              {Tok: dataSourceType(volcengineAlbMod, "ListenerHealths")},
			...
			"volcengine_alb_all_certificates":                              {Tok: dataSourceType(volcengineAlbMod, "AllCertificates")},
			...
			"volcengine_nat_ips":                                           {Tok: dataSourceType(volcengineNatMod, "Ips")},
	...
	prov.RenameDataSource("volcengine_iam_identity_providers", dataSourceType(volcengineIamMod, "IdentityProviders"),
		dataSourceType(volcengineIamMod, "getIdentityProviders"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_security_configs", dataSourceType(volcengineIamMod, "SecurityConfigs"),
		dataSourceType(volcengineIamMod, "getSecurityConfigs"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_allowed_ip_addresses", dataSourceType(volcengineIamMod, "AllowedIpAddresses"),
		dataSourceType(volcengineIamMod, "getAllowedIpAddresses"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_iam_account_summaries", dataSourceType(volcengineIamMod, "AccountSummaries"),
		dataSourceType(volcengineIamMod, "getAccountSummaries"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_iam_oauth_providers", dataSourceType(volcengineIamMod, "OauthProviders"),
		dataSourceType(volcengineIamMod, "getOauthProviders"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_login_profiles", dataSourceType(volcengineIamMod, "LoginProfiles"),
		dataSourceType(volcengineIamMod, "getLoginProfiles"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_user_policy_attachments", dataSourceType(volcengineIamMod, "UserPolicyAttachments"),
		dataSourceType(volcengineIamMod, "getUserPolicyAttachments"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_iam_tags", dataSourceType(volcengineIamMod, "Tags"),
		dataSourceType(volcengineIamMod, "getTags"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_iam_caller_identities", dataSourceType(volcengineIamMod, "CallerIdentities"),
		dataSourceType(volcengineIamMod, "getCallerIdentities"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_access_key_last_useds", dataSourceType(volcengineIamMod, "AccessKeyLastUseds"),
		dataSourceType(volcengineIamMod, "getAccessKeyLastUseds"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_entities_policies", dataSourceType(volcengineIamMod, "EntitiesPolicies"),
		dataSourceType(volcengineIamMod, "getEntitiesPolicies"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_oidc_providers", dataSourceType(volcengineIamMod, "OidcProviders"),
		dataSourceType(volcengineIamMod, "getOidcProviders"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_iam_user_group_attachments", dataSourceType(volcengineIamMod, "UserGroupAttachments"),
		dataSourceType(volcengineIamMod, "getUserGroupAttachments"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_role_policy_attachments", dataSourceType(volcengineIamMod, "RolePolicyAttachments"),
		dataSourceType(volcengineIamMod, "getRolePolicyAttachments"), volcengineIamMod, volcengineIamMod, nil)
	prov.RenameDataSource("volcengine_iam_group_users", dataSourceType(volcengineIamMod, "GroupUsers"),
		dataSourceType(volcengineIamMod, "getGroupUsers"), volcengineIamMod, volcengineIamMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_instance_ssls", dataSourceType(volcengineRdsPostgresqlMod, "InstanceSsls"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceSsls"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_regions", dataSourceType(volcengineRdsPostgresqlMod, "Regions"),
		dataSourceType(volcengineRdsPostgresqlMod, "getRegions"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_price_details", dataSourceType(volcengineRdsPostgresqlMod, "InstancePriceDetails"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstancePriceDetails"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_parameter_templates", dataSourceType(volcengineRdsPostgresqlMod, "ParameterTemplates"),
		dataSourceType(volcengineRdsPostgresqlMod, "getParameterTemplates"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_parameter_template_apply_diffs", dataSourceType(volcengineRdsPostgresqlMod, "ParameterTemplateApplyDiffs"),
		dataSourceType(volcengineRdsPostgresqlMod, "getParameterTemplateApplyDiffs"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_parameters", dataSourceType(volcengineRdsPostgresqlMod, "InstanceParameters"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceParameters"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_data_backups", dataSourceType(volcengineRdsPostgresqlMod, "DataBackups"),
		dataSourceType(volcengineRdsPostgresqlMod, "getDataBackups"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_instance_backup_wal_logs", dataSourceType(volcengineRdsPostgresqlMod, "InstanceBackupWalLogs"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceBackupWalLogs"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_zones", dataSourceType(volcengineRdsPostgresqlMod, "Zones"),
		dataSourceType(volcengineRdsPostgresqlMod, "getZones"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_database_endpoints", dataSourceType(volcengineRdsPostgresqlMod, "DatabaseEndpoints"),
		dataSourceType(volcengineRdsPostgresqlMod, "getDatabaseEndpoints"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_replication_slots", dataSourceType(volcengineRdsPostgresqlMod, "ReplicationSlots"),
		dataSourceType(volcengineRdsPostgresqlMod, "getReplicationSlots"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_planned_events", dataSourceType(volcengineRdsPostgresqlMod, "PlannedEvents"),
		dataSourceType(volcengineRdsPostgresqlMod, "getPlannedEvents"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_backup_policys", dataSourceType(volcengineRdsPostgresqlMod, "BackupPolicies"),
		dataSourceType(volcengineRdsPostgresqlMod, "getBackupPolicies"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_instance_specs", dataSourceType(volcengineRdsPostgresqlMod, "InstanceSpecs"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceSpecs"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_backup_downloads", dataSourceType(volcengineRdsPostgresqlMod, "BackupDownloads"),
		dataSourceType(volcengineRdsPostgresqlMod, "getBackupDownloads"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_tasks", dataSourceType(volcengineRdsPostgresqlMod, "InstanceTasks"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceTasks"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_engine_version_parameters", dataSourceType(volcengineRdsPostgresqlMod, "EngineVersionParameters"),
		dataSourceType(volcengineRdsPostgresqlMod, "getEngineVersionParameters"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_backup_detacheds", dataSourceType(volcengineRdsPostgresqlMod, "InstanceBackupDetacheds"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceBackupDetacheds"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_recoverable_times", dataSourceType(volcengineRdsPostgresqlMod, "InstanceRecoverableTimes"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceRecoverableTimes"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_rds_postgresql_instance_parameter_logs", dataSourceType(volcengineRdsPostgresqlMod, "InstanceParameterLogs"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceParameterLogs"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_price_differences", dataSourceType(volcengineRdsPostgresqlMod, "InstancePriceDifferences"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstancePriceDifferences"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	prov.RenameDataSource("volcengine_rds_postgresql_instance_failover_logs", dataSourceType(volcengineRdsPostgresqlMod, "InstanceFailoverLogs"),
		dataSourceType(volcengineRdsPostgresqlMod, "getInstanceFailoverLogs"), volcengineRdsPostgresqlMod, volcengineRdsPostgresqlMod, nil)
	...
	prov.RenameDataSource("volcengine_nlb_network_load_balancers", dataSourceType(volcengineNlbMod, "NetworkLoadBalancers"),
		dataSourceType(volcengineNlbMod, "getNetworkLoadBalancers"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_tags", dataSourceType(volcengineNlbMod, "Tags"),
		dataSourceType(volcengineNlbMod, "getTags"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_server_group_attributes", dataSourceType(volcengineNlbMod, "ServerGroupAttributes"),
		dataSourceType(volcengineNlbMod, "getServerGroupAttributes"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_network_load_balancer_attributes", dataSourceType(volcengineNlbMod, "NetworkLoadBalancerAttributes"),
		dataSourceType(volcengineNlbMod, "getNetworkLoadBalancerAttributes"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_server_groups", dataSourceType(volcengineNlbMod, "ServerGroups"),
		dataSourceType(volcengineNlbMod, "getServerGroups"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_listeners", dataSourceType(volcengineNlbMod, "Listeners"),
		dataSourceType(volcengineNlbMod, "getListeners"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_zones", dataSourceType(volcengineNlbMod, "Zones"),
		dataSourceType(volcengineNlbMod, "getZones"), volcengineNlbMod, volcengineNlbMod, nil)
	prov.RenameDataSource("volcengine_nlb_listener_healths", dataSourceType(volcengineNlbMod, "ListenerHealths"),
		dataSourceType(volcengineNlbMod, "getListenerHealths"), volcengineNlbMod, volcengineNlbMod, nil)
	...
	prov.RenameDataSource("volcengine_health_check_log_projects", dataSourceType(volcengineClbMod, "HealthCheckLogProjects"),
		dataSourceType(volcengineClbMod, "getHealthCheckLogProjects"), volcengineClbMod, volcengineClbMod, nil)
	...
	prov.RenameDataSource("volcengine_listener_healths", dataSourceType(volcengineClbMod, "ListenerHealths"),
		dataSourceType(volcengineClbMod, "getListenerHealths"), volcengineClbMod, volcengineClbMod, nil)
	...
	prov.RenameDataSource("volcengine_health_check_log_topics", dataSourceType(volcengineClbMod, "HealthCheckLogTopics"),
		dataSourceType(volcengineClbMod, "getHealthCheckLogTopics"), volcengineClbMod, volcengineClbMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_accounts", dataSourceType(volcengineTlsMod, "Accounts"),
		dataSourceType(volcengineTlsMod, "getAccounts"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_log_cursors", dataSourceType(volcengineTlsMod, "LogCursors"),
		dataSourceType(volcengineTlsMod, "getLogCursors"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_host_group_rules", dataSourceType(volcengineTlsMod, "HostGroupRules"),
		dataSourceType(volcengineTlsMod, "getHostGroupRules"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_alarm_content_templates", dataSourceType(volcengineTlsMod, "AlarmContentTemplates"),
		dataSourceType(volcengineTlsMod, "getAlarmContentTemplates"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_log_searches", dataSourceType(volcengineTlsMod, "LogSearches"),
		dataSourceType(volcengineTlsMod, "getLogSearches"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_alarm_webhook_integrations", dataSourceType(volcengineTlsMod, "AlarmWebhookIntegrations"),
		dataSourceType(volcengineTlsMod, "getAlarmWebhookIntegrations"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_trace_instances", dataSourceType(volcengineTlsMod, "TraceInstances"),
		dataSourceType(volcengineTlsMod, "getTraceInstances"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_tag_resources", dataSourceType(volcengineTlsMod, "TagResources"),
		dataSourceType(volcengineTlsMod, "getTagResources"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_rule_bound_host_groups", dataSourceType(volcengineTlsMod, "RuleBoundHostGroups"),
		dataSourceType(volcengineTlsMod, "getRuleBoundHostGroups"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_download_tasks", dataSourceType(volcengineTlsMod, "DownloadTasks"),
		dataSourceType(volcengineTlsMod, "getDownloadTasks"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_describe_traces", dataSourceType(volcengineTlsMod, "DescribeTraces"),
		dataSourceType(volcengineTlsMod, "getDescribeTraces"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_check_points", dataSourceType(volcengineTlsMod, "CheckPoints"),
		dataSourceType(volcengineTlsMod, "getCheckPoints"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_search_traces", dataSourceType(volcengineTlsMod, "SearchTraces"),
		dataSourceType(volcengineTlsMod, "getSearchTraces"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_log_contexts", dataSourceType(volcengineTlsMod, "LogContexts"),
		dataSourceType(volcengineTlsMod, "getLogContexts"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_download_urls", dataSourceType(volcengineTlsMod, "DownloadUrls"),
		dataSourceType(volcengineTlsMod, "getDownloadUrls"), volcengineTlsMod, volcengineTlsMod, nil)
	prov.RenameDataSource("volcengine_tls_log_histograms", dataSourceType(volcengineTlsMod, "LogHistograms"),
		dataSourceType(volcengineTlsMod, "getLogHistograms"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_tls_tags", dataSourceType(volcengineTlsMod, "Tags"),
		dataSourceType(volcengineTlsMod, "getTags"), volcengineTlsMod, volcengineTlsMod, nil)
	...
	prov.RenameDataSource("volcengine_kms_macs", dataSourceType(volcengineKmsMod, "Macs"),
		dataSourceType(volcengineKmsMod, "getMacs"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_asymmetric_signatures", dataSourceType(volcengineKmsMod, "AsymmetricSignatures"),
		dataSourceType(volcengineKmsMod, "getAsymmetricSignatures"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_mac_verifications", dataSourceType(volcengineKmsMod, "MacVerifications"),
		dataSourceType(volcengineKmsMod, "getMacVerifications"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_regions", dataSourceType(volcengineKmsMod, "Regions"),
		dataSourceType(volcengineKmsMod, "getRegions"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_secret_versions", dataSourceType(volcengineKmsMod, "SecretVersions"),
		dataSourceType(volcengineKmsMod, "getSecretVersions"), volcengineKmsMod, volcengineKmsMod, nil)
	...
	prov.RenameDataSource("volcengine_kms_asymmetric_ciphertexts", dataSourceType(volcengineKmsMod, "AsymmetricCiphertexts"),
		dataSourceType(volcengineKmsMod, "getAsymmetricCiphertexts"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_public_keys", dataSourceType(volcengineKmsMod, "PublicKeys"),
		dataSourceType(volcengineKmsMod, "getPublicKeys"), volcengineKmsMod, volcengineKmsMod, nil)
	...
	prov.RenameDataSource("volcengine_kms_key_materials", dataSourceType(volcengineKmsMod, "KeyMaterials"),
		dataSourceType(volcengineKmsMod, "getKeyMaterials"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_asymmetric_plaintexts", dataSourceType(volcengineKmsMod, "AsymmetricPlaintexts"),
		dataSourceType(volcengineKmsMod, "getAsymmetricPlaintexts"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_ciphertexts", dataSourceType(volcengineKmsMod, "Ciphertexts"),
		dataSourceType(volcengineKmsMod, "getCiphertexts"), volcengineKmsMod, volcengineKmsMod, nil)
	...
	prov.RenameDataSource("volcengine_kms_plaintexts", dataSourceType(volcengineKmsMod, "Plaintexts"),
		dataSourceType(volcengineKmsMod, "getPlaintexts"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_re_encrypts", dataSourceType(volcengineKmsMod, "ReEncrypts"),
		dataSourceType(volcengineKmsMod, "getReEncrypts"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_data_keys", dataSourceType(volcengineKmsMod, "DataKeys"),
		dataSourceType(volcengineKmsMod, "getDataKeys"), volcengineKmsMod, volcengineKmsMod, nil)
	prov.RenameDataSource("volcengine_kms_asymmetric_verifications", dataSourceType(volcengineKmsMod, "AsymmetricVerifications"),
		dataSourceType(volcengineKmsMod, "getAsymmetricVerifications"), volcengineKmsMod, volcengineKmsMod, nil)
	...
	prov.RenameDataSource("volcengine_privatelink_vpc_gateway_endpoints", dataSourceType(volcenginePrivatelinkMod, "VpcGatewayEndpoints"),
		dataSourceType(volcenginePrivatelinkMod, "getVpcGatewayEndpoints"), volcenginePrivatelinkMod, volcenginePrivatelinkMod, nil)
	...
	prov.RenameDataSource("volcengine_vmp_silence_policies", dataSourceType(volcengineVmpMod, "SilencePolicies"),
		dataSourceType(volcengineVmpMod, "getSilencePolicies"), volcengineVmpMod, volcengineVmpMod, nil)
	...
	prov.RenameDataSource("volcengine_vmp_alert_samples", dataSourceType(volcengineVmpMod, "AlertSamples"),
		dataSourceType(volcengineVmpMod, "getAlertSamples"), volcengineVmpMod, volcengineVmpMod, nil)
	...
	prov.RenameDataSource("volcengine_vmp_integration_tasks", dataSourceType(volcengineVmpMod, "IntegrationTasks"),
		dataSourceType(volcengineVmpMod, "getIntegrationTasks"), volcengineVmpMod, volcengineVmpMod, nil)
	...
	prov.RenameDataSource("volcengine_alb_listener_healths", dataSourceType(volcengineAlbMod, "ListenerHealths"),
		dataSourceType(volcengineAlbMod, "getListenerHealths"), volcengineAlbMod, volcengineAlbMod, nil)
	...
	prov.RenameDataSource("volcengine_alb_all_certificates", dataSourceType(volcengineAlbMod, "AllCertificates"),
		dataSourceType(volcengineAlbMod, "getAllCertificates"), volcengineAlbMod, volcengineAlbMod, nil)
	...
	prov.RenameDataSource("volcengine_nat_ips", dataSourceType(volcengineNatMod, "Ips"),
		dataSourceType(volcengineNatMod, "getIps"), volcengineNatMod, volcengineNatMod, nil)
