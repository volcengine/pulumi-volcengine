...
func NewBucketObjectLockConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:tos/bucketObjectLockConfiguration:BucketObjectLockConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketObjectLockConfiguration(ctx *pulumi.Context,
	...
	var resource BucketObjectLockConfiguration
	err := ctx.ReadResource("volcengine:tos/bucketObjectLockConfiguration:BucketObjectLockConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The name of the TOS bucket.
func (o BucketObjectLockConfigurationOutput) BucketName() pulumi.StringOutput {
	return o.ApplyT(func(v *BucketObjectLockConfiguration) pulumi.StringOutput { return v.BucketName }).(pulumi.StringOutput)
}
