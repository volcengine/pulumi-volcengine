...
func NewServerGroupServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:alb/serverGroupServer:ServerGroupServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerGroupServer(ctx *pulumi.Context,
	...
	var resource ServerGroupServer
	err := ctx.ReadResource("volcengine:alb/serverGroupServer:ServerGroupServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
