...
func Regions(ctx *pulumi.Context, args *RegionsArgs, opts ...pulumi.InvokeOption) (*RegionsResult, error) {
	...
	err := ctx.Invoke("volcengine:ecs/regions:Regions", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o RegionsResultOutput) Ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v RegionsResult) []string { return v.Ids }).(pulumi.StringArrayOutput)
}
