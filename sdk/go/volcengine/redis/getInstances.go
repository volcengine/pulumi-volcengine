...
func GetInstances(ctx *pulumi.Context, args *GetInstancesArgs, opts ...pulumi.InvokeOption) (*GetInstancesResult, error) {
	...
	err := ctx.Invoke("volcengine:redis/getInstances:getInstances", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// Whether enable sharded cluster for the redis instance.
func (o GetInstancesResultOutput) ShardedCluster() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetInstancesResult) *int { return v.ShardedCluster }).(pulumi.IntPtrOutput)
}
