...
func NewRouteTablePropagation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:transit_router/routeTablePropagation:RouteTablePropagation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTablePropagation(ctx *pulumi.Context,
	...
	var resource RouteTablePropagation
	err := ctx.ReadResource("volcengine:transit_router/routeTablePropagation:RouteTablePropagation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
