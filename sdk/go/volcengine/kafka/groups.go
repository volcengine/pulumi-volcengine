...
type GroupsOutputArgs struct {
	...
	// Tags.
	Tags GroupsTagArrayInput `pulumi:"tags"`
}
...
// Tags.
func (o GroupsResultOutput) Tags() GroupsTagArrayOutput {
	return o.ApplyT(func(v GroupsResult) []GroupsTag { return v.Tags }).(GroupsTagArrayOutput)
}
