...
func NewGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:direct_connect/gateway:Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("volcengine:direct_connect/gateway:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o GatewayOutput) DirectConnectGatewayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Gateway) pulumi.StringPtrOutput { return v.DirectConnectGatewayName }).(pulumi.StringPtrOutput)
}
