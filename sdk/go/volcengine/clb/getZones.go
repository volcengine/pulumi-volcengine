...
func GetZones(ctx *pulumi.Context, args *GetZonesArgs, opts ...pulumi.InvokeOption) (*GetZonesResult, error) {
	...
	err := ctx.Invoke("volcengine:clb/getZones:getZones", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetZonesResult struct {
	...
	MasterZones []GetZonesMasterZone `pulumi:"masterZones"`
	OutputFile  *string              `pulumi:"outputFile"`
...
// The master zones list.
func (o GetZonesResultOutput) MasterZones() GetZonesMasterZoneArrayOutput {
	return o.ApplyT(func(v GetZonesResult) []GetZonesMasterZone { return v.MasterZones }).(GetZonesMasterZoneArrayOutput)
}
