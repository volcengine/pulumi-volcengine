...
func FileSystems(ctx *pulumi.Context, args *FileSystemsArgs, opts ...pulumi.InvokeOption) (*FileSystemsResult, error) {
	...
	err := ctx.Invoke("volcengine:vepfs/fileSystems:FileSystems", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The project name of the vepfs file system.
func (o FileSystemsResultOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileSystemsResult) *string { return v.Project }).(pulumi.StringPtrOutput)
}
...
// The store type of the vepfs file system.
func (o FileSystemsResultOutput) StoreType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FileSystemsResult) *string { return v.StoreType }).(pulumi.StringPtrOutput)
}
