...
func NewAllowlistAssociate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:vedb_mysql/allowlistAssociate:AllowlistAssociate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowlistAssociate(ctx *pulumi.Context,
	...
	var resource AllowlistAssociate
	err := ctx.ReadResource("volcengine:vedb_mysql/allowlistAssociate:AllowlistAssociate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
