...
func NewAllowlist(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:vedb_mysql/allowlist:Allowlist", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowlist(ctx *pulumi.Context,
	...
	var resource Allowlist
	err := ctx.ReadResource("volcengine:vedb_mysql/allowlist:Allowlist", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
