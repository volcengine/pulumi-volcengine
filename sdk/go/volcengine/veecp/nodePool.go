...
func NewNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:veecp/nodePool:NodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodePool(ctx *pulumi.Context,
	...
	var resource NodePool
	err := ctx.ReadResource("volcengine:veecp/nodePool:NodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
