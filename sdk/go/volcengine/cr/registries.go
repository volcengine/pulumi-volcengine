...
// Tags.
func (o RegistriesResultOutput) ResourceTags() RegistriesResourceTagArrayOutput {
	return o.ApplyT(func(v RegistriesResult) []RegistriesResourceTag { return v.ResourceTags }).(RegistriesResourceTagArrayOutput)
}
