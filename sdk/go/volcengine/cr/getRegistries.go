...
func (o GetRegistriesResultOutput) Projects() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetRegistriesResult) []string { return v.Projects }).(pulumi.StringArrayOutput)
}
