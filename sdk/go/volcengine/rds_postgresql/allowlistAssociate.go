...
func NewAllowlistAssociate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:rds_postgresql/allowlistAssociate:AllowlistAssociate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowlistAssociate(ctx *pulumi.Context,
	...
	var resource AllowlistAssociate
	err := ctx.ReadResource("volcengine:rds_postgresql/allowlistAssociate:AllowlistAssociate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
