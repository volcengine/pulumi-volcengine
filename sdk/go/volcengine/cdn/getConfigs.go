...
func GetConfigs(ctx *pulumi.Context, args *GetConfigsArgs, opts ...pulumi.InvokeOption) (*GetConfigsResult, error) {
	...
	err := ctx.Invoke("volcengine:cdn/getConfigs:getConfigs", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetConfigsResult struct {
	...
	DomainConfigs []GetConfigsDomainConfig `pulumi:"domainConfigs"`
...
// The domain name.
func (o GetConfigsResultOutput) Domain() pulumi.StringOutput {
	return o.ApplyT(func(v GetConfigsResult) string { return v.Domain }).(pulumi.StringOutput)
}

// The collection of query.
func (o GetConfigsResultOutput) DomainConfigs() GetConfigsDomainConfigArrayOutput {
	return o.ApplyT(func(v GetConfigsResult) []GetConfigsDomainConfig { return v.DomainConfigs }).(GetConfigsDomainConfigArrayOutput)
}
...
// The total count of query.
func (o GetConfigsResultOutput) TotalCount() pulumi.IntOutput {
	return o.ApplyT(func(v GetConfigsResult) int { return v.TotalCount }).(pulumi.IntOutput)
}
