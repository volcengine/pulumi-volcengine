...
func NewAclEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:Vpc/aclEntry:AclEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAclEntry(ctx *pulumi.Context,
	...
	var resource AclEntry
	err := ctx.ReadResource("volcengine:Vpc/aclEntry:AclEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
