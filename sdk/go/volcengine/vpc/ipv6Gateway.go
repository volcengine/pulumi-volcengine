...
func GetIpv6Gateway(ctx *pulumi.Context,
	...
	var resource Ipv6Gateway
	err := ctx.ReadResource("volcengine:vpc/ipv6Gateway:Ipv6Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o Ipv6GatewayOutput) CreationTime() pulumi.StringOutput {
	return o.ApplyT(func(v *Ipv6Gateway) pulumi.StringOutput { return v.CreationTime }).(pulumi.StringOutput)
}
...
func (o Ipv6GatewayOutput) UpdateTime() pulumi.StringOutput {
	return o.ApplyT(func(v *Ipv6Gateway) pulumi.StringOutput { return v.UpdateTime }).(pulumi.StringOutput)
}
