...
type RuleAppliersResult struct {
	...
	HostGroupInfos []RuleAppliersHostGroupInfo `pulumi:"hostGroupInfos"`
...
// The host group info list.
func (o RuleAppliersResultOutput) HostGroupInfos() RuleAppliersHostGroupInfoArrayOutput {
	return o.ApplyT(func(v RuleAppliersResult) []RuleAppliersHostGroupInfo { return v.HostGroupInfos }).(RuleAppliersHostGroupInfoArrayOutput)
}
...
func (o RuleAppliersResultOutput) RuleId() pulumi.StringOutput {
	return o.ApplyT(func(v RuleAppliersResult) string { return v.RuleId }).(pulumi.StringOutput)
}
