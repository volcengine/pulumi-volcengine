...
// The project name of vpc endpoint.
func (o VpcEndpointOutput) ProjectName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VpcEndpoint) pulumi.StringPtrOutput { return v.ProjectName }).(pulumi.StringPtrOutput)
}
