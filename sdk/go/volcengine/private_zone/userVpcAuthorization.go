...
func NewUserVpcAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcengine:private_zone/userVpcAuthorization:UserVpcAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserVpcAuthorization(ctx *pulumi.Context,
	...
	var resource UserVpcAuthorization
	err := ctx.ReadResource("volcengine:private_zone/userVpcAuthorization:UserVpcAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
