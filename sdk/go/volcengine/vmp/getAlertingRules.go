...
//
// ```
func GetAlertingRules(ctx *pulumi.Context, args *GetAlertingRulesArgs, opts ...pulumi.InvokeOption) (*GetAlertingRulesResult, error) {
	opts = internal.PkgInvokeDefaultOpts(opts)
	var rv GetAlertingRulesResult
	err := ctx.Invoke("volcengine:vmp/getAlertingRules:getAlertingRules", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetAlertingRulesArgs struct {
...
type GetAlertingRulesResult struct {
	...
	AlertingRules []GetAlertingRulesAlertingRule `pulumi:"alertingRules"`
...
func GetAlertingRulesOutput(ctx *pulumi.Context, args GetAlertingRulesOutputArgs, opts ...pulumi.InvokeOption) GetAlertingRulesResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetAlertingRulesResult, error) {
			args := v.(GetAlertingRulesArgs)
			r, err := GetAlertingRules(ctx, &args, opts...)
			var s GetAlertingRulesResult
			if r != nil {
				s = *r
			}
			return s, err
...
// A collection of arguments for invoking getAlertingRules.
type GetAlertingRulesOutputArgs struct {
	// A list of vmp alerting rule IDs.
...
func (GetAlertingRulesOutputArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetAlertingRulesArgs)(nil)).Elem()
}
...
// The collection of query.
func (o GetAlertingRulesResultOutput) AlertingRules() GetAlertingRulesAlertingRuleArrayOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) []GetAlertingRulesAlertingRule { return v.AlertingRules }).(GetAlertingRulesAlertingRuleArrayOutput)
}
...
// The name of the vmp alerting rule.
func (o GetAlertingRulesResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}

func (o GetAlertingRulesResultOutput) NameRegex() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) *string { return v.NameRegex }).(pulumi.StringPtrOutput)
}

func (o GetAlertingRulesResultOutput) NotifyGroupPolicyIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) []string { return v.NotifyGroupPolicyIds }).(pulumi.StringArrayOutput)
}

func (o GetAlertingRulesResultOutput) NotifyPolicyIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) []string { return v.NotifyPolicyIds }).(pulumi.StringArrayOutput)
}

func (o GetAlertingRulesResultOutput) OutputFile() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) *string { return v.OutputFile }).(pulumi.StringPtrOutput)
}
...
// The total count of query.
func (o GetAlertingRulesResultOutput) TotalCount() pulumi.IntOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) int { return v.TotalCount }).(pulumi.IntOutput)
}

// The type of the vmp alerting rule.
func (o GetAlertingRulesResultOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) *string { return v.Type }).(pulumi.StringPtrOutput)
}

// The id of the workspace.
func (o GetAlertingRulesResultOutput) WorkspaceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAlertingRulesResult) *string { return v.WorkspaceId }).(pulumi.StringPtrOutput)
}
