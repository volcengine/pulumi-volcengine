...
func Zones(ctx *pulumi.Context, args *ZonesArgs, opts ...pulumi.InvokeOption) (*ZonesResult, error) {
	...
	var rv ZonesResult
	err := ctx.Invoke("volcengine:rds_mssql/zones:Zones", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o ZonesResultOutput) RegionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ZonesResult) *string { return v.RegionId }).(pulumi.StringPtrOutput)
}
