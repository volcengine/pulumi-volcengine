...
func GetZones(ctx *pulumi.Context, args *GetZonesArgs, opts ...pulumi.InvokeOption) (*GetZonesResult, error) {
	...
	err := ctx.Invoke("volcengine:rds_mssql/getZones:getZones", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetZonesResultOutput) RegionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetZonesResult) *string { return v.RegionId }).(pulumi.StringPtrOutput)
}
