...
export function sharedConfigs(args?: SharedConfigsArgs, opts?: pulumi.InvokeOptions): Promise<SharedConfigsResult> {
    pulumi.log.warn("sharedConfigs is deprecated: volcengine.cdn/sharedconfigs.SharedConfigs has been deprecated in favor of volcengine.cdn/getsharedconfigs.getSharedConfigs")
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:cdn/sharedConfigs:SharedConfigs", {
