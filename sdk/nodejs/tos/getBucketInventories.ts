 ...
 * ```
 */
export function getBucketInventoriesOutput(args: GetBucketInventoriesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBucketInventoriesResult> {
    return pulumi.output(args).apply((a: any) => getBucketInventories(a, opts))
}
