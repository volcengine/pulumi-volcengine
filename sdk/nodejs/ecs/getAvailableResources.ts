...
export function getAvailableResources(args: GetAvailableResourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailableResourcesResult> {
    ...
    return pulumi.runtime.invoke("volcengine:ecs/getAvailableResources:getAvailableResources", {
...
export interface GetAvailableResourcesResult {
     ...
     */
    readonly availableZones: outputs.ecs.GetAvailableResourcesAvailableZone[];
