 ...
 * ```
 */
export function getInvocations(args?: GetInvocationsArgs, opts?: pulumi.InvokeOptions): Promise<GetInvocationsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:ecs/getInvocations:getInvocations", {
 ...
 * ```
 */
export function getInvocationsOutput(args?: GetInvocationsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInvocationsResult> {
    return pulumi.output(args).apply((a: any) => getInvocations(a, opts))
}
