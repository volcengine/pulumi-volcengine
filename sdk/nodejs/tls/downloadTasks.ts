...
export function downloadTasks(args?: DownloadTasksArgs, opts?: pulumi.InvokeOptions): Promise<DownloadTasksResult> {
 ...
 */
/** @deprecated volcengine.tls.DownloadTasks has been deprecated in favor of volcengine.tls.getDownloadTasks */
export function downloadTasksOutput(args?: DownloadTasksOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<DownloadTasksResult> {
    return pulumi.output(args).apply((a: any) => downloadTasks(a, opts))
}
