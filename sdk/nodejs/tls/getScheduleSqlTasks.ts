 ...
 * ```
 */
export function getScheduleSqlTasks(args?: GetScheduleSqlTasksArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduleSqlTasksResult> {
    args = args || {};
 ...
 * ```
 */
export function getScheduleSqlTasksOutput(args?: GetScheduleSqlTasksOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScheduleSqlTasksResult> {
    return pulumi.output(args).apply((a: any) => getScheduleSqlTasks(a, opts))
}
