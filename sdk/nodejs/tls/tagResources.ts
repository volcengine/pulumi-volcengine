...
export function tagResources(args: TagResourcesArgs, opts?: pulumi.InvokeOptions): Promise<TagResourcesResult> {
    pulumi.log.warn("tagResources is deprecated: volcengine.tls.TagResources has been deprecated in favor of volcengine.tls.getTagResources")

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:tls/tagResources:TagResources", {
 ...
 */
export interface TagResourcesArgs {
    /**
     ...
     * The tag filters.
     */
    tagFilters?: inputs.tls.TagResourcesTagFilter[];
}
...
export interface TagResourcesResult {
    ...
    readonly tagFilters?: outputs.tls.TagResourcesTagFilter[];
    /**
     * The list of tags.
     */
    readonly tags: outputs.tls.TagResourcesTag[];
}
/**
 * Use this data source to query detailed information of tls tag resources
 * ## Example Usage
 ...
 */
/** @deprecated volcengine.tls.TagResources has been deprecated in favor of volcengine.tls.getTagResources */
export function tagResourcesOutput(args: TagResourcesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<TagResourcesResult> {
    return pulumi.output(args).apply((a: any) => tagResources(a, opts))
}

/**
 * A collection of arguments for invoking TagResources.
 */
export interface TagResourcesOutputArgs {
    /**
     * The number of results returned per page. Default value: 20. Maximum value: 100.
     */
     ...
     * The tag filters.
     */
    tagFilters?: pulumi.Input<pulumi.Input<inputs.tls.TagResourcesTagFilterArgs>[]>;
}
