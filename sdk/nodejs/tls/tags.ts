...
export function tags(args: TagsArgs, opts?: pulumi.InvokeOptions): Promise<TagsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:tls/tags:Tags", {
...
export interface TagsArgs {
     ...
     * The tag filters.
     */
    tagFilters?: inputs.tls.TagsTagFilter[];
}
...
export interface TagsResult {
    ...
    readonly tagFilters?: outputs.tls.TagsTagFilter[];
    /**
     * The list of tags.
     */
    readonly tags: outputs.tls.TagsTag[];
}
/**
 * Use this data source to query detailed information of tls tags
 * ## Example Usage
...
export interface TagsOutputArgs {
     ...
     * The tag filters.
     */
    tagFilters?: pulumi.Input<pulumi.Input<inputs.tls.TagsTagFilterArgs>[]>;
}
