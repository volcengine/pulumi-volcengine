...
export function importTasks(args?: ImportTasksArgs, opts?: pulumi.InvokeOptions): Promise<ImportTasksResult> {
    pulumi.log.warn("importTasks is deprecated: volcengine.tls.ImportTasks has been deprecated in favor of volcengine.tls.getImportTasks")
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:tls/importTasks:ImportTasks", {
...
export interface ImportTasksResult {
     ...
     */
    readonly taskInfos: outputs.tls.ImportTasksTaskInfo[];
    /**
     * Import the task name of the data to be queried.
     */
 ...
 */
/** @deprecated volcengine.tls.ImportTasks has been deprecated in favor of volcengine.tls.getImportTasks */
export function importTasksOutput(args?: ImportTasksOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ImportTasksResult> {
    return pulumi.output(args).apply((a: any) => importTasks(a, opts))
}

/**
 * A collection of arguments for invoking ImportTasks.
 */
export interface ImportTasksOutputArgs {
    /**
     * Specify the IAM project name to query the data import tasks under the specified IAM project.
     */
