...
export function downloadUrls(args: DownloadUrlsArgs, opts?: pulumi.InvokeOptions): Promise<DownloadUrlsResult> {
 ...
 */
/** @deprecated volcengine.tls.DownloadUrls has been deprecated in favor of volcengine.tls.getDownloadUrls */
export function downloadUrlsOutput(args: DownloadUrlsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<DownloadUrlsResult> {
    return pulumi.output(args).apply((a: any) => downloadUrls(a, opts))
}
