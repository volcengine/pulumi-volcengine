...
export class BackendServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'volcengine:nlb/backendServer:BackendServer';
     ...
     */
    public readonly backendServers!: pulumi.Output<outputs.nlb.BackendServerBackendServer[]>;
    /**
