 ...
 * ```
 */
export function getMongoAllowLists(args: GetMongoAllowListsArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoAllowListsResult> {
 ...
 * ```
 */
export function getMongoAllowListsOutput(args: GetMongoAllowListsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMongoAllowListsResult> {
    return pulumi.output(args).apply((a: any) => getMongoAllowLists(a, opts))
}
