 ...
 * ```
 */
export function getConsumedTopics(args: GetConsumedTopicsArgs, opts?: pulumi.InvokeOptions): Promise<GetConsumedTopicsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:kafka/getConsumedTopics:getConsumedTopics", {
 ...
 */
export interface GetConsumedTopicsArgs {
    /**
 ...
 */
export interface GetConsumedTopicsResult {
    /**
     * The collection of query.
     */
    readonly consumedTopics: outputs.kafka.GetConsumedTopicsConsumedTopic[];
 ...
 * ```
 */
export function getConsumedTopicsOutput(args: GetConsumedTopicsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConsumedTopicsResult> {
    return pulumi.output(args).apply((a: any) => getConsumedTopics(a, opts))
}

/**
 * A collection of arguments for invoking getConsumedTopics.
 */
export interface GetConsumedTopicsOutputArgs {
    /**
     * The id of kafka group.
     */
