 ...
 * ```
 */
export function getTopicPartitions(args: GetTopicPartitionsArgs, opts?: pulumi.InvokeOptions): Promise<GetTopicPartitionsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:kafka/getTopicPartitions:getTopicPartitions", {
 ...
 * ```
 */
export function getTopicPartitionsOutput(args: GetTopicPartitionsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTopicPartitionsResult> {
    return pulumi.output(args).apply((a: any) => getTopicPartitions(a, opts))
}
