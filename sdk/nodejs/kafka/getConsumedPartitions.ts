 ...
 * ```
 */
export function getConsumedPartitions(args: GetConsumedPartitionsArgs, opts?: pulumi.InvokeOptions): Promise<GetConsumedPartitionsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:kafka/getConsumedPartitions:getConsumedPartitions", {
 ...
 */
export interface GetConsumedPartitionsArgs {
    /**
 ...
 */
export interface GetConsumedPartitionsResult {
    /**
     * The collection of query.
     */
    readonly consumedPartitions: outputs.kafka.GetConsumedPartitionsConsumedPartition[];
 ...
 * ```
 */
export function getConsumedPartitionsOutput(args: GetConsumedPartitionsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetConsumedPartitionsResult> {
    return pulumi.output(args).apply((a: any) => getConsumedPartitions(a, opts))
}

/**
 * A collection of arguments for invoking getConsumedPartitions.
 */
export interface GetConsumedPartitionsOutputArgs {
    /**
     * The id of kafka group.
     */
