 ...
 * ```
 */
export function getDnatEntries(args?: GetDnatEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetDnatEntriesResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:nat/getDnatEntries:getDnatEntries", {
 ...
 */
export interface GetDnatEntriesArgs {
    /**
...
export interface GetDnatEntriesResult {
     ...
     */
    readonly dnatEntries: outputs.nat.GetDnatEntriesDnatEntry[];
    /**
     * The name of the DNAT entry.
     */
 ...
 * ```
 */
export function getDnatEntriesOutput(args?: GetDnatEntriesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDnatEntriesResult> {
    return pulumi.output(args).apply((a: any) => getDnatEntries(a, opts))
}

/**
 * A collection of arguments for invoking getDnatEntries.
 */
export interface GetDnatEntriesOutputArgs {
    /**
     * The name of the DNAT entry.
     */
