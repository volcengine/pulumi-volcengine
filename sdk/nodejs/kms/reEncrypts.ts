...
export function reEncrypts(args: ReEncryptsArgs, opts?: pulumi.InvokeOptions): Promise<ReEncryptsResult> {
 ...
 */
/** @deprecated volcengine.kms.ReEncrypts has been deprecated in favor of volcengine.kms.getReEncrypts */
export function reEncryptsOutput(args: ReEncryptsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ReEncryptsResult> {
    return pulumi.output(args).apply((a: any) => reEncrypts(a, opts))
}
