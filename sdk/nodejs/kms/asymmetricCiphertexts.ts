...
export function asymmetricCiphertexts(args: AsymmetricCiphertextsArgs, opts?: pulumi.InvokeOptions): Promise<AsymmetricCiphertextsResult> {
 ...
 */
/** @deprecated volcengine.kms.AsymmetricCiphertexts has been deprecated in favor of volcengine.kms.getAsymmetricCiphertexts */
export function asymmetricCiphertextsOutput(args: AsymmetricCiphertextsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<AsymmetricCiphertextsResult> {
    return pulumi.output(args).apply((a: any) => asymmetricCiphertexts(a, opts))
}
