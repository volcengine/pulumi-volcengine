...
export function asymmetricVerifications(args: AsymmetricVerificationsArgs, opts?: pulumi.InvokeOptions): Promise<AsymmetricVerificationsResult> {
 ...
 */
/** @deprecated volcengine.kms.AsymmetricVerifications has been deprecated in favor of volcengine.kms.getAsymmetricVerifications */
export function asymmetricVerificationsOutput(args: AsymmetricVerificationsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<AsymmetricVerificationsResult> {
    return pulumi.output(args).apply((a: any) => asymmetricVerifications(a, opts))
}
