 ...
 * ```
 */
export function getAsymmetricPlaintexts(args: GetAsymmetricPlaintextsArgs, opts?: pulumi.InvokeOptions): Promise<GetAsymmetricPlaintextsResult> {
 ...
 * ```
 */
export function getAsymmetricPlaintextsOutput(args: GetAsymmetricPlaintextsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAsymmetricPlaintextsResult> {
    return pulumi.output(args).apply((a: any) => getAsymmetricPlaintexts(a, opts))
}
