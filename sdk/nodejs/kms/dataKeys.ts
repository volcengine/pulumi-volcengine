...
export function dataKeys(args?: DataKeysArgs, opts?: pulumi.InvokeOptions): Promise<DataKeysResult> {
 ...
 */
/** @deprecated volcengine.kms.DataKeys has been deprecated in favor of volcengine.kms.getDataKeys */
export function dataKeysOutput(args?: DataKeysOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<DataKeysResult> {
    return pulumi.output(args).apply((a: any) => dataKeys(a, opts))
}
