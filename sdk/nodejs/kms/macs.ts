...
export function macs(args: MacsArgs, opts?: pulumi.InvokeOptions): Promise<MacsResult> {
 ...
 */
/** @deprecated volcengine.kms.Macs has been deprecated in favor of volcengine.kms.getMacs */
export function macsOutput(args: MacsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<MacsResult> {
    return pulumi.output(args).apply((a: any) => macs(a, opts))
}
