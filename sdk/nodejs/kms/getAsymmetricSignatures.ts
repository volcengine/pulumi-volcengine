 ...
 * ```
 */
export function getAsymmetricSignatures(args: GetAsymmetricSignaturesArgs, opts?: pulumi.InvokeOptions): Promise<GetAsymmetricSignaturesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:kms/getAsymmetricSignatures:getAsymmetricSignatures", {
 ...
 * ```
 */
export function getAsymmetricSignaturesOutput(args: GetAsymmetricSignaturesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAsymmetricSignaturesResult> {
    return pulumi.output(args).apply((a: any) => getAsymmetricSignatures(a, opts))
}
