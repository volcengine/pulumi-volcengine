...
export function keyMaterials(args?: KeyMaterialsArgs, opts?: pulumi.InvokeOptions): Promise<KeyMaterialsResult> {
 ...
 */
export interface KeyMaterialsArgs {
    /**
 ...
 */
export interface KeyMaterialsResult {
    /**
     ...
     */
    readonly importParameters: outputs.kms.KeyMaterialsImportParameter[];
    /**
     * The id of key.
     */
 ...
 */
/** @deprecated volcengine.kms.KeyMaterials has been deprecated in favor of volcengine.kms.getKeyMaterials */
export function keyMaterialsOutput(args?: KeyMaterialsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<KeyMaterialsResult> {
    return pulumi.output(args).apply((a: any) => keyMaterials(a, opts))
}

/**
 * A collection of arguments for invoking KeyMaterials.
 */
export interface KeyMaterialsOutputArgs {
    /**
     * The id of key. When keyId is not specified, both keyringName and keyName must be specified.
     */
