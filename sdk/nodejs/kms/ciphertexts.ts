...
export function ciphertexts(args: CiphertextsArgs, opts?: pulumi.InvokeOptions): Promise<CiphertextsResult> {
 ...
 */
/** @deprecated volcengine.kms.Ciphertexts has been deprecated in favor of volcengine.kms.getCiphertexts */
export function ciphertextsOutput(args: CiphertextsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<CiphertextsResult> {
    return pulumi.output(args).apply((a: any) => ciphertexts(a, opts))
}
