...
export function getSslVpnClientCerts(args?: GetSslVpnClientCertsArgs, opts?: pulumi.InvokeOptions): Promise<GetSslVpnClientCertsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:vpn/getSslVpnClientCerts:getSslVpnClientCerts", {
        "ids": args.ids,
...
export interface GetSslVpnClientCertsArgs {
     ...
     * Tags.
     */
    tags?: inputs.vpn.GetSslVpnClientCertsTag[];
}
...
export interface GetSslVpnClientCertsResult {
    ...
    readonly tags?: outputs.vpn.GetSslVpnClientCertsTag[];
    /**
...
export interface GetSslVpnClientCertsOutputArgs {
     ...
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.vpn.GetSslVpnClientCertsTagArgs>[]>;
}
