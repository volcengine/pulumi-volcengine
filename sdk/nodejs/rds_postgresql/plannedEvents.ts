...
export function plannedEvents(args?: PlannedEventsArgs, opts?: pulumi.InvokeOptions): Promise<PlannedEventsResult> {
    pulumi.log.warn("plannedEvents is deprecated: volcengine.rds_postgresql.PlannedEvents has been deprecated in favor of volcengine.rds_postgresql.getPlannedEvents")
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:rds_postgresql/plannedEvents:PlannedEvents", {
