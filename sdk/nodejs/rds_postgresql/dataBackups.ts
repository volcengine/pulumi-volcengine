...
export function dataBackups(args: DataBackupsArgs, opts?: pulumi.InvokeOptions): Promise<DataBackupsResult> {
 ...
 */
/** @deprecated volcengine.rds_postgresql.DataBackups has been deprecated in favor of volcengine.rds_postgresql.getDataBackups */
export function dataBackupsOutput(args: DataBackupsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<DataBackupsResult> {
    return pulumi.output(args).apply((a: any) => dataBackups(a, opts))
}
