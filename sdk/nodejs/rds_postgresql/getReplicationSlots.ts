 ...
 * ```
 */
export function getReplicationSlots(args: GetReplicationSlotsArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationSlotsResult> {
 ...
 * ```
 */
export function getReplicationSlotsOutput(args: GetReplicationSlotsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetReplicationSlotsResult> {
    return pulumi.output(args).apply((a: any) => getReplicationSlots(a, opts))
}
