...
export function instanceBackupWalLogs(args: InstanceBackupWalLogsArgs, opts?: pulumi.InvokeOptions): Promise<InstanceBackupWalLogsResult> {
 ...
 */
/** @deprecated volcengine.rds_postgresql.InstanceBackupWalLogs has been deprecated in favor of volcengine.rds_postgresql.getInstanceBackupWalLogs */
export function instanceBackupWalLogsOutput(args: InstanceBackupWalLogsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<InstanceBackupWalLogsResult> {
    return pulumi.output(args).apply((a: any) => instanceBackupWalLogs(a, opts))
}
