 ...
 * ```
 */
export function getInstanceBackupDetacheds(args?: GetInstanceBackupDetachedsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceBackupDetachedsResult> {
    args = args || {};
 ...
 * ```
 */
export function getInstanceBackupDetachedsOutput(args?: GetInstanceBackupDetachedsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInstanceBackupDetachedsResult> {
    return pulumi.output(args).apply((a: any) => getInstanceBackupDetacheds(a, opts))
}
