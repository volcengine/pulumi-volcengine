 ...
 * ```
 */
export function getBigKeys(args: GetBigKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetBigKeysResult> {
 ...
 * ```
 */
export function getBigKeysOutput(args: GetBigKeysOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBigKeysResult> {
    return pulumi.output(args).apply((a: any) => getBigKeys(a, opts))
}
