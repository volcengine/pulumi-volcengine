...
export function plannedEvents(args?: PlannedEventsArgs, opts?: pulumi.InvokeOptions): Promise<PlannedEventsResult> {
    pulumi.log.warn("plannedEvents is deprecated: volcengine.redis.PlannedEvents has been deprecated in favor of volcengine.redis.getPlannedEvents")
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:redis/plannedEvents:PlannedEvents", {
