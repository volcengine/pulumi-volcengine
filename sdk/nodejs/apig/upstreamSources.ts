...
export function upstreamSources(args?: UpstreamSourcesArgs, opts?: pulumi.InvokeOptions): Promise<UpstreamSourcesResult> {
 ...
 */
/** @deprecated volcengine.apig.UpstreamSources has been deprecated in favor of volcengine.apig.getUpstreamSources */
export function upstreamSourcesOutput(args?: UpstreamSourcesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<UpstreamSourcesResult> {
    return pulumi.output(args).apply((a: any) => upstreamSources(a, opts))
}
