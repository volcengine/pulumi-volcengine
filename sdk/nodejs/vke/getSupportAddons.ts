 ...
 * ```
 */
export function getSupportAddons(args?: GetSupportAddonsArgs, opts?: pulumi.InvokeOptions): Promise<GetSupportAddonsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:vke/getSupportAddons:getSupportAddons", {
...
export interface GetSupportAddonsResult {
     ...
     */
    readonly addons: outputs.vke.GetSupportAddonsAddon[];
 ...
 * ```
 */
export function getSupportAddonsOutput(args?: GetSupportAddonsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSupportAddonsResult> {
    return pulumi.output(args).apply((a: any) => getSupportAddons(a, opts))
}
