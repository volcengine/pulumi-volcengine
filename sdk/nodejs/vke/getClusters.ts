...
export function getClusters(args?: GetClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetClustersResult> {
    ...
    return pulumi.runtime.invoke("volcengine:vke/getClusters:getClusters", {
...
export interface GetClustersArgs {
     ...
     */
    statuses?: inputs.vke.GetClustersStatus[];
    /**
     * Tags.
     */
    tags?: inputs.vke.GetClustersTag[];
    /**
...
export interface GetClustersResult {
     ...
     */
    readonly clusters: outputs.vke.GetClustersCluster[];
    ...
    readonly statuses?: outputs.vke.GetClustersStatus[];
    /**
     * Tags of the Cluster.
     */
    readonly tags?: outputs.vke.GetClustersTag[];
    /**
...
export interface GetClustersOutputArgs {
     ...
     * Array of cluster states to filter. (The elements of the array are logically ORed. A maximum of 15 state array elements can be filled at a time).
     */
    statuses?: pulumi.Input<pulumi.Input<inputs.vke.GetClustersStatusArgs>[]>;
    /**
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.vke.GetClustersTagArgs>[]>;
    /**
     * The ClientToken when the last cluster update succeeded. ClientToken is a string that guarantees the idempotency of the request. This string is passed in by the caller.
     */
