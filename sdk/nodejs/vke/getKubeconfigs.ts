 ...
 * ```
 */
export function getKubeconfigs(args?: GetKubeconfigsArgs, opts?: pulumi.InvokeOptions): Promise<GetKubeconfigsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:vke/getKubeconfigs:getKubeconfigs", {
 ...
 * ```
 */
export function getKubeconfigsOutput(args?: GetKubeconfigsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKubeconfigsResult> {
    return pulumi.output(args).apply((a: any) => getKubeconfigs(a, opts))
}
