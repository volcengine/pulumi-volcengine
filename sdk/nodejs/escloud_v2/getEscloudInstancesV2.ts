 ...
 * ```
 */
export function getEscloudInstancesV2(args?: GetEscloudInstancesV2Args, opts?: pulumi.InvokeOptions): Promise<GetEscloudInstancesV2Result> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:escloud_v2/getEscloudInstancesV2:getEscloudInstancesV2", {
 ...
 */
export interface GetEscloudInstancesV2Args {
    /**
     ...
     */
    tags?: inputs.escloud_v2.GetEscloudInstancesV2Tag[];
    /**
 ...
 */
export interface GetEscloudInstancesV2Result {
     ...
     */
    readonly instances: outputs.escloud_v2.GetEscloudInstancesV2Instance[];
     ...
     * Tags.
     */
    readonly tags?: outputs.escloud_v2.GetEscloudInstancesV2Tag[];
    /**
 ...
 * ```
 */
export function getEscloudInstancesV2Output(args?: GetEscloudInstancesV2OutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEscloudInstancesV2Result> {
    return pulumi.output(args).apply((a: any) => getEscloudInstancesV2(a, opts))
}

/**
 * A collection of arguments for invoking getEscloudInstancesV2.
 */
export interface GetEscloudInstancesV2OutputArgs {
    /**
     * The charge types of instance.
     */
     ...
     * The tags of instance.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.escloud_v2.GetEscloudInstancesV2TagArgs>[]>;
    /**
     * The versions of instance.
     */
