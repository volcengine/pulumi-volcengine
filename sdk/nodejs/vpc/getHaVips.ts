...
export function getHaVips(args?: GetHaVipsArgs, opts?: pulumi.InvokeOptions): Promise<GetHaVipsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:vpc/getHaVips:getHaVips", {
...
export interface GetHaVipsResult {
     ...
     * Tags.
     */
    readonly tags?: outputs.vpc.GetHaVipsTag[];
    /**
...
export interface GetHaVipsOutputArgs {
     ...
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.vpc.GetHaVipsTagArgs>[]>;
    /**
     * The id of vpc.
     */
