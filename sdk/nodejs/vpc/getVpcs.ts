...
export function getVpcs(args?: GetVpcsArgs, opts?: pulumi.InvokeOptions): Promise<GetVpcsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:vpc/getVpcs:getVpcs", {
        "ids": args.ids,
...
export interface GetVpcsResult {
     ...
     * Tags.
     */
    readonly tags?: outputs.vpc.GetVpcsTag[];
    /**
...
export interface GetVpcsOutputArgs {
     ...
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.vpc.GetVpcsTagArgs>[]>;
    /**
     * The vpc name to query.
     */
