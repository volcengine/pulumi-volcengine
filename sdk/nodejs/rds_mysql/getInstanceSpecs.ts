...
export function getInstanceSpecs(args?: GetInstanceSpecsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceSpecsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:rds_mysql/getInstanceSpecs:getInstanceSpecs", {
...
export interface GetInstanceSpecsResult {
     ...
     */
    readonly instanceSpecs: outputs.rds_mysql.GetInstanceSpecsInstanceSpec[];
    /**
     * Instance type. The value is DoubleNode.
     */
