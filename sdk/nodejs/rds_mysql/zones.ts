 ...
 * ```
 */
/** @deprecated volcengine.rds_mysql.Zones has been deprecated in favor of volcengine.rds_mysql.getZones */
export function zones(args?: ZonesArgs, opts?: pulumi.InvokeOptions): Promise<ZonesResult> {
    ...
    return pulumi.runtime.invoke("volcengine:rds_mysql/zones:Zones", {
...
export interface ZonesResult {
     ...
     */
    readonly zones: outputs.rds_mysql.ZonesZone[];
}
/**
 * Use this data source to query detailed information of rds mysql zones
 * ## Example Usage
