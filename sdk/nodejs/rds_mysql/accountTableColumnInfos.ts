...
export function accountTableColumnInfos(args: AccountTableColumnInfosArgs, opts?: pulumi.InvokeOptions): Promise<AccountTableColumnInfosResult> {
 ...
 */
/** @deprecated volcengine.rds_mysql.AccountTableColumnInfos has been deprecated in favor of volcengine.rds_mysql.getAccountTableColumnInfos */
export function accountTableColumnInfosOutput(args: AccountTableColumnInfosOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<AccountTableColumnInfosResult> {
    return pulumi.output(args).apply((a: any) => accountTableColumnInfos(a, opts))
}
