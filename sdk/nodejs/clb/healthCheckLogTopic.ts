 ...
 * ```
 */
export class HealthCheckLogTopic extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HealthCheckLogTopicState, opts?: pulumi.CustomResourceOptions): HealthCheckLogTopic {
        return new HealthCheckLogTopic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'volcengine:clb/healthCheckLogTopic:HealthCheckLogTopic';

    /**
     * Returns true if the given object is an instance of HealthCheckLogTopic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HealthCheckLogTopic {
    ...
    constructor(name: string, argsOrState?: HealthCheckLogTopicArgs | HealthCheckLogTopicState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HealthCheckLogTopicState | undefined;
            resourceInputs["loadBalancerId"] = state ? state.loadBalancerId : undefined;
            resourceInputs["logTopicId"] = state ? state.logTopicId : undefined;
        } else {
            const args = argsOrState as HealthCheckLogTopicArgs | undefined;
