...
export function getAutoSnapshotPolicies(args?: GetAutoSnapshotPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoSnapshotPoliciesResult> {
    ...
    return pulumi.runtime.invoke("volcengine:nas/getAutoSnapshotPolicies:getAutoSnapshotPolicies", {
...
export interface GetAutoSnapshotPoliciesResult {
     ...
     */
    readonly autoSnapshotPolices: outputs.nas.GetAutoSnapshotPoliciesAutoSnapshotPolice[];
    /**
     * The ID of auto snapshot policy.
     */
