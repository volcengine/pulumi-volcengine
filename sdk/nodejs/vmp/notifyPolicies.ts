...
export function notifyPolicies(args?: NotifyPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<NotifyPoliciesResult> {
 ...
 */
/** @deprecated volcengine.vmp.NotifyPolicies has been deprecated in favor of volcengine.vmp.getNotifyPolicies */
export function notifyPoliciesOutput(args?: NotifyPoliciesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<NotifyPoliciesResult> {
    return pulumi.output(args).apply((a: any) => notifyPolicies(a, opts))
}
