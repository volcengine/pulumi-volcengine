 ...
 * ```
 */
export function getRdsInstancesV2(args?: GetRdsInstancesV2Args, opts?: pulumi.InvokeOptions): Promise<GetRdsInstancesV2Result> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:rds_v2/getRdsInstancesV2:getRdsInstancesV2", {
 ...
 */
export interface GetRdsInstancesV2Args {
    /**
 ...
 */
export interface GetRdsInstancesV2Result {
    /**
     * Payment type. Value:
     ...
     */
    readonly rdsInstances: outputs.rds_v2.GetRdsInstancesV2RdsInstance[];
    /**
 ...
 * ```
 */
export function getRdsInstancesV2Output(args?: GetRdsInstancesV2OutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRdsInstancesV2Result> {
    return pulumi.output(args).apply((a: any) => getRdsInstancesV2(a, opts))
}

/**
 * A collection of arguments for invoking getRdsInstancesV2.
 */
export interface GetRdsInstancesV2OutputArgs {
    /**
     * The charge type of the RDS instance.
     */
