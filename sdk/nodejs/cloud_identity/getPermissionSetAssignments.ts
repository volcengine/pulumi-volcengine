 ...
 * ```
 */
export function getPermissionSetAssignments(args?: GetPermissionSetAssignmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetPermissionSetAssignmentsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:cloud_identity/getPermissionSetAssignments:getPermissionSetAssignments", {
 ...
 */
export interface GetPermissionSetAssignmentsArgs {
    /**
...
export interface GetPermissionSetAssignmentsResult {
     ...
     */
    readonly assignments: outputs.cloud_identity.GetPermissionSetAssignmentsAssignment[];
    /**
 ...
 * ```
 */
export function getPermissionSetAssignmentsOutput(args?: GetPermissionSetAssignmentsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPermissionSetAssignmentsResult> {
    return pulumi.output(args).apply((a: any) => getPermissionSetAssignments(a, opts))
}

/**
 * A collection of arguments for invoking getPermissionSetAssignments.
 */
export interface GetPermissionSetAssignmentsOutputArgs {
    /**
     * A Name Regex of Resource.
     */
