 ...
 * ```
 */
export function getSnapshotGroups(args?: GetSnapshotGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotGroupsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:ebs/getSnapshotGroups:getSnapshotGroups", {
        "ids": args.ids,
 ...
 */
export interface GetSnapshotGroupsArgs {
    /**
...
export interface GetSnapshotGroupsResult {
     ...
     */
    readonly snapshotGroups: outputs.ebs.GetSnapshotGroupsSnapshotGroup[];
    /**
 ...
 * ```
 */
export function getSnapshotGroupsOutput(args?: GetSnapshotGroupsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSnapshotGroupsResult> {
    return pulumi.output(args).apply((a: any) => getSnapshotGroups(a, opts))
}

/**
 * A collection of arguments for invoking getSnapshotGroups.
 */
export interface GetSnapshotGroupsOutputArgs {
    /**
     * A list of snapshot group IDs.
     */
