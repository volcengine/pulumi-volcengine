...
export function getSnapshots(args?: GetSnapshotsArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:ebs/getSnapshots:getSnapshots", {
        "ids": args.ids,
...
export interface GetSnapshotsArgs {
     ...
     * Tags.
     */
    tags?: inputs.ebs.GetSnapshotsTag[];
    /**
...
export interface GetSnapshotsResult {
     ...
     */
    readonly snapshots: outputs.ebs.GetSnapshotsSnapshot[];
    /**
     * Tags.
     */
    readonly tags?: outputs.ebs.GetSnapshotsTag[];
    /**
...
export interface GetSnapshotsOutputArgs {
     ...
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.ebs.GetSnapshotsTagArgs>[]>;
    /**
     * The zone id of snapshot.
     */
