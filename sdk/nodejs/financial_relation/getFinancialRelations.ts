 ...
 * ```
 */
export function getFinancialRelations(args?: GetFinancialRelationsArgs, opts?: pulumi.InvokeOptions): Promise<GetFinancialRelationsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:financial_relation/getFinancialRelations:getFinancialRelations", {
 ...
 * ```
 */
export function getFinancialRelationsOutput(args?: GetFinancialRelationsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFinancialRelationsResult> {
    return pulumi.output(args).apply((a: any) => getFinancialRelations(a, opts))
}
