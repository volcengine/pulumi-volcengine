 ...
 * ```
 */
export function getMountServices(args?: GetMountServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetMountServicesResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:vepfs/getMountServices:getMountServices", {
 ...
 * ```
 */
export function getMountServicesOutput(args?: GetMountServicesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMountServicesResult> {
    return pulumi.output(args).apply((a: any) => getMountServices(a, opts))
}
