...
export class InstanceV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'volcengine:escloud/instanceV2:InstanceV2';
     ...
     */
    public readonly networkSpecs!: pulumi.Output<outputs.escloud.InstanceV2NetworkSpec[] | undefined>;
    /**
     * The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
     */
    public readonly nodeSpecsAssigns!: pulumi.Output<outputs.escloud.InstanceV2NodeSpecsAssign[]>;
    /**
     ...
     * Tags.
     */
    public readonly tags!: pulumi.Output<outputs.escloud.InstanceV2Tag[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceV2Args | InstanceV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "volcengine:escloud_v2/escloudInstanceV2:EscloudInstanceV2" }] };
...
export interface InstanceV2State {
     ...
     * The public network config of the ESCloud instance.
     */
    networkSpecs?: pulumi.Input<pulumi.Input<inputs.escloud.InstanceV2NetworkSpec>[]>;
    /**
     * The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
     */
    nodeSpecsAssigns?: pulumi.Input<pulumi.Input<inputs.escloud.InstanceV2NodeSpecsAssign>[]>;
    /**
     * Purchase duration in prepaid scenarios. Unit: Monthly.
     */
     ...
     * Tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.escloud.InstanceV2Tag>[]>;
    /**
     * The version of instance. When creating ESCloud instance, the valid value is `V6_7` or `V7_10`. When creating OpenSearch instance, the valid value is `OPEN_SEARCH_2_9`.
     */
