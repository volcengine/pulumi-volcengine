 ...
 * ```
 */
export class CfwNatFirewallControlPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CfwNatFirewallControlPolicyState, opts?: pulumi.CustomResourceOptions): CfwNatFirewallControlPolicy {
        return new CfwNatFirewallControlPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'volcengine:cloud_firewall/cfwNatFirewallControlPolicy:CfwNatFirewallControlPolicy';
     ...
     */
    public static isInstance(obj: any): obj is CfwNatFirewallControlPolicy {
     ...
     */
    public /*out*/ readonly natFirewallName!: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: CfwNatFirewallControlPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CfwNatFirewallControlPolicyArgs | CfwNatFirewallControlPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CfwNatFirewallControlPolicyState | undefined;
            ...
            const args = argsOrState as CfwNatFirewallControlPolicyArgs | undefined;
 ...
 */
export interface CfwNatFirewallControlPolicyState {
    /**
     * The account id of the nat firewall control policy.
     */
 ...
 */
export interface CfwNatFirewallControlPolicyArgs {
    /**
     * The action of the nat firewall control policy. Valid values: `accept`, `deny`, `monitor`.
     */
    action: pulumi.Input<string>;
