 ...
 * ```
 */
export function getCfwNatFirewallControlPolicies(args: GetCfwNatFirewallControlPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetCfwNatFirewallControlPoliciesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:cloud_firewall/getCfwNatFirewallControlPolicies:getCfwNatFirewallControlPolicies", {
 ...
 */
export interface GetCfwNatFirewallControlPoliciesArgs {
    /**
 ...
 */
export interface GetCfwNatFirewallControlPoliciesResult {
    /**
     ...
     */
    readonly natFirewallControlPolicies: outputs.cloud_firewall.GetCfwNatFirewallControlPoliciesNatFirewallControlPolicy[];
    /**
 ...
 * ```
 */
export function getCfwNatFirewallControlPoliciesOutput(args: GetCfwNatFirewallControlPoliciesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCfwNatFirewallControlPoliciesResult> {
    return pulumi.output(args).apply((a: any) => getCfwNatFirewallControlPolicies(a, opts))
}

/**
 * A collection of arguments for invoking getCfwNatFirewallControlPolicies.
 */
export interface GetCfwNatFirewallControlPoliciesOutputArgs {
    /**
     * The action list of the nat firewall control policy. Valid values: `accept`, `deny`, `monitor`.
     */
