 ...
 * ```
 */
export function getCfwControlPolicies(args: GetCfwControlPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetCfwControlPoliciesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:cloud_firewall/getCfwControlPolicies:getCfwControlPolicies", {
 ...
 * ```
 */
export function getCfwControlPoliciesOutput(args: GetCfwControlPoliciesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCfwControlPoliciesResult> {
    return pulumi.output(args).apply((a: any) => getCfwControlPolicies(a, opts))
}
