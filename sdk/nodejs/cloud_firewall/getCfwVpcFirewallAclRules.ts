 ...
 * ```
 */
export function getCfwVpcFirewallAclRules(args: GetCfwVpcFirewallAclRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetCfwVpcFirewallAclRulesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:cloud_firewall/getCfwVpcFirewallAclRules:getCfwVpcFirewallAclRules", {
 ...
 * ```
 */
export function getCfwVpcFirewallAclRulesOutput(args: GetCfwVpcFirewallAclRulesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCfwVpcFirewallAclRulesResult> {
    return pulumi.output(args).apply((a: any) => getCfwVpcFirewallAclRules(a, opts))
}
