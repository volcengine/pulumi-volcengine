 ...
 * ```
 */
export function getScalingActivities(args: GetScalingActivitiesArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingActivitiesResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("volcengine:autoscaling/getScalingActivities:getScalingActivities", {
 ...
 */
export interface GetScalingActivitiesArgs {
    /**
 ...
 */
export interface GetScalingActivitiesResult {
    /**
     * The collection of Scaling Activity query.
     */
    readonly activities: outputs.autoscaling.GetScalingActivitiesActivity[];
 ...
 * ```
 */
export function getScalingActivitiesOutput(args: GetScalingActivitiesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScalingActivitiesResult> {
    return pulumi.output(args).apply((a: any) => getScalingActivities(a, opts))
}

/**
 * A collection of arguments for invoking getScalingActivities.
 */
export interface GetScalingActivitiesOutputArgs {
    /**
     * An end time to start a Scaling Activity.
     */
