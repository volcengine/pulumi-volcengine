...
export function getScalingConfigurations(args?: GetScalingConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingConfigurationsResult> {
    ...
    return pulumi.runtime.invoke("volcengine:autoscaling/getScalingConfigurations:getScalingConfigurations", {
        "ids": args.ids,
...
export interface GetScalingConfigurationsResult {
     ...
     */
    readonly scalingConfigurations: outputs.autoscaling.GetScalingConfigurationsScalingConfiguration[];
    /**
