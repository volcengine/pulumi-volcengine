...
namespace Pulumi.Volcengine.Vedb_mysql
{
    ...
    /// ```
    /// </summary>
    [VolcengineResourceType("volcengine:vedb_mysql/allowlist:Allowlist")]
    public partial class Allowlist : global::Pulumi.CustomResource
    {
        ...
        public Allowlist(string name, AllowlistArgs args, CustomResourceOptions? options = null)
            : base("volcengine:vedb_mysql/allowlist:Allowlist", name, args ?? new AllowlistArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Allowlist(string name, Input<string> id, AllowlistState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:vedb_mysql/allowlist:Allowlist", name, state, MakeResourceOptions(options, id))
        {
        }
