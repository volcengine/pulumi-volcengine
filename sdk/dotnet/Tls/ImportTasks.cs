...
{
    [Obsolete(@"volcengine.tls.ImportTasks has been deprecated in favor of volcengine.tls.getImportTasks")]
    public static class ImportTasks
    {
        ...
        /// ```
        /// </summary>
        public static Task<ImportTasksResult> InvokeAsync(ImportTasksArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ImportTasksResult>("volcengine:tls/importTasks:ImportTasks", args ?? new ImportTasksArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<ImportTasksResult> Invoke(ImportTasksInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ImportTasksResult>("volcengine:tls/importTasks:ImportTasks", args ?? new ImportTasksInvokeArgs(), options.WithDefaults());
    }


    public sealed class ImportTasksArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public ImportTasksArgs()
        {
        }
        public static new ImportTasksArgs Empty => new ImportTasksArgs();
    }

    public sealed class ImportTasksInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Specify the IAM project name to query the data import tasks under the specified IAM project.
        /// </summary>
        ...
        public ImportTasksInvokeArgs()
        {
        }
        public static new ImportTasksInvokeArgs Empty => new ImportTasksInvokeArgs();
    }
    ...
    public sealed class ImportTasksResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.ImportTasksTaskInfoResult> TaskInfos;
        /// <summary>
        /// Import the task name of the data to be queried.
        /// </summary>
        ...
        private ImportTasksResult(
            ...
            ImmutableArray<Outputs.ImportTasksTaskInfoResult> taskInfos,
