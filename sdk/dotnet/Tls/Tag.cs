...
namespace Pulumi.Volcengine.Tls
{
    ...
    /// ```
    /// </summary>
    [VolcengineResourceType("volcengine:tls/tag:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("volcengine:tls/tag:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, TagState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:tls/tag:Tag", name, state, MakeResourceOptions(options, id))
        {
        }
