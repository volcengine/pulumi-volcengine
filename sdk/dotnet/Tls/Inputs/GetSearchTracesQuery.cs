...
namespace Pulumi.Volcengine.Tls.Inputs
{
    ...
    public sealed class GetSearchTracesQueryArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("attributes")]
        private List<Inputs.GetSearchTracesQueryAttributeArgs>? _attributes;

        /// <summary>
        /// Attributes.
        /// </summary>
        public List<Inputs.GetSearchTracesQueryAttributeArgs> Attributes
        {
            get => _attributes ?? (_attributes = new List<Inputs.GetSearchTracesQueryAttributeArgs>());
        ...
        public GetSearchTracesQueryArgs()
        {
        }
        public static new GetSearchTracesQueryArgs Empty => new GetSearchTracesQueryArgs();
    }
}
