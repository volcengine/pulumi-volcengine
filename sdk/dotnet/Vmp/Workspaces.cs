...
{
    [Obsolete(@"volcengine.vmp.Workspaces has been deprecated in favor of volcengine.vmp.getWorkspaces")]
    public static class Workspaces
    {
        ...
        public static Task<WorkspacesResult> InvokeAsync(WorkspacesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<WorkspacesResult>("volcengine:vmp/workspaces:Workspaces", args ?? new WorkspacesArgs(), options.WithDefaults());
        ...
        public static Output<WorkspacesResult> Invoke(WorkspacesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<WorkspacesResult>("volcengine:vmp/workspaces:Workspaces", args ?? new WorkspacesInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class WorkspacesArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private List<Inputs.WorkspacesTagArgs>? _tags;

        /// <summary>
        /// The tags of vmp workspace.
        /// </summary>
        public List<Inputs.WorkspacesTagArgs> Tags
        {
            get => _tags ?? (_tags = new List<Inputs.WorkspacesTagArgs>());
            set => _tags = value;
        }
    ...
    public sealed class WorkspacesInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.WorkspacesTagInputArgs>? _tags;

        /// <summary>
        /// The tags of vmp workspace.
        /// </summary>
        public InputList<Inputs.WorkspacesTagInputArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.WorkspacesTagInputArgs>());
            set => _tags = value;
        }
    ...
    public sealed class WorkspacesResult
    {
        ...
        /// Tags.
        /// </summary>
        public readonly ImmutableArray<Outputs.WorkspacesTagResult> Tags;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.WorkspacesWorkspaceResult> Workspaces;
        ...
        private WorkspacesResult(
            ...
            ImmutableArray<Outputs.WorkspacesTagResult> tags,

            int totalCount,

            ImmutableArray<Outputs.WorkspacesWorkspaceResult> workspaces)
        {
            Id = id;
            Ids = ids;
