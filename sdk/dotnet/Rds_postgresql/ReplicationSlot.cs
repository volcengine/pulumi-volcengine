...
namespace Pulumi.Volcengine.Rds_postgresql
{
    ...
    /// ```
    /// </summary>
    [VolcengineResourceType("volcengine:rds_postgresql/replicationSlot:ReplicationSlot")]
    public partial class ReplicationSlot : global::Pulumi.CustomResource
    {
        ...
        public ReplicationSlot(string name, ReplicationSlotArgs args, CustomResourceOptions? options = null)
            : base("volcengine:rds_postgresql/replicationSlot:ReplicationSlot", name, args ?? new ReplicationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicationSlot(string name, Input<string> id, ReplicationSlotState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:rds_postgresql/replicationSlot:ReplicationSlot", name, state, MakeResourceOptions(options, id))
        {
        }
