...
{
    [Obsolete(@"volcengine.rds_postgresql.InstanceTasks has been deprecated in favor of volcengine.rds_postgresql.getInstanceTasks")]
    public static class InstanceTasks
    {
        ...
        /// ```
        /// </summary>
        public static Task<InstanceTasksResult> InvokeAsync(InstanceTasksArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<InstanceTasksResult>("volcengine:rds_postgresql/instanceTasks:InstanceTasks", args ?? new InstanceTasksArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<InstanceTasksResult> Invoke(InstanceTasksInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<InstanceTasksResult>("volcengine:rds_postgresql/instanceTasks:InstanceTasks", args ?? new InstanceTasksInvokeArgs(), options.WithDefaults());
    }


    public sealed class InstanceTasksArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public InstanceTasksArgs()
        {
        }
        public static new InstanceTasksArgs Empty => new InstanceTasksArgs();
    }

    public sealed class InstanceTasksInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Task end time. Format: yyyy-MM-ddTHH:mm:ssZ (UTC). Note: The maximum interval between creation_start_time and creation_end_time cannot exceed 7 days.
        /// </summary>
        ...
        public InstanceTasksInvokeArgs()
        {
        }
        public static new InstanceTasksInvokeArgs Empty => new InstanceTasksInvokeArgs();
    }


    [OutputType]
    public sealed class InstanceTasksResult
    {
        ...
        /// Task list.
        /// </summary>
        public readonly ImmutableArray<Outputs.InstanceTasksTaskInfoResult> TaskInfos;
        /// <summary>
        /// Task status.
        /// </summary>
        ...
        private InstanceTasksResult(
            ...
            ImmutableArray<Outputs.InstanceTasksTaskInfoResult> taskInfos,
