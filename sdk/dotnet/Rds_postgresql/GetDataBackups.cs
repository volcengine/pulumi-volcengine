...
namespace Pulumi.Volcengine.Rds_postgresql
{
    public static class GetDataBackups
    {
        ...
        public static Task<GetDataBackupsResult> InvokeAsync(GetDataBackupsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataBackupsResult>("volcengine:rds_postgresql/getDataBackups:getDataBackups", args ?? new GetDataBackupsArgs(), options.WithDefaults());
        ...
        public static Output<GetDataBackupsResult> Invoke(GetDataBackupsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataBackupsResult>("volcengine:rds_postgresql/getDataBackups:getDataBackups", args ?? new GetDataBackupsInvokeArgs(), options.WithDefaults());
    }
