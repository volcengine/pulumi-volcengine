...
namespace Pulumi.Volcengine.Rds_postgresql.Inputs
{
    ...
    public sealed class InstanceEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.InstanceEndpointReadOnlyNodeWeightArgs>? _readOnlyNodeWeights;

        /// <summary>
        /// The list of nodes configured by the connection terminal and the corresponding read-only weights.
        /// </summary>
        public InputList<Inputs.InstanceEndpointReadOnlyNodeWeightArgs> ReadOnlyNodeWeights
        {
            get => _readOnlyNodeWeights ?? (_readOnlyNodeWeights = new InputList<Inputs.InstanceEndpointReadOnlyNodeWeightArgs>());
