...
{
    [Obsolete(@"volcengine.rds_postgresql.InstanceParameters has been deprecated in favor of volcengine.rds_postgresql.getInstanceParameters")]
    public static class InstanceParameters
    {
        ...
        public static Task<InstanceParametersResult> InvokeAsync(InstanceParametersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<InstanceParametersResult>("volcengine:rds_postgresql/instanceParameters:InstanceParameters", args ?? new InstanceParametersArgs(), options.WithDefaults());
        ...
        public static Output<InstanceParametersResult> Invoke(InstanceParametersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<InstanceParametersResult>("volcengine:rds_postgresql/instanceParameters:InstanceParameters", args ?? new InstanceParametersInvokeArgs(), options.WithDefaults());
    }
