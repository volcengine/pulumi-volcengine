...
namespace Pulumi.Volcengine.Rds_postgresql
{
    public static class GetSchemas
    {
        ...
        public static Task<GetSchemasResult> InvokeAsync(GetSchemasArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSchemasResult>("volcengine:rds_postgresql/getSchemas:getSchemas", args ?? new GetSchemasArgs(), options.WithDefaults());
        ...
        public static Output<GetSchemasResult> Invoke(GetSchemasInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSchemasResult>("volcengine:rds_postgresql/getSchemas:getSchemas", args ?? new GetSchemasInvokeArgs(), options.WithDefaults());
    }
