...
namespace Volcengine.PulumiPackage.Volcengine.Rds
{
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("volcengine:rds/database:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, DatabaseState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:rds/database:Database", name, state, MakeResourceOptions(options, id))
        {
        }
