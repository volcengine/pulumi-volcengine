...
namespace Volcengine.PulumiPackage.Volcengine.Mongodb
{
    public static class Zones
    {
        ...
        public static Task<ZonesResult> InvokeAsync(ZonesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ZonesResult>("volcengine:mongodb/zones:Zones", args ?? new ZonesArgs(), options.WithDefaults());
        ...
        public static Output<ZonesResult> Invoke(ZonesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ZonesResult>("volcengine:mongodb/zones:Zones", args ?? new ZonesInvokeArgs(), options.WithDefaults());
    }
