...
namespace Volcengine.PulumiPackage.Volcengine.Tls.Inputs
{
    ...
    public sealed class IndexKeyValueGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("jsonKeys")]
        private InputList<Inputs.IndexKeyValueJsonKeyGetArgs>? _jsonKeys;

        /// <summary>
        /// The JSON subfield key value index.
        /// </summary>
        public InputList<Inputs.IndexKeyValueJsonKeyGetArgs> JsonKeys
        {
            get => _jsonKeys ?? (_jsonKeys = new InputList<Inputs.IndexKeyValueJsonKeyGetArgs>());
            set => _jsonKeys = value;
        }
