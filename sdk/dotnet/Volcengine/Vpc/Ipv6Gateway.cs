...
namespace Volcengine.PulumiPackage.Volcengine.Vpc
{
    ...
    public partial class Ipv6Gateway : Pulumi.CustomResource
    {
        ...
        public Ipv6Gateway(string name, Ipv6GatewayArgs args, CustomResourceOptions? options = null)
            : base("volcengine:vpc/ipv6Gateway:Ipv6Gateway", name, args ?? new Ipv6GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ipv6Gateway(string name, Input<string> id, Ipv6GatewayState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:vpc/ipv6Gateway:Ipv6Gateway", name, state, MakeResourceOptions(options, id))
        {
        }
