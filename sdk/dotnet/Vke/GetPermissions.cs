...
namespace Pulumi.Volcengine.Vke
{
    public static class GetPermissions
    {
        ...
        public static Task<GetPermissionsResult> InvokeAsync(GetPermissionsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPermissionsResult>("volcengine:vke/getPermissions:getPermissions", args ?? new GetPermissionsArgs(), options.WithDefaults());
        ...
        public static Output<GetPermissionsResult> Invoke(GetPermissionsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPermissionsResult>("volcengine:vke/getPermissions:getPermissions", args ?? new GetPermissionsInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetPermissionsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPermissionsAccessPolicyResult> AccessPolicies;
        ...
        private GetPermissionsResult(
            ImmutableArray<Outputs.GetPermissionsAccessPolicyResult> accessPolicies,
