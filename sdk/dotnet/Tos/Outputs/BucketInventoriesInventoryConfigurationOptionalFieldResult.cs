...
namespace Pulumi.Volcengine.Tos.Outputs
{
    ...
    [OutputType]
    public sealed class BucketInventoriesInventoryConfigurationOptionalFieldResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private BucketInventoriesInventoryConfigurationOptionalFieldResult(ImmutableArray<string> fields)
        {
            Fields = fields;
        }
    }
