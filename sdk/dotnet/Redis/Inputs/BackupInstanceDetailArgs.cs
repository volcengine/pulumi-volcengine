...
namespace Pulumi.Volcengine.Redis.Inputs
{
    ...
    public sealed class BackupInstanceDetailArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("vpcInfos")]
        private InputList<Inputs.BackupInstanceDetailVpcInfoArgs>? _vpcInfos;

        /// <summary>
        /// Information of vpc.
        /// </summary>
        public InputList<Inputs.BackupInstanceDetailVpcInfoArgs> VpcInfos
        {
            get => _vpcInfos ?? (_vpcInfos = new InputList<Inputs.BackupInstanceDetailVpcInfoArgs>());
            set => _vpcInfos = value;
        }
