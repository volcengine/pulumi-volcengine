...
namespace Pulumi.Volcengine.Ebs
{
    public static class GetVolumes
    {
        ...
        public static Task<GetVolumesResult> InvokeAsync(GetVolumesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumesResult>("volcengine:ebs/getVolumes:getVolumes", args ?? new GetVolumesArgs(), options.WithDefaults());
        ...
        public static Output<GetVolumesResult> Invoke(GetVolumesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVolumesResult>("volcengine:ebs/getVolumes:getVolumes", args ?? new GetVolumesInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetVolumesArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private List<Inputs.GetVolumesTagArgs>? _tags;

        /// <summary>
        /// Tags.
        /// </summary>
        public List<Inputs.GetVolumesTagArgs> Tags
        {
            get => _tags ?? (_tags = new List<Inputs.GetVolumesTagArgs>());
            set => _tags = value;
        }
    ...
    public sealed class GetVolumesInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.GetVolumesTagInputArgs>? _tags;

        /// <summary>
        /// Tags.
        /// </summary>
        public InputList<Inputs.GetVolumesTagInputArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.GetVolumesTagInputArgs>());
            set => _tags = value;
        }
    ...
    public sealed class GetVolumesResult
    {
        ...
        /// Tags.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetVolumesTagResult> Tags;
        /// <summary>
        ...
        private GetVolumesResult(
            ...
            ImmutableArray<Outputs.GetVolumesTagResult> tags,
