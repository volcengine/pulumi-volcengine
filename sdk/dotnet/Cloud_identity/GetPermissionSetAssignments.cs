...
namespace Pulumi.Volcengine.Cloud_identity
{
    public static class GetPermissionSetAssignments
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetPermissionSetAssignmentsResult> InvokeAsync(GetPermissionSetAssignmentsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPermissionSetAssignmentsResult>("volcengine:cloud_identity/getPermissionSetAssignments:getPermissionSetAssignments", args ?? new GetPermissionSetAssignmentsArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetPermissionSetAssignmentsResult> Invoke(GetPermissionSetAssignmentsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPermissionSetAssignmentsResult>("volcengine:cloud_identity/getPermissionSetAssignments:getPermissionSetAssignments", args ?? new GetPermissionSetAssignmentsInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetPermissionSetAssignmentsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetPermissionSetAssignmentsArgs()
        {
        }
        public static new GetPermissionSetAssignmentsArgs Empty => new GetPermissionSetAssignmentsArgs();
    }

    public sealed class GetPermissionSetAssignmentsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// A Name Regex of Resource.
        /// </summary>
        ...
        public GetPermissionSetAssignmentsInvokeArgs()
        {
        }
        public static new GetPermissionSetAssignmentsInvokeArgs Empty => new GetPermissionSetAssignmentsInvokeArgs();
    }
    ...
    public sealed class GetPermissionSetAssignmentsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPermissionSetAssignmentsAssignmentResult> Assignments;
        /// <summary>
        ...
        private GetPermissionSetAssignmentsResult(
            ImmutableArray<Outputs.GetPermissionSetAssignmentsAssignmentResult> assignments,
