...
namespace Pulumi.Volcengine.Rds_mysql
{
    public static class GetPlannedEvents
    {
        ...
        public static Task<GetPlannedEventsResult> InvokeAsync(GetPlannedEventsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPlannedEventsResult>("volcengine:rds_mysql/getPlannedEvents:getPlannedEvents", args ?? new GetPlannedEventsArgs(), options.WithDefaults());
        ...
        public static Output<GetPlannedEventsResult> Invoke(GetPlannedEventsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPlannedEventsResult>("volcengine:rds_mysql/getPlannedEvents:getPlannedEvents", args ?? new GetPlannedEventsInvokeArgs(), options.WithDefaults());
    }
