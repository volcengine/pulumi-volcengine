...
namespace Pulumi.Volcengine.Rds_mysql.Inputs
{
    ...
    public sealed class InstanceEndpointGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodeWeights")]
        private InputList<Inputs.InstanceEndpointNodeWeightGetArgs>? _nodeWeights;

        /// <summary>
        /// The list of nodes configured by the connection terminal and the corresponding read-only weights.
        /// </summary>
        public InputList<Inputs.InstanceEndpointNodeWeightGetArgs> NodeWeights
        {
            get => _nodeWeights ?? (_nodeWeights = new InputList<Inputs.InstanceEndpointNodeWeightGetArgs>());
            set => _nodeWeights = value;
        }
