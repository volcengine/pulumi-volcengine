...
namespace Pulumi.Volcengine.Rds_mysql
{
    public static class GetTasks
    {
        ...
        public static Task<GetTasksResult> InvokeAsync(GetTasksArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTasksResult>("volcengine:rds_mysql/getTasks:getTasks", args ?? new GetTasksArgs(), options.WithDefaults());
        ...
        public static Output<GetTasksResult> Invoke(GetTasksInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTasksResult>("volcengine:rds_mysql/getTasks:getTasks", args ?? new GetTasksInvokeArgs(), options.WithDefaults());
    }
