...
namespace Pulumi.Volcengine.Cloud_monitor
{
    public static class GetRules
    {
        ...
        public static Task<GetRulesResult> InvokeAsync(GetRulesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRulesResult>("volcengine:cloud_monitor/getRules:getRules", args ?? new GetRulesArgs(), options.WithDefaults());
        ...
        public static Output<GetRulesResult> Invoke(GetRulesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRulesResult>("volcengine:cloud_monitor/getRules:getRules", args ?? new GetRulesInvokeArgs(), options.WithDefaults());
    }
