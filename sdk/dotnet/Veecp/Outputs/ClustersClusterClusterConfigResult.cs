...
namespace Pulumi.Volcengine.Veecp.Outputs
{
    ...
    [OutputType]
    public sealed class ClustersClusterClusterConfigResult
    {
        /// <summary>
        /// Endpoint information accessed by the cluster API Server.
        /// </summary>
        public readonly Outputs.ClustersClusterClusterConfigApiServerEndpointsResult ApiServerEndpoints;
        /// <summary>
        /// Cluster API Server public network access configuration.
        /// </summary>
        public readonly Outputs.ClustersClusterClusterConfigApiServerPublicAccessConfigResult ApiServerPublicAccessConfig;
        /// <summary>
        ...
        [OutputConstructor]
        private ClustersClusterClusterConfigResult(
            Outputs.ClustersClusterClusterConfigApiServerEndpointsResult apiServerEndpoints,

            Outputs.ClustersClusterClusterConfigApiServerPublicAccessConfigResult apiServerPublicAccessConfig,
