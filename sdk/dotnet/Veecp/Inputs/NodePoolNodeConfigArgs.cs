...
namespace Pulumi.Volcengine.Veecp.Inputs
{
    ...
    public sealed class NodePoolNodeConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("ecsTags")]
        private InputList<Inputs.NodePoolNodeConfigEcsTagArgs>? _ecsTags;

        /// <summary>
        /// Tags for Ecs.
        /// </summary>
        public InputList<Inputs.NodePoolNodeConfigEcsTagArgs> EcsTags
        {
            get => _ecsTags ?? (_ecsTags = new InputList<Inputs.NodePoolNodeConfigEcsTagArgs>());
            set => _ecsTags = value;
        }
        ...
        public Input<Inputs.NodePoolNodeConfigSecurityArgs> Security { get; set; } = null!;
