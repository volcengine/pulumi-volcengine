...
namespace Pulumi.Volcengine.Veecp
{
    public static class GetSupportAddons
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetSupportAddonsResult> InvokeAsync(GetSupportAddonsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSupportAddonsResult>("volcengine:veecp/getSupportAddons:getSupportAddons", args ?? new GetSupportAddonsArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetSupportAddonsResult> Invoke(GetSupportAddonsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSupportAddonsResult>("volcengine:veecp/getSupportAddons:getSupportAddons", args ?? new GetSupportAddonsInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetSupportAddonsArgs : global::Pulumi.InvokeArgs
    {
        [Input("categories")]
        ...
        public GetSupportAddonsArgs()
        {
        }
        public static new GetSupportAddonsArgs Empty => new GetSupportAddonsArgs();
    }

    public sealed class GetSupportAddonsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("categories")]
        ...
        public GetSupportAddonsInvokeArgs()
        {
        }
        public static new GetSupportAddonsInvokeArgs Empty => new GetSupportAddonsInvokeArgs();
    }


    [OutputType]
    public sealed class GetSupportAddonsResult
    {
        /// <summary>
        /// The collection of query.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSupportAddonsAddonResult> Addons;
        ...
        [OutputConstructor]
        private GetSupportAddonsResult(
            ImmutableArray<Outputs.GetSupportAddonsAddonResult> addons,
