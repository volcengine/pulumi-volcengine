...
namespace Pulumi.Volcengine.Veecp
{
    public static class GetAddons
    {
        ...
        public static Task<GetAddonsResult> InvokeAsync(GetAddonsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddonsResult>("volcengine:veecp/getAddons:getAddons", args ?? new GetAddonsArgs(), options.WithDefaults());
        ...
        public static Output<GetAddonsResult> Invoke(GetAddonsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddonsResult>("volcengine:veecp/getAddons:getAddons", args ?? new GetAddonsInvokeArgs(), options.WithDefaults());
    }
