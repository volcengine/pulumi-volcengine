...
{
    [Obsolete(@"volcengine.veecp.SupportAddons has been deprecated in favor of volcengine.veecp.getSupportAddons")]
    public static class SupportAddons
    {
        ...
        public static Task<SupportAddonsResult> InvokeAsync(SupportAddonsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<SupportAddonsResult>("volcengine:veecp/supportAddons:SupportAddons", args ?? new SupportAddonsArgs(), options.WithDefaults());
        ...
        public static Output<SupportAddonsResult> Invoke(SupportAddonsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<SupportAddonsResult>("volcengine:veecp/supportAddons:SupportAddons", args ?? new SupportAddonsInvokeArgs(), options.WithDefaults());
    }
