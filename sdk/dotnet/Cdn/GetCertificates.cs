...
namespace Pulumi.Volcengine.Cdn
{
    public static class GetCertificates
    {
        ...
        public static Task<GetCertificatesResult> InvokeAsync(GetCertificatesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificatesResult>("volcengine:cdn/getCertificates:getCertificates", args ?? new GetCertificatesArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificatesResult> Invoke(GetCertificatesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificatesResult>("volcengine:cdn/getCertificates:getCertificates", args ?? new GetCertificatesInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetCertificatesResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCertificatesCertInfoResult> CertInfos;
        /// <summary>
        ...
        private GetCertificatesResult(
            ImmutableArray<Outputs.GetCertificatesCertInfoResult> certInfos,
