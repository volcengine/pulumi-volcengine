...
namespace Pulumi.Volcengine.Cdn.Outputs
{
    ...
    [OutputType]
    public sealed class GetSharedConfigsConfigDataDenyIpAccessRuleResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSharedConfigsConfigDataDenyIpAccessRuleResult(ImmutableArray<string> rules)
        {
            Rules = rules;
        }
    }
