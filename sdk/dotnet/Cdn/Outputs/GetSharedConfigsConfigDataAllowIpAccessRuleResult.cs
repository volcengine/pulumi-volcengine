...
namespace Pulumi.Volcengine.Cdn.Outputs
{
    ...
    [OutputType]
    public sealed class GetSharedConfigsConfigDataAllowIpAccessRuleResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSharedConfigsConfigDataAllowIpAccessRuleResult(ImmutableArray<string> rules)
        {
            Rules = rules;
        }
    }
