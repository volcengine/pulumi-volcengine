...
namespace Pulumi.Volcengine.Waf.Inputs
{
    ...
    public sealed class CcRuleRuleGroupRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Advanced conditions.
        /// </summary>
        [Input("accurateGroup")]
        public Input<Inputs.CcRuleRuleGroupRuleAccurateGroupGetArgs>? AccurateGroup { get; set; }
        ...
        [Input("cronConfs")]
        private InputList<Inputs.CcRuleRuleGroupRuleCronConfGetArgs>? _cronConfs;

        /// <summary>
        /// Details of the periodic loop configuration.
        /// </summary>
        public InputList<Inputs.CcRuleRuleGroupRuleCronConfGetArgs> CronConfs
        {
            get => _cronConfs ?? (_cronConfs = new InputList<Inputs.CcRuleRuleGroupRuleCronConfGetArgs>());
        ...
        public CcRuleRuleGroupRuleGetArgs()
        {
        }
        public static new CcRuleRuleGroupRuleGetArgs Empty => new CcRuleRuleGroupRuleGetArgs();
    }
}
