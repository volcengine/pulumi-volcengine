...
{
    [Obsolete(@"volcengine.waf.HostGroups has been deprecated in favor of volcengine.waf.getHostGroups")]
    public static class HostGroups
    {
        ...
        /// ```
        /// </summary>
        public static Task<HostGroupsResult> InvokeAsync(HostGroupsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<HostGroupsResult>("volcengine:waf/hostGroups:HostGroups", args ?? new HostGroupsArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<HostGroupsResult> Invoke(HostGroupsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<HostGroupsResult>("volcengine:waf/hostGroups:HostGroups", args ?? new HostGroupsInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class HostGroupsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.HostGroupsHostGroupListResult> HostGroupLists;
        /// <summary>
        ...
        private HostGroupsResult(
            ...
            ImmutableArray<Outputs.HostGroupsHostGroupListResult> hostGroupLists,
