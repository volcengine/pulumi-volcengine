...
namespace Pulumi.Volcengine.Waf.Outputs
{
    ...
    [OutputType]
    public sealed class CcRuleRuleGroupGroup
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.CcRuleRuleGroupGroupAccurateRule> AccurateRules;
        /// <summary>
        ...
        [OutputConstructor]
        private CcRuleRuleGroupGroup(
            int? accurateGroupPriority,

            ImmutableArray<Outputs.CcRuleRuleGroupGroupAccurateRule> accurateRules,
