...
namespace Pulumi.Volcengine.Rds.Outputs
{
    ...
    [OutputType]
    public sealed class GetAccountsRdsAccountResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAccountsRdsAccountDbPrivilegeResult> DbPrivileges;
        /// <summary>
        ...
        [OutputConstructor]
        private GetAccountsRdsAccountResult(
            string accountName,
            ...
            ImmutableArray<Outputs.GetAccountsRdsAccountDbPrivilegeResult> dbPrivileges,
