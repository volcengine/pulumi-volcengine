...
{
    [Obsolete(@"volcengine.vpc.TrafficMirrorSessions has been deprecated in favor of volcengine.vpc.getTrafficMirrorSessions")]
    public static class TrafficMirrorSessions
    {
        ...
        /// ```
        /// </summary>
        public static Task<TrafficMirrorSessionsResult> InvokeAsync(TrafficMirrorSessionsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<TrafficMirrorSessionsResult>("volcengine:vpc/trafficMirrorSessions:TrafficMirrorSessions", args ?? new TrafficMirrorSessionsArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<TrafficMirrorSessionsResult> Invoke(TrafficMirrorSessionsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<TrafficMirrorSessionsResult>("volcengine:vpc/trafficMirrorSessions:TrafficMirrorSessions", args ?? new TrafficMirrorSessionsInvokeArgs(), options.WithDefaults());
    }


    public sealed class TrafficMirrorSessionsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private List<Inputs.TrafficMirrorSessionsTagArgs>? _tags;

        /// <summary>
        /// Tags.
        /// </summary>
        public List<Inputs.TrafficMirrorSessionsTagArgs> Tags
        {
            get => _tags ?? (_tags = new List<Inputs.TrafficMirrorSessionsTagArgs>());
            set => _tags = value;
        }
        ...
        public TrafficMirrorSessionsArgs()
        {
        }
        public static new TrafficMirrorSessionsArgs Empty => new TrafficMirrorSessionsArgs();
    }

    public sealed class TrafficMirrorSessionsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// A Name Regex of Resource.
        /// </summary>
        ...
        [Input("tags")]
        private InputList<Inputs.TrafficMirrorSessionsTagInputArgs>? _tags;

        /// <summary>
        /// Tags.
        /// </summary>
        public InputList<Inputs.TrafficMirrorSessionsTagInputArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.TrafficMirrorSessionsTagInputArgs>());
            set => _tags = value;
        }
        ...
        public TrafficMirrorSessionsInvokeArgs()
        {
        }
        public static new TrafficMirrorSessionsInvokeArgs Empty => new TrafficMirrorSessionsInvokeArgs();
    }


    [OutputType]
    public sealed class TrafficMirrorSessionsResult
    {
        /// <summary>
        ...
        /// Tags.
        /// </summary>
        public readonly ImmutableArray<Outputs.TrafficMirrorSessionsTagResult> Tags;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.TrafficMirrorSessionsTrafficMirrorSessionResult> TrafficMirrorSessions;
        /// <summary>
        /// The ID of traffic mirror target.
        /// </summary>
        ...
        [OutputConstructor]
        private TrafficMirrorSessionsResult(
            string id,
            ...
            ImmutableArray<Outputs.TrafficMirrorSessionsTagResult> tags,
            ...
            ImmutableArray<Outputs.TrafficMirrorSessionsTrafficMirrorSessionResult> trafficMirrorSessions,
