...
namespace Pulumi.Volcengine.Vpc
{
    ...
    /// ```
    /// </summary>
    [VolcengineResourceType("volcengine:Vpc/acl:Acl")]
    public partial class Acl : Pulumi.CustomResource
    {
        ...
        public Acl(string name, AclArgs? args = null, CustomResourceOptions? options = null)
            : base("volcengine:Vpc/acl:Acl", name, args ?? new AclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Acl(string name, Input<string> id, AclState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:Vpc/acl:Acl", name, state, MakeResourceOptions(options, id))
        {
        }
