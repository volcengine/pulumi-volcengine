...
namespace Pulumi.Volcengine.Autoscaling
{
    public static class GetScalingInstances
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetScalingInstancesResult> InvokeAsync(GetScalingInstancesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingInstancesResult>("volcengine:autoscaling/getScalingInstances:getScalingInstances", args ?? new GetScalingInstancesArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetScalingInstancesResult> Invoke(GetScalingInstancesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScalingInstancesResult>("volcengine:autoscaling/getScalingInstances:getScalingInstances", args ?? new GetScalingInstancesInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetScalingInstancesArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetScalingInstancesArgs()
        {
        }
        public static new GetScalingInstancesArgs Empty => new GetScalingInstancesArgs();
    }

    public sealed class GetScalingInstancesInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The creation type of the instances. Valid values: AutoCreated, Attached.
        /// </summary>
        ...
        public GetScalingInstancesInvokeArgs()
        {
        }
        public static new GetScalingInstancesInvokeArgs Empty => new GetScalingInstancesInvokeArgs();
    }


    [OutputType]
    public sealed class GetScalingInstancesResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetScalingInstancesScalingInstanceResult> ScalingInstances;
        /// <summary>
        ...
        [OutputConstructor]
        private GetScalingInstancesResult(
            string? creationType,
            ...
            ImmutableArray<Outputs.GetScalingInstancesScalingInstanceResult> scalingInstances,
