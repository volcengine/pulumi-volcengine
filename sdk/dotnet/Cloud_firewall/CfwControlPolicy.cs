...
namespace Pulumi.Volcengine.Cloud_firewall
{
    ...
    /// ```
    /// </summary>
    [VolcengineResourceType("volcengine:cloud_firewall/cfwControlPolicy:CfwControlPolicy")]
    public partial class CfwControlPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CfwControlPolicy(string name, CfwControlPolicyArgs args, CustomResourceOptions? options = null)
            : base("volcengine:cloud_firewall/cfwControlPolicy:CfwControlPolicy", name, args ?? new CfwControlPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CfwControlPolicy(string name, Input<string> id, CfwControlPolicyState? state = null, CustomResourceOptions? options = null)
            : base("volcengine:cloud_firewall/cfwControlPolicy:CfwControlPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CfwControlPolicy Get(string name, Input<string> id, CfwControlPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new CfwControlPolicy(name, id, state, options);
        }
    }

    public sealed class CfwControlPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The action of the control policy. Valid values: `accept`, `deny`, `monitor`.
        /// </summary>
        ...
        public CfwControlPolicyArgs()
        {
        }
        public static new CfwControlPolicyArgs Empty => new CfwControlPolicyArgs();
    }

    public sealed class CfwControlPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The account id of the control policy.
        /// </summary>
        ...
        public CfwControlPolicyState()
        {
        }
        public static new CfwControlPolicyState Empty => new CfwControlPolicyState();
    }
}
