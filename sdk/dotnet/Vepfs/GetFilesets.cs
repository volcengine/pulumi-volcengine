...
namespace Pulumi.Volcengine.Vepfs
{
    public static class GetFilesets
    {
        ...
        public static Task<GetFilesetsResult> InvokeAsync(GetFilesetsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFilesetsResult>("volcengine:vepfs/getFilesets:getFilesets", args ?? new GetFilesetsArgs(), options.WithDefaults());
        ...
        public static Output<GetFilesetsResult> Invoke(GetFilesetsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFilesetsResult>("volcengine:vepfs/getFilesets:getFilesets", args ?? new GetFilesetsInvokeArgs(), options.WithDefaults());
    }
