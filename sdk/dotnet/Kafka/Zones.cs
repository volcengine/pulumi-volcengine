...
{
    [Obsolete(@"volcengine.kafka.Zones has been deprecated in favor of volcengine.kafka.getZones")]
    public static class Zones
    {
        ...
        public static Task<ZonesResult> InvokeAsync(ZonesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ZonesResult>("volcengine:kafka/zones:Zones", args ?? new ZonesArgs(), options.WithDefaults());
        ...
        public static Output<ZonesResult> Invoke(ZonesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ZonesResult>("volcengine:kafka/zones:Zones", args ?? new ZonesInvokeArgs(), options.WithDefaults());
    }
