...
namespace Pulumi.Volcengine.Apig.Inputs
{
    ...
    public sealed class ApigRouteUpstreamListArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ai provider settings of the api gateway route.
        /// </summary>
        [Input("aiProviderSettings")]
        public Input<Inputs.ApigRouteUpstreamListAiProviderSettingsArgs>? AiProviderSettings { get; set; }
        ...
        public ApigRouteUpstreamListArgs()
        {
        }
        public static new ApigRouteUpstreamListArgs Empty => new ApigRouteUpstreamListArgs();
    }
}
