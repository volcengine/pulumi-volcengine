...
namespace Pulumi.Volcengine.Apig.Inputs
{
    ...
    public sealed class ApigUpstreamLoadBalancerSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The consistent hash lb of apig upstream.
        /// </summary>
        [Input("consistentHashLb")]
        public Input<Inputs.ApigUpstreamLoadBalancerSettingsConsistentHashLbGetArgs>? ConsistentHashLb { get; set; }
        ...
        public ApigUpstreamLoadBalancerSettingsGetArgs()
        {
        }
        public static new ApigUpstreamLoadBalancerSettingsGetArgs Empty => new ApigUpstreamLoadBalancerSettingsGetArgs();
    }
}
