...
{
    [Obsolete(@"volcengine.kms.Keys has been deprecated in favor of volcengine.kms.getKeys")]
    public static class Keys
    {
        ...
        public static Task<KeysResult> InvokeAsync(KeysArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<KeysResult>("volcengine:kms/keys:Keys", args ?? new KeysArgs(), options.WithDefaults());
        ...
        public static Output<KeysResult> Invoke(KeysInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<KeysResult>("volcengine:kms/keys:Keys", args ?? new KeysInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class KeysArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private List<Inputs.KeysTagArgs>? _tags;

        /// <summary>
        /// A list of tags.
        /// </summary>
        public List<Inputs.KeysTagArgs> Tags
        {
            get => _tags ?? (_tags = new List<Inputs.KeysTagArgs>());
            set => _tags = value;
        }
    ...
    public sealed class KeysInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.KeysTagInputArgs>? _tags;

        /// <summary>
        /// A list of tags.
        /// </summary>
        public InputList<Inputs.KeysTagInputArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.KeysTagInputArgs>());
            set => _tags = value;
        }
    ...
    public sealed class KeysResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.KeysKeyResult> Keys;
        ...
        /// Tags.
        /// </summary>
        public readonly ImmutableArray<Outputs.KeysTagResult> Tags;
        /// <summary>
        ...
        private KeysResult(
            ...
            ImmutableArray<Outputs.KeysKeyResult> keys,
            ...
            ImmutableArray<Outputs.KeysTagResult> tags,
