...
namespace Pulumi.Volcengine.Rocketmq.Outputs
{
    ...
    [OutputType]
    public sealed class AccessKeysAccessKeyResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.AccessKeysAccessKeyTopicPermissionResult> TopicPermissions;

        [OutputConstructor]
        private AccessKeysAccessKeyResult(
            string accessKey,
            ...
            ImmutableArray<Outputs.AccessKeysAccessKeyTopicPermissionResult> topicPermissions)
        {
            AccessKey = accessKey;
