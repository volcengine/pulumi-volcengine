...
warnings.warn("""volcengine.nas.AutoSnapshotPolicies has been deprecated in favor of volcengine.nas.getAutoSnapshotPolicies""", DeprecationWarning)
...
class AutoSnapshotPoliciesResult:
    ...
    def auto_snapshot_polices(self) -> Sequence['outputs.AutoSnapshotPoliciesAutoSnapshotPoliceResult']:
        """
...
def auto_snapshot_policies(auto_snapshot_policy_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""auto_snapshot_policies is deprecated: volcengine.nas.AutoSnapshotPolicies has been deprecated in favor of volcengine.nas.getAutoSnapshotPolicies""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nas/autoSnapshotPolicies:AutoSnapshotPolicies', __args__, opts=opts, typ=AutoSnapshotPoliciesResult).value
...
def auto_snapshot_policies_output(auto_snapshot_policy_id: Optional[pulumi.Input[Optional[str]]] = None,
