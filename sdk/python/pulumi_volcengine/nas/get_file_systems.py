...
class GetFileSystemsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetFileSystemsTagResult']]:
        """
...
def get_file_systems(charge_type: Optional[str] = None,
                     ...
                     tags: Optional[Sequence[pulumi.InputType['GetFileSystemsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetFileSystemsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nas/getFileSystems:getFileSystems', __args__, opts=opts, typ=GetFileSystemsResult).value
...
def get_file_systems_output(charge_type: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetFileSystemsTagArgs']]]]] = None,
