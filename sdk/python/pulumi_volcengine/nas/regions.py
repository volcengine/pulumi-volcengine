...
warnings.warn("""volcengine.nas.Regions has been deprecated in favor of volcengine.nas.getRegions""", DeprecationWarning)
...
def regions(output_file: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""regions is deprecated: volcengine.nas.Regions has been deprecated in favor of volcengine.nas.getRegions""")
    __args__ = dict()
    __args__['outputFile'] = output_file
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcengine:nas/regions:Regions', __args__, opts=opts, typ=RegionsResult).value
