...
warnings.warn("""volcengine.redis.PlannedEvents has been deprecated in favor of volcengine.redis.getPlannedEvents""", DeprecationWarning)
...
def planned_events(instance_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""planned_events is deprecated: volcengine.redis.PlannedEvents has been deprecated in favor of volcengine.redis.getPlannedEvents""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:redis/plannedEvents:PlannedEvents', __args__, opts=opts, typ=PlannedEventsResult).value
...
def planned_events_output(instance_id: Optional[pulumi.Input[Optional[str]]] = None,
