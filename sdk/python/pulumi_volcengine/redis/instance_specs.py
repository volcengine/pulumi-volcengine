...
warnings.warn("""volcengine.redis.InstanceSpecs has been deprecated in favor of volcengine.redis.getInstanceSpecs""", DeprecationWarning)
...
def instance_specs(arch_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""instance_specs is deprecated: volcengine.redis.InstanceSpecs has been deprecated in favor of volcengine.redis.getInstanceSpecs""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:redis/instanceSpecs:InstanceSpecs', __args__, opts=opts, typ=InstanceSpecsResult).value
...
def instance_specs_output(arch_type: Optional[pulumi.Input[Optional[str]]] = None,
