...
__all__ = [
    'ParameterGroupsResult',
    'AwaitableParameterGroupsResult',
    'parameter_groups',
    'parameter_groups_output',
]

warnings.warn("""volcengine.redis.ParameterGroups has been deprecated in favor of volcengine.redis.getParameterGroups""", DeprecationWarning)

@pulumi.output_type
class ParameterGroupsResult:
    """
    ...
    def parameter_groups(self) -> Sequence['outputs.ParameterGroupsParameterGroupResult']:
        """
...
class AwaitableParameterGroupsResult(ParameterGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ParameterGroupsResult(
...
def parameter_groups(engine_version: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""parameter_groups is deprecated: volcengine.redis.ParameterGroups has been deprecated in favor of volcengine.redis.getParameterGroups""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:redis/parameterGroups:ParameterGroups', __args__, opts=opts, typ=ParameterGroupsResult).value

    return AwaitableParameterGroupsResult(
...
@_utilities.lift_output_func(parameter_groups)
def parameter_groups_output(engine_version: Optional[pulumi.Input[Optional[str]]] = None,
