...
__all__ = [
    'BigKeysResult',
    'AwaitableBigKeysResult',
    'big_keys',
    'big_keys_output',
]

warnings.warn("""volcengine.redis.BigKeys has been deprecated in favor of volcengine.redis.getBigKeys""", DeprecationWarning)
...
class BigKeysResult:
    ...
    def big_keys(self) -> Sequence['outputs.BigKeysBigKeyResult']:
        """
...
class AwaitableBigKeysResult(BigKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return BigKeysResult(
...
def big_keys(instance_id: Optional[str] = None,
             ...
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableBigKeysResult:
    """
    ...
    """
    pulumi.log.warn("""big_keys is deprecated: volcengine.redis.BigKeys has been deprecated in favor of volcengine.redis.getBigKeys""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:redis/bigKeys:BigKeys', __args__, opts=opts, typ=BigKeysResult).value

    return AwaitableBigKeysResult(
...
@_utilities.lift_output_func(big_keys)
def big_keys_output(instance_id: Optional[pulumi.Input[str]] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[BigKeysResult]:
    """
    Use this data source to query detailed information of redis big keys
    ## Example Usage
