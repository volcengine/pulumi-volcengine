...
def get_backups(backup_strategy_lists: Optional[Sequence[str]] = None,
...
def get_backups_output(backup_strategy_lists: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
