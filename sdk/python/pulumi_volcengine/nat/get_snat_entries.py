...
class GetSnatEntriesResult:
    ...
    def snat_entries(self) -> Sequence['outputs.GetSnatEntriesSnatEntryResult']:
        """
...
def get_snat_entries(eip_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nat/getSnatEntries:getSnatEntries', __args__, opts=opts, typ=GetSnatEntriesResult).value
...
def get_snat_entries_output(eip_id: Optional[pulumi.Input[Optional[str]]] = None,
