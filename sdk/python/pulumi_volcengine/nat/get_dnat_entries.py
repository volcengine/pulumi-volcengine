...
__all__ = [
    'GetDnatEntriesResult',
    'AwaitableGetDnatEntriesResult',
    'get_dnat_entries',
    'get_dnat_entries_output',
]

@pulumi.output_type
class GetDnatEntriesResult:
    """
    ...
    def dnat_entries(self) -> Sequence['outputs.GetDnatEntriesDnatEntryResult']:
        """
...
class AwaitableGetDnatEntriesResult(GetDnatEntriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnatEntriesResult(
...
def get_dnat_entries(dnat_entry_name: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnatEntriesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nat/getDnatEntries:getDnatEntries', __args__, opts=opts, typ=GetDnatEntriesResult).value

    return AwaitableGetDnatEntriesResult(
...
@_utilities.lift_output_func(get_dnat_entries)
def get_dnat_entries_output(dnat_entry_name: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDnatEntriesResult]:
    """
    Use this data source to query detailed information of dnat entries
    ## Example Usage
