...
class GetGatewaysResult:
    ...
    def nat_gateways(self) -> Sequence['outputs.GetGatewaysNatGatewayResult']:
        """
...
def get_gateways(description: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nat/getGateways:getGateways', __args__, opts=opts, typ=GetGatewaysResult).value
...
def get_gateways_output(description: Optional[pulumi.Input[Optional[str]]] = None,
