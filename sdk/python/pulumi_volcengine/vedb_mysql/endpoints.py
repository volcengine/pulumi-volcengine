...
def endpoints(endpoint_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vedb_mysql/endpoints:Endpoints', __args__, opts=opts, typ=EndpointsResult).value
...
def endpoints_output(endpoint_id: Optional[pulumi.Input[Optional[str]]] = None,
