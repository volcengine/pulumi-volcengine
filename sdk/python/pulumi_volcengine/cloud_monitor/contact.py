...
class ContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] email: The email of contact.
        :param pulumi.Input[str] name: The name of contact.
        :param pulumi.Input[str] phone: The phone of contact.
        """
...
class Contact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Contact, __self__).__init__(
            'volcengine:cloud_monitor/contact:Contact',
            resource_name,
            __props__,
            opts)
