...
class GetParameterTemplatesResult:
    ...
    def template_infos(self) -> Sequence['outputs.GetParameterTemplatesTemplateInfoResult']:
        """
...
def get_parameter_templates(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getParameterTemplates:getParameterTemplates', __args__, opts=opts, typ=GetParameterTemplatesResult).value
...
def get_parameter_templates_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
