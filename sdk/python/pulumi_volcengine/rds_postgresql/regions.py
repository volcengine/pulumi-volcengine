...
warnings.warn("""volcengine.rds_postgresql.Regions has been deprecated in favor of volcengine.rds_postgresql.getRegions""", DeprecationWarning)
...
def regions(output_file: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""regions is deprecated: volcengine.rds_postgresql.Regions has been deprecated in favor of volcengine.rds_postgresql.getRegions""")
    __args__ = dict()
    __args__['outputFile'] = output_file
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/regions:Regions', __args__, opts=opts, typ=RegionsResult).value
