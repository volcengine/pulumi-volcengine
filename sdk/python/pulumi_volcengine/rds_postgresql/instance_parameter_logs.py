...
warnings.warn("""volcengine.rds_postgresql.InstanceParameterLogs has been deprecated in favor of volcengine.rds_postgresql.getInstanceParameterLogs""", DeprecationWarning)
...
def instance_parameter_logs(end_time: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""instance_parameter_logs is deprecated: volcengine.rds_postgresql.InstanceParameterLogs has been deprecated in favor of volcengine.rds_postgresql.getInstanceParameterLogs""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/instanceParameterLogs:InstanceParameterLogs', __args__, opts=opts, typ=InstanceParameterLogsResult).value
