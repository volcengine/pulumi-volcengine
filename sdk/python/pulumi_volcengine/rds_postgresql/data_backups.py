...
__all__ = [
    'DataBackupsResult',
    'AwaitableDataBackupsResult',
    'data_backups',
    'data_backups_output',
]

warnings.warn("""volcengine.rds_postgresql.DataBackups has been deprecated in favor of volcengine.rds_postgresql.getDataBackups""", DeprecationWarning)

@pulumi.output_type
class DataBackupsResult:
    """
    ...
    @property
    @pulumi.getter
    def backups(self) -> Sequence['outputs.DataBackupsBackupResult']:
        """
...
class AwaitableDataBackupsResult(DataBackupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return DataBackupsResult(
...
def data_backups(backup_database_name: Optional[str] = None,
                 ...
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableDataBackupsResult:
    """
    ...
    """
    pulumi.log.warn("""data_backups is deprecated: volcengine.rds_postgresql.DataBackups has been deprecated in favor of volcengine.rds_postgresql.getDataBackups""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/dataBackups:DataBackups', __args__, opts=opts, typ=DataBackupsResult).value

    return AwaitableDataBackupsResult(
...
@_utilities.lift_output_func(data_backups)
def data_backups_output(backup_database_name: Optional[pulumi.Input[Optional[str]]] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[DataBackupsResult]:
    """
    Use this data source to query detailed information of rds postgresql data backups
    ## Example Usage
