...
__all__ = [
    ...
    'AwaitableGetInstanceParametersResult',
    'get_instance_parameters',
    'get_instance_parameters_output',
]

@pulumi.output_type
class GetInstanceParametersResult:
    """
    ...
    def instance_parameters(self) -> Sequence['outputs.GetInstanceParametersInstanceParameterResult']:
        """
...
class AwaitableGetInstanceParametersResult(GetInstanceParametersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInstanceParametersResult(
            id=self.id,
...
def get_instance_parameters(instance_id: Optional[str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceParametersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getInstanceParameters:getInstanceParameters', __args__, opts=opts, typ=GetInstanceParametersResult).value

    return AwaitableGetInstanceParametersResult(
...
@_utilities.lift_output_func(get_instance_parameters)
def get_instance_parameters_output(instance_id: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInstanceParametersResult]:
    """
    Use this data source to query detailed information of rds postgresql instance parameters
    ## Example Usage
