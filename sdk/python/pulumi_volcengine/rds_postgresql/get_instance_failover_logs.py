...
__all__ = [
    'GetInstanceFailoverLogsResult',
    'AwaitableGetInstanceFailoverLogsResult',
    'get_instance_failover_logs',
    'get_instance_failover_logs_output',
]

@pulumi.output_type
class GetInstanceFailoverLogsResult:
    """
    ...
    def failover_logs(self) -> Sequence['outputs.GetInstanceFailoverLogsFailoverLogResult']:
        """
...
class AwaitableGetInstanceFailoverLogsResult(GetInstanceFailoverLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInstanceFailoverLogsResult(
...
def get_instance_failover_logs(instance_id: Optional[str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceFailoverLogsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getInstanceFailoverLogs:getInstanceFailoverLogs', __args__, opts=opts, typ=GetInstanceFailoverLogsResult).value

    return AwaitableGetInstanceFailoverLogsResult(
...
@_utilities.lift_output_func(get_instance_failover_logs)
def get_instance_failover_logs_output(instance_id: Optional[pulumi.Input[str]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInstanceFailoverLogsResult]:
    """
    Use this data source to query detailed information of rds postgresql instance failover logs
    ## Example Usage
