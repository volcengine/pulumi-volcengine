...
def get_schemas(db_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getSchemas:getSchemas', __args__, opts=opts, typ=GetSchemasResult).value
...
def get_schemas_output(db_name: Optional[pulumi.Input[Optional[str]]] = None,
