...
warnings.warn("""volcengine.rds_postgresql.Zones has been deprecated in favor of volcengine.rds_postgresql.getZones""", DeprecationWarning)
...
def zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
