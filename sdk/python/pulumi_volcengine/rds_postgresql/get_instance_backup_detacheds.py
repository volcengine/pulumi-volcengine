...
__all__ = [
    'GetInstanceBackupDetachedsResult',
    'AwaitableGetInstanceBackupDetachedsResult',
    'get_instance_backup_detacheds',
    'get_instance_backup_detacheds_output',
]

@pulumi.output_type
class GetInstanceBackupDetachedsResult:
    """
    ...
    @property
    @pulumi.getter
    def backups(self) -> Sequence['outputs.GetInstanceBackupDetachedsBackupResult']:
        """
...
class AwaitableGetInstanceBackupDetachedsResult(GetInstanceBackupDetachedsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInstanceBackupDetachedsResult(
...
def get_instance_backup_detacheds(backup_end_time: Optional[str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceBackupDetachedsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getInstanceBackupDetacheds:getInstanceBackupDetacheds', __args__, opts=opts, typ=GetInstanceBackupDetachedsResult).value

    return AwaitableGetInstanceBackupDetachedsResult(
...
@_utilities.lift_output_func(get_instance_backup_detacheds)
def get_instance_backup_detacheds_output(backup_end_time: Optional[pulumi.Input[Optional[str]]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInstanceBackupDetachedsResult]:
    """
    Use this data source to query detailed information of rds postgresql instance backup detacheds
    ## Example Usage
