...
__all__ = [
    'InstanceTasksResult',
    'AwaitableInstanceTasksResult',
    'instance_tasks',
    'instance_tasks_output',
]

warnings.warn("""volcengine.rds_postgresql.InstanceTasks has been deprecated in favor of volcengine.rds_postgresql.getInstanceTasks""", DeprecationWarning)

@pulumi.output_type
class InstanceTasksResult:
    """
    ...
    def task_infos(self) -> Sequence['outputs.InstanceTasksTaskInfoResult']:
        """
        Task list.
        """
...
class AwaitableInstanceTasksResult(InstanceTasksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return InstanceTasksResult(
...
def instance_tasks(creation_end_time: Optional[str] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableInstanceTasksResult:
    """
    ...
    """
    pulumi.log.warn("""instance_tasks is deprecated: volcengine.rds_postgresql.InstanceTasks has been deprecated in favor of volcengine.rds_postgresql.getInstanceTasks""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/instanceTasks:InstanceTasks', __args__, opts=opts, typ=InstanceTasksResult).value

    return AwaitableInstanceTasksResult(
...
@_utilities.lift_output_func(instance_tasks)
def instance_tasks_output(creation_end_time: Optional[pulumi.Input[Optional[str]]] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[InstanceTasksResult]:
    """
    Use this data source to query detailed information of rds postgresql instance tasks
    ## Example Usage
