...
__all__ = [
    'GetReplicationSlotsResult',
    'AwaitableGetReplicationSlotsResult',
    'get_replication_slots',
    'get_replication_slots_output',
]

@pulumi.output_type
class GetReplicationSlotsResult:
    """
    ...
    def replication_slots(self) -> Sequence['outputs.GetReplicationSlotsReplicationSlotResult']:
        """
...
class AwaitableGetReplicationSlotsResult(GetReplicationSlotsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetReplicationSlotsResult(
...
def get_replication_slots(data_base: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReplicationSlotsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/getReplicationSlots:getReplicationSlots', __args__, opts=opts, typ=GetReplicationSlotsResult).value

    return AwaitableGetReplicationSlotsResult(
...
@_utilities.lift_output_func(get_replication_slots)
def get_replication_slots_output(data_base: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetReplicationSlotsResult]:
    """
    Use this data source to query detailed information of rds postgresql replication slots
    ## Example Usage
