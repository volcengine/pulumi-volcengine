...
warnings.warn("""volcengine.rds_postgresql.InstanceSpecs has been deprecated in favor of volcengine.rds_postgresql.getInstanceSpecs""", DeprecationWarning)
...
def instance_specs(db_engine_version: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""instance_specs is deprecated: volcengine.rds_postgresql.InstanceSpecs has been deprecated in favor of volcengine.rds_postgresql.getInstanceSpecs""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_postgresql/instanceSpecs:InstanceSpecs', __args__, opts=opts, typ=InstanceSpecsResult).value
