...
class InstanceReadonlyNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: The RDS PostgreSQL instance id of the readonly node.
...
class InstanceReadonlyNode(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(InstanceReadonlyNode, __self__).__init__(
            'volcengine:rds_postgresql/instanceReadonlyNode:InstanceReadonlyNode',
            resource_name,
            __props__,
            opts)
