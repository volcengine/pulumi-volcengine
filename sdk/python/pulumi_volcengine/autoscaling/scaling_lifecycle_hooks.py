...
__all__ = [
    'ScalingLifecycleHooksResult',
    'AwaitableScalingLifecycleHooksResult',
    'scaling_lifecycle_hooks',
...
class ScalingLifecycleHooksResult:
    ...
    def lifecycle_hooks(self) -> Sequence['outputs.ScalingLifecycleHooksLifecycleHookResult']:
        """
...
class AwaitableScalingLifecycleHooksResult(ScalingLifecycleHooksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ScalingLifecycleHooksResult(
            id=self.id,
            ids=self.ids,
...
def scaling_lifecycle_hooks(ids: Optional[Sequence[str]] = None,
...
@_utilities.lift_output_func(scaling_lifecycle_hooks)
def scaling_lifecycle_hooks_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
