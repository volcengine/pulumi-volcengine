...
class GetScalingPoliciesResult:
    ...
    def scaling_policies(self) -> Sequence['outputs.GetScalingPoliciesScalingPolicyResult']:
        """
...
def get_scaling_policies(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:autoscaling/getScalingPolicies:getScalingPolicies', __args__, opts=opts, typ=GetScalingPoliciesResult).value
...
def get_scaling_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
