...
__all__ = [
    'GetScalingInstancesResult',
    'AwaitableGetScalingInstancesResult',
    'get_scaling_instances',
    'get_scaling_instances_output',
]

@pulumi.output_type
class GetScalingInstancesResult:
    """
    ...
    def scaling_instances(self) -> Sequence['outputs.GetScalingInstancesScalingInstanceResult']:
        """
...
class AwaitableGetScalingInstancesResult(GetScalingInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetScalingInstancesResult(
...
def get_scaling_instances(creation_type: Optional[str] = None,
                          ids: Optional[Sequence[str]] = None,
                          output_file: Optional[str] = None,
                          scaling_configuration_id: Optional[str] = None,
                          scaling_group_id: Optional[str] = None,
                          status: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScalingInstancesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:autoscaling/getScalingInstances:getScalingInstances', __args__, opts=opts, typ=GetScalingInstancesResult).value

    return AwaitableGetScalingInstancesResult(
...
@_utilities.lift_output_func(get_scaling_instances)
def get_scaling_instances_output(creation_type: Optional[pulumi.Input[Optional[str]]] = None,
                                 ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                 output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                 scaling_configuration_id: Optional[pulumi.Input[Optional[str]]] = None,
                                 scaling_group_id: Optional[pulumi.Input[str]] = None,
                                 status: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetScalingInstancesResult]:
    """
    Use this data source to query detailed information of scaling instances
    ## Example Usage
