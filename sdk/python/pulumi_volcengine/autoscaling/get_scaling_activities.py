...
__all__ = [
    ...
    'AwaitableGetScalingActivitiesResult',
    'get_scaling_activities',
    'get_scaling_activities_output',
]

@pulumi.output_type
class GetScalingActivitiesResult:
    """
    ...
    @property
    @pulumi.getter
    def activities(self) -> Sequence['outputs.GetScalingActivitiesActivityResult']:
        """
...
class AwaitableGetScalingActivitiesResult(GetScalingActivitiesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetScalingActivitiesResult(
...
def get_scaling_activities(end_time: Optional[str] = None,
                           ids: Optional[Sequence[str]] = None,
                           output_file: Optional[str] = None,
                           scaling_group_id: Optional[str] = None,
                           start_time: Optional[str] = None,
                           status_code: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScalingActivitiesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:autoscaling/getScalingActivities:getScalingActivities', __args__, opts=opts, typ=GetScalingActivitiesResult).value

    return AwaitableGetScalingActivitiesResult(
...
@_utilities.lift_output_func(get_scaling_activities)
def get_scaling_activities_output(end_time: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetScalingActivitiesResult]:
    """
    Use this data source to query detailed information of scaling activities
    ## Example Usage
