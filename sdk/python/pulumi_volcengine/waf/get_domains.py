...
class GetDomainsResult:
    ...
    @property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetDomainsDataResult']:
        """
...
def get_domains(accurate_query: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult).value
...
def get_domains_output(accurate_query: Optional[pulumi.Input[Optional[int]]] = None,
