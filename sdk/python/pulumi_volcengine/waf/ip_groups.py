...
__all__ = [
    'IpGroupsResult',
    'AwaitableIpGroupsResult',
    'ip_groups',
    'ip_groups_output',
]

warnings.warn("""volcengine.waf.IpGroups has been deprecated in favor of volcengine.waf.getIpGroups""", DeprecationWarning)

@pulumi.output_type
class IpGroupsResult:
    """
    ...
    def ip_group_lists(self) -> Sequence['outputs.IpGroupsIpGroupListResult']:
        """
...
class AwaitableIpGroupsResult(IpGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return IpGroupsResult(
            id=self.id,
            ip=self.ip,
...
def ip_groups(ip: Optional[str] = None,
              ...
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableIpGroupsResult:
    """
    ...
    """
    pulumi.log.warn("""ip_groups is deprecated: volcengine.waf.IpGroups has been deprecated in favor of volcengine.waf.getIpGroups""")
    __args__ = dict()
    __args__['ip'] = ip
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/ipGroups:IpGroups', __args__, opts=opts, typ=IpGroupsResult).value

    return AwaitableIpGroupsResult(
...
@_utilities.lift_output_func(ip_groups)
def ip_groups_output(ip: Optional[pulumi.Input[Optional[str]]] = None,
                     name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                     output_file: Optional[pulumi.Input[Optional[str]]] = None,
                     rule_tag: Optional[pulumi.Input[Optional[str]]] = None,
                     time_order_by: Optional[pulumi.Input[str]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[IpGroupsResult]:
    """
    Use this data source to query detailed information of waf ip groups
    ## Example Usage
