...
__all__ = [
    'GetAclRulesResult',
    'AwaitableGetAclRulesResult',
    'get_acl_rules',
    'get_acl_rules_output',
]

@pulumi.output_type
class GetAclRulesResult:
    """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetAclRulesRuleResult']:
        """
...
class AwaitableGetAclRulesResult(GetAclRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAclRulesResult(
...
def get_acl_rules(acl_type: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAclRulesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/getAclRules:getAclRules', __args__, opts=opts, typ=GetAclRulesResult).value

    return AwaitableGetAclRulesResult(
...
@_utilities.lift_output_func(get_acl_rules)
def get_acl_rules_output(acl_type: Optional[pulumi.Input[str]] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAclRulesResult]:
    """
    Use this data source to query detailed information of waf acl rules
    ## Example Usage
