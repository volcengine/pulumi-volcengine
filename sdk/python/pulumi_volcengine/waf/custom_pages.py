...
__all__ = [
    'CustomPagesResult',
    'AwaitableCustomPagesResult',
    'custom_pages',
    'custom_pages_output',
]

warnings.warn("""volcengine.waf.CustomPages has been deprecated in favor of volcengine.waf.getCustomPages""", DeprecationWarning)

@pulumi.output_type
class CustomPagesResult:
    """
    ...
    @property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.CustomPagesDataResult']:
        """
...
class AwaitableCustomPagesResult(CustomPagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return CustomPagesResult(
            datas=self.datas,
            host=self.host,
            id=self.id,
...
def custom_pages(host: Optional[str] = None,
                 ...
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableCustomPagesResult:
    """
    ...
    """
    pulumi.log.warn("""custom_pages is deprecated: volcengine.waf.CustomPages has been deprecated in favor of volcengine.waf.getCustomPages""")
    __args__ = dict()
    __args__['host'] = host
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/customPages:CustomPages', __args__, opts=opts, typ=CustomPagesResult).value

    return AwaitableCustomPagesResult(
...
@_utilities.lift_output_func(custom_pages)
def custom_pages_output(host: Optional[pulumi.Input[str]] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[CustomPagesResult]:
    """
    Use this data source to query detailed information of waf custom pages
    ## Example Usage
