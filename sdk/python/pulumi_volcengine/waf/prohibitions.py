...
__all__ = [
    'ProhibitionsResult',
    'AwaitableProhibitionsResult',
    'prohibitions',
    'prohibitions_output',
]

warnings.warn("""volcengine.waf.Prohibitions has been deprecated in favor of volcengine.waf.getProhibitions""", DeprecationWarning)

@pulumi.output_type
class ProhibitionsResult:
    """
    ...
    def ip_agg_groups(self) -> Sequence['outputs.ProhibitionsIpAggGroupResult']:
        """
...
class AwaitableProhibitionsResult(ProhibitionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ProhibitionsResult(
...
def prohibitions(end_time: Optional[int] = None,
                 ...
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableProhibitionsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/prohibitions:Prohibitions', __args__, opts=opts, typ=ProhibitionsResult).value

    return AwaitableProhibitionsResult(
...
@_utilities.lift_output_func(prohibitions)
def prohibitions_output(end_time: Optional[pulumi.Input[int]] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ProhibitionsResult]:
    """
    Use this data source to query detailed information of waf prohibitions
    ## Example Usage
