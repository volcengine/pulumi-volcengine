...
class GetCcRulesResult:
    ...
    @property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetCcRulesDataResult']:
        """
...
def get_cc_rules(cc_types: Optional[Sequence[int]] = None,
                 ...
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCcRulesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/getCcRules:getCcRules', __args__, opts=opts, typ=GetCcRulesResult).value
...
@_utilities.lift_output_func(get_cc_rules)
def get_cc_rules_output(cc_types: Optional[pulumi.Input[Optional[Sequence[int]]]] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCcRulesResult]:
    """
    Use this data source to query detailed information of waf cc rules
    ## Example Usage
