...
warnings.warn("""volcengine.waf.HostGroups has been deprecated in favor of volcengine.waf.getHostGroups""", DeprecationWarning)
...
class HostGroupsResult:
    ...
    def host_group_lists(self) -> Sequence['outputs.HostGroupsHostGroupListResult']:
        """
...
def host_groups(host_fix: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""host_groups is deprecated: volcengine.waf.HostGroups has been deprecated in favor of volcengine.waf.getHostGroups""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:waf/hostGroups:HostGroups', __args__, opts=opts, typ=HostGroupsResult).value
...
def host_groups_output(host_fix: Optional[pulumi.Input[Optional[str]]] = None,
