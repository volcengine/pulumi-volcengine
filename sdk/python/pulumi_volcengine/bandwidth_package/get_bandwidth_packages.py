...
class GetBandwidthPackagesResult:
    ...
    def tag_filters(self) -> Optional[Sequence['outputs.GetBandwidthPackagesTagFilterResult']]:
...
def get_bandwidth_packages(bandwidth_package_name: Optional[str] = None,
                           ...
                           tag_filters: Optional[Sequence[pulumi.InputType['GetBandwidthPackagesTagFilterArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetBandwidthPackagesTagFilterArgs']] tag_filters: A list of tags.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:bandwidth_package/getBandwidthPackages:getBandwidthPackages', __args__, opts=opts, typ=GetBandwidthPackagesResult).value
...
def get_bandwidth_packages_output(bandwidth_package_name: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  tag_filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetBandwidthPackagesTagFilterArgs']]]]] = None,
