...
class GetPrivateZonesResult:
    ...
    def private_zones(self) -> Sequence['outputs.GetPrivateZonesPrivateZoneResult']:
        """
...
def get_private_zones(key_word: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:private_zone/getPrivateZones:getPrivateZones', __args__, opts=opts, typ=GetPrivateZonesResult).value
