...
def get_saml_providers(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:iam/getSamlProviders:getSamlProviders', __args__, opts=opts, typ=GetSamlProvidersResult).value
...
def get_saml_providers_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
