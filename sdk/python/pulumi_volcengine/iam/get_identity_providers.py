...
class GetIdentityProvidersResult:
    ...
    @property
    @pulumi.getter
    def providers(self) -> Sequence['outputs.GetIdentityProvidersProviderResult']:
        """
...
def get_identity_providers(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:iam/getIdentityProviders:getIdentityProviders', __args__, opts=opts, typ=GetIdentityProvidersResult).value
...
def get_identity_providers_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
