...
def get_user_groups(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:iam/getUserGroups:getUserGroups', __args__, opts=opts, typ=GetUserGroupsResult).value
...
def get_user_groups_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
