...
warnings.warn("""volcengine.veecp.Addons has been deprecated in favor of volcengine.veecp.getAddons""", DeprecationWarning)
...
def addons(categories: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/addons:Addons', __args__, opts=opts, typ=AddonsResult).value
...
def addons_output(categories: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
