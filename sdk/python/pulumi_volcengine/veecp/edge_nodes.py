...
__all__ = [
    'EdgeNodesResult',
    'AwaitableEdgeNodesResult',
    'edge_nodes',
    'edge_nodes_output',
]

warnings.warn("""volcengine.veecp.EdgeNodes has been deprecated in favor of volcengine.veecp.getEdgeNodes""", DeprecationWarning)

@pulumi.output_type
class EdgeNodesResult:
    """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Sequence['outputs.EdgeNodesNodeResult']:
        """
    ...
    @property
    @pulumi.getter
    def statuses(self) -> Optional[Sequence['outputs.EdgeNodesStatusResult']]:
...
class AwaitableEdgeNodesResult(EdgeNodesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return EdgeNodesResult(
...
def edge_nodes(cluster_ids: Optional[Sequence[str]] = None,
               ...
               statuses: Optional[Sequence[pulumi.InputType['EdgeNodesStatusArgs']]] = None,
               zone_ids: Optional[Sequence[str]] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableEdgeNodesResult:
    """
    ...
    :param Sequence[pulumi.InputType['EdgeNodesStatusArgs']] statuses: The Status of filter.
    :param Sequence[str] zone_ids: The Zone IDs.
    """
    pulumi.log.warn("""edge_nodes is deprecated: volcengine.veecp.EdgeNodes has been deprecated in favor of volcengine.veecp.getEdgeNodes""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/edgeNodes:EdgeNodes', __args__, opts=opts, typ=EdgeNodesResult).value

    return AwaitableEdgeNodesResult(
...
@_utilities.lift_output_func(edge_nodes)
def edge_nodes_output(cluster_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                      ...
                      statuses: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['EdgeNodesStatusArgs']]]]] = None,
                      zone_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[EdgeNodesResult]:
    """
    Use this data source to query detailed information of veecp edge nodes
    ## Example Usage
