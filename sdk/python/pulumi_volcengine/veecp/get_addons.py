...
def get_addons(categories: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/getAddons:getAddons', __args__, opts=opts, typ=GetAddonsResult).value
...
def get_addons_output(categories: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
