...
__all__ = [
    'EdgeNodePoolsResult',
    'AwaitableEdgeNodePoolsResult',
    'edge_node_pools',
    'edge_node_pools_output',
]

warnings.warn("""volcengine.veecp.EdgeNodePools has been deprecated in favor of volcengine.veecp.getEdgeNodePools""", DeprecationWarning)

@pulumi.output_type
class EdgeNodePoolsResult:
    """
    ...
    def node_pools(self) -> Sequence['outputs.EdgeNodePoolsNodePoolResult']:
        """
    ...
    @property
    @pulumi.getter
    def statuses(self) -> Optional[Sequence['outputs.EdgeNodePoolsStatusResult']]:
...
class AwaitableEdgeNodePoolsResult(EdgeNodePoolsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return EdgeNodePoolsResult(
...
def edge_node_pools(add_by_auto: Optional[bool] = None,
                    ...
                    statuses: Optional[Sequence[pulumi.InputType['EdgeNodePoolsStatusArgs']]] = None,
                    update_client_token: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableEdgeNodePoolsResult:
    """
    ...
    :param Sequence[pulumi.InputType['EdgeNodePoolsStatusArgs']] statuses: The Status of NodePool.
    :param str update_client_token: The ClientToken when last update was successful.
    """
    pulumi.log.warn("""edge_node_pools is deprecated: volcengine.veecp.EdgeNodePools has been deprecated in favor of volcengine.veecp.getEdgeNodePools""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/edgeNodePools:EdgeNodePools', __args__, opts=opts, typ=EdgeNodePoolsResult).value

    return AwaitableEdgeNodePoolsResult(
...
@_utilities.lift_output_func(edge_node_pools)
def edge_node_pools_output(add_by_auto: Optional[pulumi.Input[Optional[bool]]] = None,
                           ...
                           statuses: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['EdgeNodePoolsStatusArgs']]]]] = None,
                           update_client_token: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[EdgeNodePoolsResult]:
    """
    Use this data source to query detailed information of veecp edge node pools
    ## Example Usage
