...
warnings.warn("""volcengine.veecp.NodePools has been deprecated in favor of volcengine.veecp.getNodePools""", DeprecationWarning)
...
def node_pools(auto_scaling_enabled: Optional[bool] = None,
    ...
    """
    pulumi.log.warn("""node_pools is deprecated: volcengine.veecp.NodePools has been deprecated in favor of volcengine.veecp.getNodePools""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/nodePools:NodePools', __args__, opts=opts, typ=NodePoolsResult).value
