...
warnings.warn("""volcengine.veecp.SupportAddons has been deprecated in favor of volcengine.veecp.getSupportAddons""", DeprecationWarning)
...
def support_addons(categories: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""support_addons is deprecated: volcengine.veecp.SupportAddons has been deprecated in favor of volcengine.veecp.getSupportAddons""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/supportAddons:SupportAddons', __args__, opts=opts, typ=SupportAddonsResult).value
