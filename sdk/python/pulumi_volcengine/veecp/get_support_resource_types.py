...
__all__ = [
    'GetSupportResourceTypesResult',
    'AwaitableGetSupportResourceTypesResult',
    'get_support_resource_types',
    'get_support_resource_types_output',
]

@pulumi.output_type
class GetSupportResourceTypesResult:
    """
    ...
    @property
    @pulumi.getter
    def resources(self) -> Sequence['outputs.GetSupportResourceTypesResourceResult']:
        """
...
class AwaitableGetSupportResourceTypesResult(GetSupportResourceTypesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSupportResourceTypesResult(
            id=self.id,
...
def get_support_resource_types(output_file: Optional[str] = None,
                               resource_types: Optional[Sequence[str]] = None,
                               zone_ids: Optional[Sequence[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSupportResourceTypesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veecp/getSupportResourceTypes:getSupportResourceTypes', __args__, opts=opts, typ=GetSupportResourceTypesResult).value

    return AwaitableGetSupportResourceTypesResult(
...
@_utilities.lift_output_func(get_support_resource_types)
def get_support_resource_types_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                      resource_types: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                      zone_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSupportResourceTypesResult]:
    """
    Use this data source to query detailed information of veecp support resource types
    ## Example Usage
