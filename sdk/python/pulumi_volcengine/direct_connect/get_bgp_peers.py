...
class GetBgpPeersResult:
    ...
    def bgp_peers(self) -> Sequence['outputs.GetBgpPeersBgpPeerResult']:
        """
...
def get_bgp_peers(bgp_peer_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:direct_connect/getBgpPeers:getBgpPeers', __args__, opts=opts, typ=GetBgpPeersResult).value
...
def get_bgp_peers_output(bgp_peer_name: Optional[pulumi.Input[Optional[str]]] = None,
