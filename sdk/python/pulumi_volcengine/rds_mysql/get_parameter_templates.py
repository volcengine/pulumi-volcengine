...
class GetParameterTemplatesResult:
    ...
    @property
    @pulumi.getter
    def templates(self) -> Sequence['outputs.GetParameterTemplatesTemplateResult']:
        """
...
def get_parameter_templates(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mysql/getParameterTemplates:getParameterTemplates', __args__, opts=opts, typ=GetParameterTemplatesResult).value
