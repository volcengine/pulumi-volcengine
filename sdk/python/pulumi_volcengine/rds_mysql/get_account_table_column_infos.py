...
__all__ = [
    'GetAccountTableColumnInfosResult',
    'AwaitableGetAccountTableColumnInfosResult',
    'get_account_table_column_infos',
    'get_account_table_column_infos_output',
]

@pulumi.output_type
class GetAccountTableColumnInfosResult:
    """
    ...
    def table_infos(self) -> Sequence['outputs.GetAccountTableColumnInfosTableInfoResult']:
        """
...
class AwaitableGetAccountTableColumnInfosResult(GetAccountTableColumnInfosResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccountTableColumnInfosResult(
...
def get_account_table_column_infos(account_name: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccountTableColumnInfosResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mysql/getAccountTableColumnInfos:getAccountTableColumnInfos', __args__, opts=opts, typ=GetAccountTableColumnInfosResult).value

    return AwaitableGetAccountTableColumnInfosResult(
...
@_utilities.lift_output_func(get_account_table_column_infos)
def get_account_table_column_infos_output(account_name: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccountTableColumnInfosResult]:
    """
    Use this data source to query detailed information of rds mysql account table column infos
    ## Example Usage
