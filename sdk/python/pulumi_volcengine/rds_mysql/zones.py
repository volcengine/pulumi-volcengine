...
warnings.warn("""volcengine.rds_mysql.Zones has been deprecated in favor of volcengine.rds_mysql.getZones""", DeprecationWarning)
...
def zones(output_file: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""zones is deprecated: volcengine.rds_mysql.Zones has been deprecated in favor of volcengine.rds_mysql.getZones""")
    __args__ = dict()
    __args__['outputFile'] = output_file
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mysql/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
