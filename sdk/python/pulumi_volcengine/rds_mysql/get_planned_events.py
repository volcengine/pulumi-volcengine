...
def get_planned_events(begin_time: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mysql/getPlannedEvents:getPlannedEvents', __args__, opts=opts, typ=GetPlannedEventsResult).value
...
def get_planned_events_output(begin_time: Optional[pulumi.Input[Optional[str]]] = None,
