...
__all__ = [
    'CfwControlPoliciesResult',
    'AwaitableCfwControlPoliciesResult',
    'cfw_control_policies',
...
class CfwControlPoliciesResult:
    ...
    def control_policies(self) -> Sequence['outputs.CfwControlPoliciesControlPolicyResult']:
        """
...
class AwaitableCfwControlPoliciesResult(CfwControlPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return CfwControlPoliciesResult(
...
def cfw_control_policies(actions: Optional[Sequence[str]] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableCfwControlPoliciesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_firewall/cfwControlPolicies:CfwControlPolicies', __args__, opts=opts, typ=CfwControlPoliciesResult).value

    return AwaitableCfwControlPoliciesResult(
...
@_utilities.lift_output_func(cfw_control_policies)
def cfw_control_policies_output(actions: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[CfwControlPoliciesResult]:
    """
    Use this data source to query detailed information of cfw control policies
    ## Example Usage
