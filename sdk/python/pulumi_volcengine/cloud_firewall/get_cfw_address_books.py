...
__all__ = [
    'GetCfwAddressBooksResult',
    'AwaitableGetCfwAddressBooksResult',
    'get_cfw_address_books',
    'get_cfw_address_books_output',
]

@pulumi.output_type
class GetCfwAddressBooksResult:
    """
    ...
    def address_books(self) -> Sequence['outputs.GetCfwAddressBooksAddressBookResult']:
        """
...
class AwaitableGetCfwAddressBooksResult(GetCfwAddressBooksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCfwAddressBooksResult(
...
def get_cfw_address_books(address: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCfwAddressBooksResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_firewall/getCfwAddressBooks:getCfwAddressBooks', __args__, opts=opts, typ=GetCfwAddressBooksResult).value

    return AwaitableGetCfwAddressBooksResult(
...
@_utilities.lift_output_func(get_cfw_address_books)
def get_cfw_address_books_output(address: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCfwAddressBooksResult]:
    """
    Use this data source to query detailed information of cfw address books
    ## Example Usage
