...
__all__ = ['CfwVpcFirewallAclRuleArgs', 'CfwVpcFirewallAclRule']

@pulumi.input_type
class CfwVpcFirewallAclRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The action of the vpc firewall acl rule. Valid values: `accept`, `deny`, `monitor`.
        :param pulumi.Input[str] destination: The destination of the vpc firewall acl rule.
        :param pulumi.Input[str] destination_type: The destination type of the vpc firewall acl rule. Valid values: `net`, `group`, `location`, `domain`.
        :param pulumi.Input[str] proto: The proto of the vpc firewall acl rule. Valid values: `TCP`, `ICMP`, `UDP`, `ANY`. When the destination_type is `domain`, The proto must be `TCP`.
        :param pulumi.Input[str] source: The source of the vpc firewall acl rule.
        :param pulumi.Input[str] source_type: The source type of the vpc firewall acl rule. Valid values: `net`, `group`.
        :param pulumi.Input[str] vpc_firewall_id: The id of the vpc firewall.
        :param pulumi.Input[str] description: The description of the vpc firewall acl rule.
        :param pulumi.Input[str] dest_port: The dest port of the vpc firewall acl rule.
        :param pulumi.Input[str] dest_port_type: The dest port type of the vpc firewall acl rule. Valid values: `port`, `group`.
        :param pulumi.Input[int] end_time: The end time of the vpc firewall acl rule. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[int] priority: The priority of the vpc firewall acl rule. Default is 0. This field is only effective when creating a control policy.0 means lowest priority, 1 means highest priority. The priority increases in order from 1, with lower priority indicating higher priority.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] repeat_days: The repeat days of the vpc firewall acl rule. When the value of repeat_type is one of `Weekly`, `Monthly`, this field is required.
               When the repeat_type is `Weekly`, the valid value range is 0~6.
               When the repeat_type is `Monthly`, the valid value range is 1~31.
        :param pulumi.Input[str] repeat_end_time: The repeat end time of the vpc firewall acl rule. Accurate to the minute, in the format of hh: mm. For example: 12:00.
               When the value of repeat_type is one of `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[str] repeat_start_time: The repeat start time of the vpc firewall acl rule. Accurate to the minute, in the format of hh: mm. For example: 12:00.
               When the value of repeat_type is one of `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[str] repeat_type: The repeat type of the vpc firewall acl rule. Valid values: `Permanent`, `Once`, `Daily`, `Weekly`, `Monthly`.
        :param pulumi.Input[int] start_time: The start time of the vpc firewall acl rule. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[bool] status: Whether to enable the vpc firewall acl rule. Default is false.
        """
...
@pulumi.input_type
class _CfwVpcFirewallAclRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: The account id of the vpc firewall acl rule.
        :param pulumi.Input[str] action: The action of the vpc firewall acl rule. Valid values: `accept`, `deny`, `monitor`.
        :param pulumi.Input[str] description: The description of the vpc firewall acl rule.
        :param pulumi.Input[str] dest_port: The dest port of the vpc firewall acl rule.
        :param pulumi.Input[str] dest_port_type: The dest port type of the vpc firewall acl rule. Valid values: `port`, `group`.
        :param pulumi.Input[str] destination: The destination of the vpc firewall acl rule.
        :param pulumi.Input[str] destination_type: The destination type of the vpc firewall acl rule. Valid values: `net`, `group`, `location`, `domain`.
        :param pulumi.Input[int] effect_status: The effect status of the vpc firewall acl rule. 1: Not yet effective, 2: Issued in progress, 3: Effective.
        :param pulumi.Input[int] end_time: The end time of the vpc firewall acl rule. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[int] hit_cnt: The hit count of the vpc firewall acl rule.
        :param pulumi.Input[bool] is_effected: Whether the vpc firewall acl rule is effected.
        ...
        :param pulumi.Input[int] start_time: The start time of the vpc firewall acl rule. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[bool] status: Whether to enable the vpc firewall acl rule. Default is false.
        :param pulumi.Input[int] update_time: The update time of the vpc firewall acl rule.
        :param pulumi.Input[int] use_count: The use count of the vpc firewall acl rule.
        :param pulumi.Input[str] vpc_firewall_id: The id of the vpc firewall.
        :param pulumi.Input[str] vpc_firewall_name: The name of the vpc firewall.
        """
...
class CfwVpcFirewallAclRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CfwVpcFirewallAclRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CfwVpcFirewallAclRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CfwVpcFirewallAclRuleArgs.__new__(CfwVpcFirewallAclRuleArgs)
        ...
        super(CfwVpcFirewallAclRule, __self__).__init__(
            'volcengine:cloud_firewall/cfwVpcFirewallAclRule:CfwVpcFirewallAclRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            use_count: Optional[pulumi.Input[int]] = None,
            vpc_firewall_id: Optional[pulumi.Input[str]] = None,
            vpc_firewall_name: Optional[pulumi.Input[str]] = None) -> 'CfwVpcFirewallAclRule':
        """
        ...
        __props__ = _CfwVpcFirewallAclRuleState.__new__(_CfwVpcFirewallAclRuleState)
        ...
        return CfwVpcFirewallAclRule(resource_name, opts=opts, __props__=__props__)
