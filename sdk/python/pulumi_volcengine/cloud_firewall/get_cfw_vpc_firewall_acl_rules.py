...
__all__ = [
    'GetCfwVpcFirewallAclRulesResult',
    'AwaitableGetCfwVpcFirewallAclRulesResult',
    'get_cfw_vpc_firewall_acl_rules',
    'get_cfw_vpc_firewall_acl_rules_output',
]

@pulumi.output_type
class GetCfwVpcFirewallAclRulesResult:
    """
    ...
    def vpc_firewall_acl_rules(self) -> Sequence['outputs.GetCfwVpcFirewallAclRulesVpcFirewallAclRuleResult']:
        """
...
class AwaitableGetCfwVpcFirewallAclRulesResult(GetCfwVpcFirewallAclRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCfwVpcFirewallAclRulesResult(
...
def get_cfw_vpc_firewall_acl_rules(actions: Optional[Sequence[str]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCfwVpcFirewallAclRulesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_firewall/getCfwVpcFirewallAclRules:getCfwVpcFirewallAclRules', __args__, opts=opts, typ=GetCfwVpcFirewallAclRulesResult).value

    return AwaitableGetCfwVpcFirewallAclRulesResult(
...
@_utilities.lift_output_func(get_cfw_vpc_firewall_acl_rules)
def get_cfw_vpc_firewall_acl_rules_output(actions: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCfwVpcFirewallAclRulesResult]:
    """
    Use this data source to query detailed information of cfw vpc firewall acl rules
    ## Example Usage
