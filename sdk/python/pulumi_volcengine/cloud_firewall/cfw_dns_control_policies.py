...
__all__ = [
    'CfwDnsControlPoliciesResult',
    'AwaitableCfwDnsControlPoliciesResult',
    'cfw_dns_control_policies',
...
class CfwDnsControlPoliciesResult:
    ...
    def dns_control_policies(self) -> Sequence['outputs.CfwDnsControlPoliciesDnsControlPolicyResult']:
        """
...
class AwaitableCfwDnsControlPoliciesResult(CfwDnsControlPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return CfwDnsControlPoliciesResult(
...
def cfw_dns_control_policies(description: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableCfwDnsControlPoliciesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_firewall/cfwDnsControlPolicies:CfwDnsControlPolicies', __args__, opts=opts, typ=CfwDnsControlPoliciesResult).value

    return AwaitableCfwDnsControlPoliciesResult(
...
@_utilities.lift_output_func(cfw_dns_control_policies)
def cfw_dns_control_policies_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[CfwDnsControlPoliciesResult]:
    """
    Use this data source to query detailed information of cfw dns control policies
    ## Example Usage
