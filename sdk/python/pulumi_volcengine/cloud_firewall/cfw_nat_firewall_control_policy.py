...
__all__ = ['CfwNatFirewallControlPolicyArgs', 'CfwNatFirewallControlPolicy']

@pulumi.input_type
class CfwNatFirewallControlPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The action of the nat firewall control policy. Valid values: `accept`, `deny`, `monitor`.
        :param pulumi.Input[str] destination: The destination of the nat firewall control policy.
        :param pulumi.Input[str] destination_type: The destination type of the nat firewall control policy. Valid values: `net`, `group`, `location`, `domain`.
        ...
        :param pulumi.Input[str] proto: The proto of the nat firewall control policy. Valid values: `TCP`, `ICMP`, `UDP`, `ANY`. When the destination_type is `domain`, The proto must be `TCP`.
        :param pulumi.Input[str] source: The source of the nat firewall control policy.
        :param pulumi.Input[str] source_type: The source type of the nat firewall control policy. Valid values: `net`, `group`.
        :param pulumi.Input[str] description: The description of the nat firewall control policy.
        :param pulumi.Input[str] dest_port: The dest port of the nat firewall control policy.
        :param pulumi.Input[str] dest_port_type: The dest port type of the nat firewall control policy. Valid values: `port`, `group`.
        :param pulumi.Input[int] end_time: The end time of the nat firewall control policy. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[int] priority: The priority of the nat firewall control policy. Default is 0. This field is only effective when creating a control policy.0 means lowest priority, 1 means highest priority. The priority increases in order from 1, with lower priority indicating higher priority.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] repeat_days: The repeat days of the nat firewall control policy. When the value of repeat_type is one of `Weekly`, `Monthly`, this field is required.
               When the repeat_type is `Weekly`, the valid value range is 0~6.
               When the repeat_type is `Monthly`, the valid value range is 1~31.
        :param pulumi.Input[str] repeat_end_time: The repeat end time of the nat firewall control policy. Accurate to the minute, in the format of hh: mm. For example: 12:00.
               When the value of repeat_type is one of `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[str] repeat_start_time: The repeat start time of the nat firewall control policy. Accurate to the minute, in the format of hh: mm. For example: 12:00.
               When the value of repeat_type is one of `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[str] repeat_type: The repeat type of the nat firewall control policy. Valid values: `Permanent`, `Once`, `Daily`, `Weekly`, `Monthly`.
        :param pulumi.Input[int] start_time: The start time of the nat firewall control policy. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[bool] status: Whether to enable the nat firewall control policy. Default is false.
        """
...
@pulumi.input_type
class _CfwNatFirewallControlPolicyState:
    def __init__(__self__, *,
                 ...
                 nat_firewall_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] account_id: The account id of the nat firewall control policy.
        :param pulumi.Input[str] action: The action of the nat firewall control policy. Valid values: `accept`, `deny`, `monitor`.
        :param pulumi.Input[str] description: The description of the nat firewall control policy.
        :param pulumi.Input[str] dest_port: The dest port of the nat firewall control policy.
        :param pulumi.Input[str] dest_port_type: The dest port type of the nat firewall control policy. Valid values: `port`, `group`.
        ...
        :param pulumi.Input[str] destination_type: The destination type of the nat firewall control policy. Valid values: `net`, `group`, `location`, `domain`.
        :param pulumi.Input[str] direction: The direction of the nat firewall control policy. Valid values: `in`, `out`.
        :param pulumi.Input[int] effect_status: The effect status of the nat firewall control policy. 1: Not yet effective, 2: Issued in progress, 3: Effective.
        :param pulumi.Input[int] end_time: The end time of the nat firewall control policy. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[int] hit_cnt: The hit count of the nat firewall control policy.
        :param pulumi.Input[bool] is_effected: Whether the nat firewall control policy is effected.
        :param pulumi.Input[str] nat_firewall_id: The id of the nat firewall.
        :param pulumi.Input[str] nat_firewall_name: The name of the nat firewall.
        ...
        :param pulumi.Input[int] start_time: The start time of the nat firewall control policy. Unix timestamp, fields need to be precise to 23:59:00 of the set date.
               When the value of repeat_type is one of `Once`, `Daily`, `Weekly`, `Monthly`, this field is required.
        :param pulumi.Input[bool] status: Whether to enable the nat firewall control policy. Default is false.
        :param pulumi.Input[int] update_time: The update time of the nat firewall control policy.
        :param pulumi.Input[int] use_count: The use count of the nat firewall control policy.
        """
    ...
    def nat_firewall_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def nat_firewall_name(self, value: Optional[pulumi.Input[str]]):
...
class CfwNatFirewallControlPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CfwNatFirewallControlPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CfwNatFirewallControlPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CfwNatFirewallControlPolicyArgs.__new__(CfwNatFirewallControlPolicyArgs)
            ...
            __props__.__dict__["nat_firewall_name"] = None
            __props__.__dict__["prio"] = None
            __props__.__dict__["rule_id"] = None
            __props__.__dict__["update_time"] = None
            __props__.__dict__["use_count"] = None
        super(CfwNatFirewallControlPolicy, __self__).__init__(
            'volcengine:cloud_firewall/cfwNatFirewallControlPolicy:CfwNatFirewallControlPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[bool]] = None,
            update_time: Optional[pulumi.Input[int]] = None,
            use_count: Optional[pulumi.Input[int]] = None) -> 'CfwNatFirewallControlPolicy':
        """
        ...
        __props__ = _CfwNatFirewallControlPolicyState.__new__(_CfwNatFirewallControlPolicyState)
        ...
        return CfwNatFirewallControlPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="natFirewallName")
    def nat_firewall_name(self) -> pulumi.Output[str]:
        """
        The name of the nat firewall.
        """
        return pulumi.get(self, "nat_firewall_name")
