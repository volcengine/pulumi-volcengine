...
__all__ = [
    'GetMongoAllowListsResult',
    'AwaitableGetMongoAllowListsResult',
    'get_mongo_allow_lists',
    'get_mongo_allow_lists_output',
]

@pulumi.output_type
class GetMongoAllowListsResult:
    """
    ...
    def allow_lists(self) -> Sequence['outputs.GetMongoAllowListsAllowListResult']:
        """
...
class AwaitableGetMongoAllowListsResult(GetMongoAllowListsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMongoAllowListsResult(
...
def get_mongo_allow_lists(allow_list_ids: Optional[Sequence[str]] = None,
                          instance_id: Optional[str] = None,
                          output_file: Optional[str] = None,
                          project_name: Optional[str] = None,
                          region_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMongoAllowListsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:mongodb/getMongoAllowLists:getMongoAllowLists', __args__, opts=opts, typ=GetMongoAllowListsResult).value

    return AwaitableGetMongoAllowListsResult(
...
@_utilities.lift_output_func(get_mongo_allow_lists)
def get_mongo_allow_lists_output(allow_list_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                 instance_id: Optional[pulumi.Input[Optional[str]]] = None,
                                 output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                 project_name: Optional[pulumi.Input[Optional[str]]] = None,
                                 region_id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMongoAllowListsResult]:
    """
    Use this data source to query detailed information of mongodb allow lists
    ## Example Usage
