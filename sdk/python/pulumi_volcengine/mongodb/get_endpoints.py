...
def get_endpoints(instance_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:mongodb/getEndpoints:getEndpoints', __args__, opts=opts, typ=GetEndpointsResult).value
...
def get_endpoints_output(instance_id: Optional[pulumi.Input[Optional[str]]] = None,
