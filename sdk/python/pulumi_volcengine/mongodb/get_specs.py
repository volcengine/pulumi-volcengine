...
__all__ = [
    'GetSpecsResult',
    'AwaitableGetSpecsResult',
    'get_specs',
    'get_specs_output',
]

@pulumi.output_type
class GetSpecsResult:
    """
    ...
    @property
    @pulumi.getter
    def specs(self) -> 'outputs.GetSpecsSpecsResult':
        """
...
class AwaitableGetSpecsResult(GetSpecsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSpecsResult(
            id=self.id,
...
def get_specs(output_file: Optional[str] = None,
              ...
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSpecsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:mongodb/getSpecs:getSpecs', __args__, opts=opts, typ=GetSpecsResult).value

    return AwaitableGetSpecsResult(
...
@_utilities.lift_output_func(get_specs)
def get_specs_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
                     region_id: Optional[pulumi.Input[Optional[str]]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSpecsResult]:
    """
    Use this data source to query detailed information of mongodb specs
    ## Example Usage
