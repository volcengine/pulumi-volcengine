...
class GetInstanceParametersResult:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetInstanceParametersParameterResult']:
        """
...
def get_instance_parameters(instance_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:mongodb/getInstanceParameters:getInstanceParameters', __args__, opts=opts, typ=GetInstanceParametersResult).value
