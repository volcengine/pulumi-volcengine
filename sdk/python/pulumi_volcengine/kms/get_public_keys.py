...
__all__ = [
    'GetPublicKeysResult',
    'AwaitableGetPublicKeysResult',
    'get_public_keys',
    'get_public_keys_output',
]

@pulumi.output_type
class GetPublicKeysResult:
    """
    ...
    def public_keys(self) -> Sequence['outputs.GetPublicKeysPublicKeyResult']:
        """
...
class AwaitableGetPublicKeysResult(GetPublicKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPublicKeysResult(
            id=self.id,
            key_id=self.key_id,
...
def get_public_keys(key_id: Optional[str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPublicKeysResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/getPublicKeys:getPublicKeys', __args__, opts=opts, typ=GetPublicKeysResult).value

    return AwaitableGetPublicKeysResult(
...
@_utilities.lift_output_func(get_public_keys)
def get_public_keys_output(key_id: Optional[pulumi.Input[Optional[str]]] = None,
                           key_name: Optional[pulumi.Input[Optional[str]]] = None,
                           keyring_name: Optional[pulumi.Input[Optional[str]]] = None,
                           output_file: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPublicKeysResult]:
    """
    Use this data source to query detailed information of kms public keys
    ## Example Usage
