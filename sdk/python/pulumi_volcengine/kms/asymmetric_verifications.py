...
__all__ = [
    'AsymmetricVerificationsResult',
    'AwaitableAsymmetricVerificationsResult',
    'asymmetric_verifications',
    'asymmetric_verifications_output',
]

warnings.warn("""volcengine.kms.AsymmetricVerifications has been deprecated in favor of volcengine.kms.getAsymmetricVerifications""", DeprecationWarning)

@pulumi.output_type
class AsymmetricVerificationsResult:
    """
    ...
    def verification_infos(self) -> Sequence['outputs.AsymmetricVerificationsVerificationInfoResult']:
        """
...
class AwaitableAsymmetricVerificationsResult(AsymmetricVerificationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return AsymmetricVerificationsResult(
...
def asymmetric_verifications(algorithm: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableAsymmetricVerificationsResult:
    """
    ...
    """
    pulumi.log.warn("""asymmetric_verifications is deprecated: volcengine.kms.AsymmetricVerifications has been deprecated in favor of volcengine.kms.getAsymmetricVerifications""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/asymmetricVerifications:AsymmetricVerifications', __args__, opts=opts, typ=AsymmetricVerificationsResult).value

    return AwaitableAsymmetricVerificationsResult(
...
@_utilities.lift_output_func(asymmetric_verifications)
def asymmetric_verifications_output(algorithm: Optional[pulumi.Input[str]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[AsymmetricVerificationsResult]:
    """
    Use this data source to query detailed information of kms asymmetric verifications
    ## Example Usage
