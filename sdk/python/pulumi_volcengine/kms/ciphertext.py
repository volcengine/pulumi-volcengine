...
class CiphertextArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] plaintext: The plaintext to be symmetrically encrypted, Base64 encoded.
        :param pulumi.Input[str] encryption_context: The JSON string of key/value pairs.
    ...
    def encryption_context(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def encryption_context(self, value: Optional[pulumi.Input[str]]):
...
class _CiphertextState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ciphertext_blob: The ciphertext, Base64 encoded. The produced ciphertext_blob stays stable across applies. If the plaintext should be re-encrypted on each apply use the `kms_get_ciphertexts` data source.
        :param pulumi.Input[str] encryption_context: The JSON string of key/value pairs.
        :param pulumi.Input[str] key_id: The id of the key. When key_id is not specified, both keyring_name and key_name must be specified.
        :param pulumi.Input[str] key_name: The name of the key.
        :param pulumi.Input[str] keyring_name: The name of the keyring.
    ...
    def ciphertext_blob(self) -> Optional[pulumi.Input[str]]:
        """
        The ciphertext, Base64 encoded. The produced ciphertext_blob stays stable across applies. If the plaintext should be re-encrypted on each apply use the `kms_get_ciphertexts` data source.
        """
...
class Ciphertext(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Ciphertext, __self__).__init__(
            'volcengine:kms/ciphertext:Ciphertext',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="encryptionContext")
    def encryption_context(self) -> pulumi.Output[Optional[str]]:
        """
        The JSON string of key/value pairs.
        """
        return pulumi.get(self, "encryption_context")
