...
warnings.warn("""volcengine.kms.Keys has been deprecated in favor of volcengine.kms.getKeys""", DeprecationWarning)
...
class KeysResult:
    ...
    @property
    @pulumi.getter
    def keys(self) -> Sequence['outputs.KeysKeyResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.KeysTagResult']]:
        """
        Tags.
        """
...
def keys(creation_date_ranges: Optional[Sequence[str]] = None,
         ...
         tags: Optional[Sequence[pulumi.InputType['KeysTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['KeysTagArgs']] tags: A list of tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/keys:Keys', __args__, opts=opts, typ=KeysResult).value
...
def keys_output(creation_date_ranges: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                ...
                tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['KeysTagArgs']]]]] = None,
