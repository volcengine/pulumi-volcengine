...
warnings.warn("""volcengine.kms.Regions has been deprecated in favor of volcengine.kms.getRegions""", DeprecationWarning)
...
def regions(output_file: Optional[str] = None,
    ...
    default = volcengine.kms.get_regions()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/regions:Regions', __args__, opts=opts, typ=RegionsResult).value
