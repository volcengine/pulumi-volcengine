...
__all__ = [
    'GetPlaintextsResult',
    'AwaitableGetPlaintextsResult',
    'get_plaintexts',
    'get_plaintexts_output',
]

@pulumi.output_type
class GetPlaintextsResult:
    """
    ...
    def plaintext_infos(self) -> Sequence['outputs.GetPlaintextsPlaintextInfoResult']:
        """
...
class AwaitableGetPlaintextsResult(GetPlaintextsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPlaintextsResult(
...
def get_plaintexts(ciphertext_blob: Optional[str] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPlaintextsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/getPlaintexts:getPlaintexts', __args__, opts=opts, typ=GetPlaintextsResult).value

    return AwaitableGetPlaintextsResult(
...
@_utilities.lift_output_func(get_plaintexts)
def get_plaintexts_output(ciphertext_blob: Optional[pulumi.Input[str]] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPlaintextsResult]:
    """
    Use this data source to query detailed information of kms plaintexts
    ## Example Usage
