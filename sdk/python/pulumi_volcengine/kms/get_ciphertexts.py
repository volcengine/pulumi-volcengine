...
__all__ = [
    'GetCiphertextsResult',
    'AwaitableGetCiphertextsResult',
    'get_ciphertexts',
    'get_ciphertexts_output',
]

@pulumi.output_type
class GetCiphertextsResult:
    """
    ...
    def ciphertext_infos(self) -> Sequence['outputs.GetCiphertextsCiphertextInfoResult']:
        """
...
class AwaitableGetCiphertextsResult(GetCiphertextsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCiphertextsResult(
...
def get_ciphertexts(encryption_context: Optional[str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCiphertextsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/getCiphertexts:getCiphertexts', __args__, opts=opts, typ=GetCiphertextsResult).value

    return AwaitableGetCiphertextsResult(
...
@_utilities.lift_output_func(get_ciphertexts)
def get_ciphertexts_output(encryption_context: Optional[pulumi.Input[Optional[str]]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCiphertextsResult]:
    """
    Use this data source to query detailed information of kms ciphertexts
    ## Example Usage
