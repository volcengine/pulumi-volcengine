...
warnings.warn("""volcengine.kms.Secrets has been deprecated in favor of volcengine.kms.getSecrets""", DeprecationWarning)
...
class SecretsResult:
    ...
    @property
    @pulumi.getter
    def secrets(self) -> Sequence['outputs.SecretsSecretResult']:
        """
...
def secrets(creation_date_ranges: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""secrets is deprecated: volcengine.kms.Secrets has been deprecated in favor of volcengine.kms.getSecrets""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kms/secrets:Secrets', __args__, opts=opts, typ=SecretsResult).value
...
def secrets_output(creation_date_ranges: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
