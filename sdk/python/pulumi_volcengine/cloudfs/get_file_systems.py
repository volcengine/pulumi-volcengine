...
def get_file_systems(fs_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloudfs/getFileSystems:getFileSystems', __args__, opts=opts, typ=GetFileSystemsResult).value
...
def get_file_systems_output(fs_name: Optional[pulumi.Input[Optional[str]]] = None,
