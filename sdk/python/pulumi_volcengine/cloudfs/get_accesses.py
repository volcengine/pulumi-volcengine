...
__all__ = [
    'GetAccessesResult',
    'AwaitableGetAccessesResult',
    'get_accesses',
    'get_accesses_output',
]

@pulumi.output_type
class GetAccessesResult:
    """
    ...
    @property
    @pulumi.getter
    def accesses(self) -> Sequence['outputs.GetAccessesAccessResult']:
        """
...
class AwaitableGetAccessesResult(GetAccessesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAccessesResult(
...
def get_accesses(fs_name: Optional[str] = None,
                 output_file: Optional[str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloudfs/getAccesses:getAccesses', __args__, opts=opts, typ=GetAccessesResult).value

    return AwaitableGetAccessesResult(
...
@_utilities.lift_output_func(get_accesses)
def get_accesses_output(fs_name: Optional[pulumi.Input[str]] = None,
                        output_file: Optional[pulumi.Input[Optional[str]]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessesResult]:
    """
    Use this data source to query detailed information of cloudfs accesses
    ## Example Usage
