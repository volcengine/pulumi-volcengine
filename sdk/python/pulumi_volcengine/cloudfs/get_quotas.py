...
def get_quotas(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloudfs/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
