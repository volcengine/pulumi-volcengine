...
def get_namespaces(fs_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloudfs/getNamespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult).value
