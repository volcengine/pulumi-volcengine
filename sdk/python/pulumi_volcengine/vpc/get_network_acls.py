...
class GetNetworkAclsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetNetworkAclsTagResult']]:
        """
        Tags.
        """
...
def get_network_acls(ids: Optional[Sequence[str]] = None,
                     ...
                     tags: Optional[Sequence[pulumi.InputType['GetNetworkAclsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetNetworkAclsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getNetworkAcls:getNetworkAcls', __args__, opts=opts, typ=GetNetworkAclsResult).value
...
def get_network_acls_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            ...
                            tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNetworkAclsTagArgs']]]]] = None,
