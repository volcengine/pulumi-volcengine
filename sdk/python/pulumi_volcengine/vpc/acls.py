...
class AclsResult:
    ...
    """
    def __init__(__self__, acl_name=None, acls=None, id=None, ids=None, name_regex=None, output_file=None, total_count=None):
...
def acls(acl_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:Vpc/acls:Acls', __args__, opts=opts, typ=AclsResult).value
