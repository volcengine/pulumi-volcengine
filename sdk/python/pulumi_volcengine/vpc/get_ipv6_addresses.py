...
class GetIpv6AddressesResult:
    ...
    def ipv6_addresses(self) -> Sequence['outputs.GetIpv6AddressesIpv6AddressResult']:
        """
...
def get_ipv6_addresses(associated_instance_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getIpv6Addresses:getIpv6Addresses', __args__, opts=opts, typ=GetIpv6AddressesResult).value
