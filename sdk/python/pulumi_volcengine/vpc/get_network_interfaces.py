...
class GetNetworkInterfacesResult:
    ...
    def network_interfaces(self) -> Sequence['outputs.GetNetworkInterfacesNetworkInterfaceResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetNetworkInterfacesTagResult']]:
        """
        Tags.
        """
...
def get_network_interfaces(ids: Optional[Sequence[str]] = None,
                           ...
                           tags: Optional[Sequence[pulumi.InputType['GetNetworkInterfacesTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetNetworkInterfacesTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getNetworkInterfaces:getNetworkInterfaces', __args__, opts=opts, typ=GetNetworkInterfacesResult).value
...
def get_network_interfaces_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                  ...
                                  tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNetworkInterfacesTagArgs']]]]] = None,
