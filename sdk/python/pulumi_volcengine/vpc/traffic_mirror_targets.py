...
__all__ = [
    'TrafficMirrorTargetsResult',
    'AwaitableTrafficMirrorTargetsResult',
    'traffic_mirror_targets',
    'traffic_mirror_targets_output',
]

warnings.warn("""volcengine.vpc.TrafficMirrorTargets has been deprecated in favor of volcengine.vpc.getTrafficMirrorTargets""", DeprecationWarning)

@pulumi.output_type
class TrafficMirrorTargetsResult:
    """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.TrafficMirrorTargetsTagResult']]:
        """
        Tags.
        """
    ...
    def traffic_mirror_targets(self) -> Sequence['outputs.TrafficMirrorTargetsTrafficMirrorTargetResult']:
        """
...
class AwaitableTrafficMirrorTargetsResult(TrafficMirrorTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return TrafficMirrorTargetsResult(
            id=self.id,
...
def traffic_mirror_targets(name_regex: Optional[str] = None,
                           output_file: Optional[str] = None,
                           project_name: Optional[str] = None,
                           tags: Optional[Sequence[pulumi.InputType['TrafficMirrorTargetsTagArgs']]] = None,
                           traffic_mirror_target_ids: Optional[Sequence[str]] = None,
                           traffic_mirror_target_name: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableTrafficMirrorTargetsResult:
    """
    ...
    :param Sequence[pulumi.InputType['TrafficMirrorTargetsTagArgs']] tags: Tags.
    ...
    """
    pulumi.log.warn("""traffic_mirror_targets is deprecated: volcengine.vpc.TrafficMirrorTargets has been deprecated in favor of volcengine.vpc.getTrafficMirrorTargets""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/trafficMirrorTargets:TrafficMirrorTargets', __args__, opts=opts, typ=TrafficMirrorTargetsResult).value

    return AwaitableTrafficMirrorTargetsResult(
...
@_utilities.lift_output_func(traffic_mirror_targets)
def traffic_mirror_targets_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                                  output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                  project_name: Optional[pulumi.Input[Optional[str]]] = None,
                                  tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['TrafficMirrorTargetsTagArgs']]]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[TrafficMirrorTargetsResult]:
    """
    Use this data source to query detailed information of traffic mirror targets
    ## Example Usage
