...
class GetSecurityGroupRulesResult:
    ...
    def security_group_rules(self) -> Sequence['outputs.GetSecurityGroupRulesSecurityGroupRuleResult']:
        """
...
def get_security_group_rules(cidr_ip: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getSecurityGroupRules:getSecurityGroupRules', __args__, opts=opts, typ=GetSecurityGroupRulesResult).value
...
def get_security_group_rules_output(cidr_ip: Optional[pulumi.Input[Optional[str]]] = None,
