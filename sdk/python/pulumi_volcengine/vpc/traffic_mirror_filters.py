...
__all__ = [
    'TrafficMirrorFiltersResult',
    'AwaitableTrafficMirrorFiltersResult',
    'traffic_mirror_filters',
    'traffic_mirror_filters_output',
]

warnings.warn("""volcengine.vpc.TrafficMirrorFilters has been deprecated in favor of volcengine.vpc.getTrafficMirrorFilters""", DeprecationWarning)

@pulumi.output_type
class TrafficMirrorFiltersResult:
    """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.TrafficMirrorFiltersTagResult']]:
        """
        Tags.
        """
    ...
    def traffic_mirror_filters(self) -> Sequence['outputs.TrafficMirrorFiltersTrafficMirrorFilterResult']:
        """
...
class AwaitableTrafficMirrorFiltersResult(TrafficMirrorFiltersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return TrafficMirrorFiltersResult(
            id=self.id,
...
def traffic_mirror_filters(name_regex: Optional[str] = None,
                           output_file: Optional[str] = None,
                           project_name: Optional[str] = None,
                           tags: Optional[Sequence[pulumi.InputType['TrafficMirrorFiltersTagArgs']]] = None,
                           traffic_mirror_filter_ids: Optional[Sequence[str]] = None,
                           traffic_mirror_filter_names: Optional[Sequence[str]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableTrafficMirrorFiltersResult:
    """
    ...
    :param Sequence[pulumi.InputType['TrafficMirrorFiltersTagArgs']] tags: Tags.
    ...
    """
    pulumi.log.warn("""traffic_mirror_filters is deprecated: volcengine.vpc.TrafficMirrorFilters has been deprecated in favor of volcengine.vpc.getTrafficMirrorFilters""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/trafficMirrorFilters:TrafficMirrorFilters', __args__, opts=opts, typ=TrafficMirrorFiltersResult).value

    return AwaitableTrafficMirrorFiltersResult(
...
@_utilities.lift_output_func(traffic_mirror_filters)
def traffic_mirror_filters_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                                  output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                  project_name: Optional[pulumi.Input[Optional[str]]] = None,
                                  tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['TrafficMirrorFiltersTagArgs']]]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[TrafficMirrorFiltersResult]:
    """
    Use this data source to query detailed information of traffic mirror filters
    ## Example Usage
