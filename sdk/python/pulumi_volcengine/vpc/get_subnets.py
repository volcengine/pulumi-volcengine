...
class GetSubnetsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetSubnetsTagResult']]:
        """
        Tags.
        """
...
def get_subnets(ids: Optional[Sequence[str]] = None,
                ...
                tags: Optional[Sequence[pulumi.InputType['GetSubnetsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetSubnetsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getSubnets:getSubnets', __args__, opts=opts, typ=GetSubnetsResult).value
...
def get_subnets_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                       ...
                       tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSubnetsTagArgs']]]]] = None,
