...
class CertificatesResult:
    ...
    """
    def __init__(__self__, certificate_name=None, certificates=None, id=None, ids=None, name_regex=None, output_file=None, total_count=None):
...
def certificates(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:Vpc/certificates:Certificates', __args__, opts=opts, typ=CertificatesResult).value
