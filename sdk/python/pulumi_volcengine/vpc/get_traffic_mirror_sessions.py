...
class GetTrafficMirrorSessionsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetTrafficMirrorSessionsTagResult']]:
        """
        Tags.
        """
...
def get_traffic_mirror_sessions(name_regex: Optional[str] = None,
                                ...
                                tags: Optional[Sequence[pulumi.InputType['GetTrafficMirrorSessionsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetTrafficMirrorSessionsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getTrafficMirrorSessions:getTrafficMirrorSessions', __args__, opts=opts, typ=GetTrafficMirrorSessionsResult).value
...
def get_traffic_mirror_sessions_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                                       ...
                                       tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetTrafficMirrorSessionsTagArgs']]]]] = None,
