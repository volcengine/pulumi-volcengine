...
class GetHaVipsResult:
    ...
    def ha_vips(self) -> Sequence['outputs.GetHaVipsHaVipResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetHaVipsTagResult']]:
        """
        Tags.
        """
...
def get_ha_vips(ha_vip_name: Optional[str] = None,
                ...
                tags: Optional[Sequence[pulumi.InputType['GetHaVipsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetHaVipsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getHaVips:getHaVips', __args__, opts=opts, typ=GetHaVipsResult).value
...
@_utilities.lift_output_func(get_ha_vips)
def get_ha_vips_output(ha_vip_name: Optional[pulumi.Input[Optional[str]]] = None,
                       ...
                       tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetHaVipsTagArgs']]]]] = None,
