...
class GetFlowLogsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetFlowLogsTagResult']]:
        """
        Tags.
        """
...
def get_flow_logs(aggregation_interval: Optional[int] = None,
                  ...
                  tags: Optional[Sequence[pulumi.InputType['GetFlowLogsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetFlowLogsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpc/getFlowLogs:getFlowLogs', __args__, opts=opts, typ=GetFlowLogsResult).value
...
def get_flow_logs_output(aggregation_interval: Optional[pulumi.Input[Optional[int]]] = None,
                         ...
                         tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetFlowLogsTagArgs']]]]] = None,
