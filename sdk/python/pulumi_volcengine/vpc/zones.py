...
class ZonesResult:
    ...
    """
    def __init__(__self__, id=None, ids=None, output_file=None, total_count=None, zones=None):
...
def zones(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:Vpc/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
...
def zones_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
