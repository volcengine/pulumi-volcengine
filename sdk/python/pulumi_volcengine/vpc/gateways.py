...
class GatewaysResult:
    ...
    """
    def __init__(__self__, description=None, id=None, ids=None, name_regex=None, nat_gateway_name=None, nat_gateways=None, output_file=None, spec=None, subnet_id=None, total_count=None, vpc_id=None):
...
def gateways(description: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:Vpc/gateways:Gateways', __args__, opts=opts, typ=GatewaysResult).value
