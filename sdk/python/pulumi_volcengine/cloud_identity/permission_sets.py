...
warnings.warn("""volcengine.cloud_identity/permissionsets.PermissionSets has been deprecated in favor of volcengine.cloud_identity/getpermissionsets.getPermissionSets""", DeprecationWarning)
...
def permission_sets(ids: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""permission_sets is deprecated: volcengine.cloud_identity/permissionsets.PermissionSets has been deprecated in favor of volcengine.cloud_identity/getpermissionsets.getPermissionSets""")
    __args__ = dict()
    __args__['ids'] = ids
