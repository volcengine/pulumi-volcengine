...
__all__ = [
    ...
    'AwaitableGetPermissionSetAssignmentsResult',
    'get_permission_set_assignments',
    'get_permission_set_assignments_output',
]

@pulumi.output_type
class GetPermissionSetAssignmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def assignments(self) -> Sequence['outputs.GetPermissionSetAssignmentsAssignmentResult']:
        """
...
class AwaitableGetPermissionSetAssignmentsResult(GetPermissionSetAssignmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPermissionSetAssignmentsResult(
...
def get_permission_set_assignments(name_regex: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPermissionSetAssignmentsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_identity/getPermissionSetAssignments:getPermissionSetAssignments', __args__, opts=opts, typ=GetPermissionSetAssignmentsResult).value

    return AwaitableGetPermissionSetAssignmentsResult(
...
@_utilities.lift_output_func(get_permission_set_assignments)
def get_permission_set_assignments_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPermissionSetAssignmentsResult]:
    """
    Use this data source to query detailed information of cloud identity permission set assignments
    ## Example Usage
