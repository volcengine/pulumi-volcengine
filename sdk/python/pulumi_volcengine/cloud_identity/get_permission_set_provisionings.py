...
class GetPermissionSetProvisioningsResult:
    ...
    def permission_provisionings(self) -> Sequence['outputs.GetPermissionSetProvisioningsPermissionProvisioningResult']:
        """
...
def get_permission_set_provisionings(name_regex: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_identity/getPermissionSetProvisionings:getPermissionSetProvisionings', __args__, opts=opts, typ=GetPermissionSetProvisioningsResult).value
...
@_utilities.lift_output_func(get_permission_set_provisionings)
def get_permission_set_provisionings_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                                            output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                            permission_set_id: Optional[pulumi.Input[Optional[str]]] = None,
                                            target_id: Optional[pulumi.Input[Optional[str]]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPermissionSetProvisioningsResult]:
    """
    Use this data source to query detailed information of cloud identity permission set provisionings
    ## Example Usage
