...
def get_permission_sets(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cloud_identity/getPermissionSets:getPermissionSets', __args__, opts=opts, typ=GetPermissionSetsResult).value
...
@_utilities.lift_output_func(get_permission_sets)
def get_permission_sets_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
