...
class GetWorkspacesResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWorkspacesItemResult']:
        """
...
def get_workspaces(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:bioos/getWorkspaces:getWorkspaces', __args__, opts=opts, typ=GetWorkspacesResult).value
