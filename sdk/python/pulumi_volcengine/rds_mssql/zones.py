...
warnings.warn("""volcengine.rds_mssql.Zones has been deprecated in favor of volcengine.rds_mssql.getZones""", DeprecationWarning)
...
def zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mssql/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
