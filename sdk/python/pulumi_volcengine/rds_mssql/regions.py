...
warnings.warn("""volcengine.rds_mssql.Regions has been deprecated in favor of volcengine.rds_mssql.getRegions""", DeprecationWarning)
...
def regions(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_mssql/regions:Regions', __args__, opts=opts, typ=RegionsResult).value
