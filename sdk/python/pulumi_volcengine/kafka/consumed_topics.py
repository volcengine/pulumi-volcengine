...
__all__ = [
    'ConsumedTopicsResult',
    'AwaitableConsumedTopicsResult',
    'consumed_topics',
...
class ConsumedTopicsResult:
    ...
    def consumed_topics(self) -> Sequence['outputs.ConsumedTopicsConsumedTopicResult']:
        """
...
class AwaitableConsumedTopicsResult(ConsumedTopicsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ConsumedTopicsResult(
...
def consumed_topics(group_id: Optional[str] = None,
                    instance_id: Optional[str] = None,
                    output_file: Optional[str] = None,
                    topic_name: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableConsumedTopicsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/consumedTopics:ConsumedTopics', __args__, opts=opts, typ=ConsumedTopicsResult).value

    return AwaitableConsumedTopicsResult(
...
@_utilities.lift_output_func(consumed_topics)
def consumed_topics_output(group_id: Optional[pulumi.Input[str]] = None,
                           instance_id: Optional[pulumi.Input[str]] = None,
                           output_file: Optional[pulumi.Input[Optional[str]]] = None,
                           topic_name: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ConsumedTopicsResult]:
    """
    Use this data source to query detailed information of kafka consumed topics
    ## Example Usage
