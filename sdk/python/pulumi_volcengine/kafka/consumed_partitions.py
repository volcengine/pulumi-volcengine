...
__all__ = [
    'ConsumedPartitionsResult',
    'AwaitableConsumedPartitionsResult',
    'consumed_partitions',
...
class ConsumedPartitionsResult:
    ...
    def consumed_partitions(self) -> Sequence['outputs.ConsumedPartitionsConsumedPartitionResult']:
        """
...
class AwaitableConsumedPartitionsResult(ConsumedPartitionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ConsumedPartitionsResult(
...
def consumed_partitions(group_id: Optional[str] = None,
                        instance_id: Optional[str] = None,
                        output_file: Optional[str] = None,
                        topic_name: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableConsumedPartitionsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/consumedPartitions:ConsumedPartitions', __args__, opts=opts, typ=ConsumedPartitionsResult).value

    return AwaitableConsumedPartitionsResult(
...
@_utilities.lift_output_func(consumed_partitions)
def consumed_partitions_output(group_id: Optional[pulumi.Input[str]] = None,
                               instance_id: Optional[pulumi.Input[str]] = None,
                               output_file: Optional[pulumi.Input[Optional[str]]] = None,
                               topic_name: Optional[pulumi.Input[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ConsumedPartitionsResult]:
    """
    Use this data source to query detailed information of kafka consumed partitions
    ## Example Usage
