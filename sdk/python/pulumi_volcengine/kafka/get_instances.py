...
def get_instances(instance_id: Optional[str] = None,
    ...
    :param Sequence[pulumi.InputType['GetInstancesTagArgs']] tags: The tags of instance.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
