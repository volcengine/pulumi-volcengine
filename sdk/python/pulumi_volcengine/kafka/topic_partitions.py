...
__all__ = [
    'TopicPartitionsResult',
    'AwaitableTopicPartitionsResult',
    'topic_partitions',
...
class TopicPartitionsResult:
    ...
    @property
    @pulumi.getter
    def partitions(self) -> Sequence['outputs.TopicPartitionsPartitionResult']:
        """
...
class AwaitableTopicPartitionsResult(TopicPartitionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return TopicPartitionsResult(
            id=self.id,
...
def topic_partitions(instance_id: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableTopicPartitionsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/topicPartitions:TopicPartitions', __args__, opts=opts, typ=TopicPartitionsResult).value

    return AwaitableTopicPartitionsResult(
...
@_utilities.lift_output_func(topic_partitions)
def topic_partitions_output(instance_id: Optional[pulumi.Input[str]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[TopicPartitionsResult]:
    """
    Use this data source to query detailed information of kafka topic partitions
    ## Example Usage
