...
warnings.warn("""volcengine.kafka.AllowLists has been deprecated in favor of volcengine.kafka.getAllowLists""", DeprecationWarning)
...
def allow_lists(instance_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""allow_lists is deprecated: volcengine.kafka.AllowLists has been deprecated in favor of volcengine.kafka.getAllowLists""")
    __args__ = dict()
    __args__['instanceId'] = instance_id
    __args__['outputFile'] = output_file
    __args__['regionId'] = region_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/allowLists:AllowLists', __args__, opts=opts, typ=AllowListsResult).value
