...
warnings.warn("""volcengine.kafka.Regions has been deprecated in favor of volcengine.kafka.getRegions""", DeprecationWarning)
...
def regions(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:kafka/regions:Regions', __args__, opts=opts, typ=RegionsResult).value
