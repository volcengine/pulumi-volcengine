...
class GetConnectionsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetConnectionsTagResult']]:
        """
        Tags.
        """
    ...
    def vpn_connections(self) -> Sequence['outputs.GetConnectionsVpnConnectionResult']:
        """
...
def get_connections(attach_status: Optional[str] = None,
                    ...
                    tags: Optional[Sequence[pulumi.InputType['GetConnectionsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetConnectionsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vpn/getConnections:getConnections', __args__, opts=opts, typ=GetConnectionsResult).value
...
def get_connections_output(attach_status: Optional[pulumi.Input[Optional[str]]] = None,
                           ...
                           tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetConnectionsTagArgs']]]]] = None,
