...
class GetSnapshotsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetSnapshotsTagResult']]:
        """
        Tags.
        """
...
def get_snapshots(ids: Optional[Sequence[str]] = None,
                  ...
                  tags: Optional[Sequence[pulumi.InputType['GetSnapshotsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetSnapshotsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ebs/getSnapshots:getSnapshots', __args__, opts=opts, typ=GetSnapshotsResult).value
...
def get_snapshots_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                         ...
                         tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSnapshotsTagArgs']]]]] = None,
