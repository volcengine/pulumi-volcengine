...
def get_snapshot_groups(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ebs/getSnapshotGroups:getSnapshotGroups', __args__, opts=opts, typ=GetSnapshotGroupsResult).value
...
@_utilities.lift_output_func(get_snapshot_groups)
def get_snapshot_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSnapshotGroupsResult]:
    """
    Use this data source to query detailed information of ebs snapshot groups
    ## Example Usage
