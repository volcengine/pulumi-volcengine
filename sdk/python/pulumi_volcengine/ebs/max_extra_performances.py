...
__all__ = [
    'MaxExtraPerformancesResult',
    'AwaitableMaxExtraPerformancesResult',
    'max_extra_performances',
    'max_extra_performances_output',
]

warnings.warn("""volcengine.ebs.MaxExtraPerformances has been deprecated in favor of volcengine.ebs.getMaxExtraPerformances""", DeprecationWarning)

@pulumi.output_type
class MaxExtraPerformancesResult:
    """
    ...
    @property
    @pulumi.getter
    def performances(self) -> Sequence['outputs.MaxExtraPerformancesPerformanceResult']:
        """
...
class AwaitableMaxExtraPerformancesResult(MaxExtraPerformancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return MaxExtraPerformancesResult(
            id=self.id,
...
def max_extra_performances(name_regex: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""max_extra_performances is deprecated: volcengine.ebs.MaxExtraPerformances has been deprecated in favor of volcengine.ebs.getMaxExtraPerformances""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ebs/maxExtraPerformances:MaxExtraPerformances', __args__, opts=opts, typ=MaxExtraPerformancesResult).value

    return AwaitableMaxExtraPerformancesResult(
...
@_utilities.lift_output_func(max_extra_performances)
def max_extra_performances_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
