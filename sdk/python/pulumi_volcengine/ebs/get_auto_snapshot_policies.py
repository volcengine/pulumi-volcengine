...
class GetAutoSnapshotPoliciesResult:
    ...
    def auto_snapshot_policies(self) -> Sequence['outputs.GetAutoSnapshotPoliciesAutoSnapshotPolicyResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetAutoSnapshotPoliciesTagResult']]:
        """
        Tags.
        """
...
def get_auto_snapshot_policies(ids: Optional[Sequence[str]] = None,
                               ...
                               tags: Optional[Sequence[pulumi.InputType['GetAutoSnapshotPoliciesTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetAutoSnapshotPoliciesTagArgs']] tags: Tags.
    """
    __args__ = dict()
    __args__['ids'] = ids
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ebs/getAutoSnapshotPolicies:getAutoSnapshotPolicies', __args__, opts=opts, typ=GetAutoSnapshotPoliciesResult).value
...
def get_auto_snapshot_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                      ...
                                      tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAutoSnapshotPoliciesTagArgs']]]]] = None,
