...
class OrganizationsResult:
    ...
    """
    def __init__(__self__, id=None, name_regex=None, organizations=None, output_file=None, total_count=None):
    ...
    @property
    @pulumi.getter
    def organizations(self) -> Sequence['outputs.OrganizationsOrganizationResult']:
        """
...
class AwaitableOrganizationsResult(OrganizationsResult):
...
def organizations(name_regex: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableOrganizationsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:organization/organizations:Organizations', __args__, opts=opts, typ=OrganizationsResult).value

    return AwaitableOrganizationsResult(
...
@_utilities.lift_output_func(organizations)
def organizations_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                         output_file: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[OrganizationsResult]:
    """
    Use this data source to query detailed information of organizations
    ## Example Usage
