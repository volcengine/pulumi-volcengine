...
def get_organizations(name_regex: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:organization/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult).value
...
def get_organizations_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
