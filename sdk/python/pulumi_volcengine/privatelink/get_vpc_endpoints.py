...
class GetVpcEndpointsResult:
    ...
    def vpc_endpoints(self) -> Sequence['outputs.GetVpcEndpointsVpcEndpointResult']:
        """
...
def get_vpc_endpoints(endpoint_name: Optional[str] = None,
...
def get_vpc_endpoints_output(endpoint_name: Optional[pulumi.Input[Optional[str]]] = None,
