...
def get_vpc_endpoint_connections(endpoint_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:privatelink/getVpcEndpointConnections:getVpcEndpointConnections', __args__, opts=opts, typ=GetVpcEndpointConnectionsResult).value
