...
__all__ = [
    'GetRdsInstancesV2Result',
    'AwaitableGetRdsInstancesV2Result',
    'get_rds_instances_v2',
    'get_rds_instances_v2_output',
]

@pulumi.output_type
class GetRdsInstancesV2Result:
    """
    ...
    def rds_instances(self) -> Sequence['outputs.GetRdsInstancesV2RdsInstanceResult']:
        """
...
class AwaitableGetRdsInstancesV2Result(GetRdsInstancesV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRdsInstancesV2Result(
...
def get_rds_instances_v2(charge_type: Optional[str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRdsInstancesV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds_v2/getRdsInstancesV2:getRdsInstancesV2', __args__, opts=opts, typ=GetRdsInstancesV2Result).value

    return AwaitableGetRdsInstancesV2Result(
...
@_utilities.lift_output_func(get_rds_instances_v2)
def get_rds_instances_v2_output(charge_type: Optional[pulumi.Input[Optional[str]]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRdsInstancesV2Result]:
    """
    (Deprecated! Recommend use volcengine_rds_mysql_*** replace) Use this data source to query detailed information of rds instances v2
    ## Example Usage
