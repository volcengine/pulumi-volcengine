...
class GetRouteTablePropagationsResult:
    ...
    @property
    @pulumi.getter
    def propagations(self) -> Sequence['outputs.GetRouteTablePropagationsPropagationResult']:
        """
...
def get_route_table_propagations(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:transit_router/getRouteTablePropagations:getRouteTablePropagations', __args__, opts=opts, typ=GetRouteTablePropagationsResult).value
...
def get_route_table_propagations_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
