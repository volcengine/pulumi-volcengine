...
class GetRouteTableAssociationsResult:
    ...
    @property
    @pulumi.getter
    def associations(self) -> Sequence['outputs.GetRouteTableAssociationsAssociationResult']:
        """
...
def get_route_table_associations(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:transit_router/getRouteTableAssociations:getRouteTableAssociations', __args__, opts=opts, typ=GetRouteTableAssociationsResult).value
...
def get_route_table_associations_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
