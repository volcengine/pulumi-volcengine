...
__all__ = [
    'GetGrantRulesResult',
    'AwaitableGetGrantRulesResult',
    'get_grant_rules',
    'get_grant_rules_output',
]

@pulumi.output_type
class GetGrantRulesResult:
    """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetGrantRulesRuleResult']:
        """
...
class AwaitableGetGrantRulesResult(GetGrantRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGrantRulesResult(
...
def get_grant_rules(grant_account_id: Optional[str] = None,
                    output_file: Optional[str] = None,
                    transit_router_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGrantRulesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:transit_router/getGrantRules:getGrantRules', __args__, opts=opts, typ=GetGrantRulesResult).value

    return AwaitableGetGrantRulesResult(
...
@_utilities.lift_output_func(get_grant_rules)
def get_grant_rules_output(grant_account_id: Optional[pulumi.Input[Optional[str]]] = None,
                           output_file: Optional[pulumi.Input[Optional[str]]] = None,
                           transit_router_id: Optional[pulumi.Input[str]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGrantRulesResult]:
    """
    Use this data source to query detailed information of transit router grant rules
    ## Example Usage
