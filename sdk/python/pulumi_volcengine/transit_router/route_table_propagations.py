...
warnings.warn("""volcengine.transit_router.RouteTablePropagations has been deprecated in favor of volcengine.transit_router.getRouteTablePropagations""", DeprecationWarning)
...
def route_table_propagations(output_file: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""route_table_propagations is deprecated: volcengine.transit_router.RouteTablePropagations has been deprecated in favor of volcengine.transit_router.getRouteTablePropagations""")
    __args__ = dict()
