...
def get_vpc_endpoints(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cr/getVpcEndpoints:getVpcEndpoints', __args__, opts=opts, typ=GetVpcEndpointsResult).value
...
def get_vpc_endpoints_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
