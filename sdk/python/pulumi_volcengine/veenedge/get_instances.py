...
def get_instances(cloud_server_ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veenedge/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(cloud_server_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
