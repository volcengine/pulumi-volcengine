...
class GetAvailableResourcesResult:
    ...
    @property
    @pulumi.getter
    def regions(self) -> Sequence['outputs.GetAvailableResourcesRegionResult']:
        """
...
def get_available_resources(bandwith_limit: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veenedge/getAvailableResources:getAvailableResources', __args__, opts=opts, typ=GetAvailableResourcesResult).value
