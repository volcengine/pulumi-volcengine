...
__all__ = [
    'GetCloudServersResult',
    'AwaitableGetCloudServersResult',
    'get_cloud_servers',
    'get_cloud_servers_output',
]

@pulumi.output_type
class GetCloudServersResult:
    """
    ...
    def cloud_servers(self) -> Sequence['outputs.GetCloudServersCloudServerResult']:
        """
...
class AwaitableGetCloudServersResult(GetCloudServersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudServersResult(
...
def get_cloud_servers(ids: Optional[Sequence[str]] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudServersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:veenedge/getCloudServers:getCloudServers', __args__, opts=opts, typ=GetCloudServersResult).value

    return AwaitableGetCloudServersResult(
...
@_utilities.lift_output_func(get_cloud_servers)
def get_cloud_servers_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                             name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                             output_file: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudServersResult]:
    """
    Use this data source to query detailed information of veenedge cloud servers
    ## Example Usage
