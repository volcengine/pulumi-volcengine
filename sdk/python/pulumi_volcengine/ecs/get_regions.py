...
def get_regions(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ecs/getRegions:getRegions', __args__, opts=opts, typ=GetRegionsResult).value
...
def get_regions_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
