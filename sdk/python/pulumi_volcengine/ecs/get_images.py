...
class GetImagesResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetImagesTagResult']]:
        """
        Tags.
        """
...
def get_images(ids: Optional[Sequence[str]] = None,
               ...
               tags: Optional[Sequence[pulumi.InputType['GetImagesTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetImagesTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ecs/getImages:getImages', __args__, opts=opts, typ=GetImagesResult).value
...
def get_images_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                      ...
                      tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetImagesTagArgs']]]]] = None,
