...
class GetAvailableResourcesResult:
    ...
    def available_zones(self) -> Sequence['outputs.GetAvailableResourcesAvailableZoneResult']:
        """
...
def get_available_resources(destination_resource: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ecs/getAvailableResources:getAvailableResources', __args__, opts=opts, typ=GetAvailableResourcesResult).value
...
@_utilities.lift_output_func(get_available_resources)
def get_available_resources_output(destination_resource: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAvailableResourcesResult]:
    """
    Use this data source to query detailed information of ecs available resources
    ## Example Usage
