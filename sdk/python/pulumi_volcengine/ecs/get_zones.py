...
def get_zones(ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ecs/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
