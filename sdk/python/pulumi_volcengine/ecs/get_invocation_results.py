...
__all__ = [
    'GetInvocationResultsResult',
    'AwaitableGetInvocationResultsResult',
    'get_invocation_results',
    'get_invocation_results_output',
]

@pulumi.output_type
class GetInvocationResultsResult:
    """
    ...
    def invocation_results(self) -> Sequence['outputs.GetInvocationResultsInvocationResultResult']:
        """
...
class AwaitableGetInvocationResultsResult(GetInvocationResultsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetInvocationResultsResult(
...
def get_invocation_results(command_id: Optional[str] = None,
                           instance_id: Optional[str] = None,
                           invocation_id: Optional[str] = None,
                           invocation_result_statuses: Optional[Sequence[str]] = None,
                           output_file: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInvocationResultsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:ecs/getInvocationResults:getInvocationResults', __args__, opts=opts, typ=GetInvocationResultsResult).value

    return AwaitableGetInvocationResultsResult(
...
@_utilities.lift_output_func(get_invocation_results)
def get_invocation_results_output(command_id: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInvocationResultsResult]:
    """
    Use this data source to query detailed information of ecs invocation results
    ## Example Usage
