...
__all__ = [
    'GetServiceRouteEntriesResult',
    'AwaitableGetServiceRouteEntriesResult',
    'get_service_route_entries',
    'get_service_route_entries_output',
]

@pulumi.output_type
class GetServiceRouteEntriesResult:
    """
    ...
    def service_route_entries(self) -> Sequence['outputs.GetServiceRouteEntriesServiceRouteEntryResult']:
        """
...
class AwaitableGetServiceRouteEntriesResult(GetServiceRouteEntriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceRouteEntriesResult(
            cen_id=self.cen_id,
...
def get_service_route_entries(cen_id: Optional[str] = None,
                              destination_cidr_block: Optional[str] = None,
                              output_file: Optional[str] = None,
                              service_region_id: Optional[str] = None,
                              service_vpc_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceRouteEntriesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cen/getServiceRouteEntries:getServiceRouteEntries', __args__, opts=opts, typ=GetServiceRouteEntriesResult).value

    return AwaitableGetServiceRouteEntriesResult(
...
@_utilities.lift_output_func(get_service_route_entries)
def get_service_route_entries_output(cen_id: Optional[pulumi.Input[Optional[str]]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceRouteEntriesResult]:
    """
    Use this data source to query detailed information of cen service route entries
    ## Example Usage
