...
__all__ = [
    'InterRegionBandwidthsResult',
    'AwaitableInterRegionBandwidthsResult',
...
class InterRegionBandwidthsResult:
    ...
    def inter_region_bandwidths(self) -> Sequence['outputs.InterRegionBandwidthsInterRegionBandwidthResult']:
        """
...
class AwaitableInterRegionBandwidthsResult(InterRegionBandwidthsResult):
