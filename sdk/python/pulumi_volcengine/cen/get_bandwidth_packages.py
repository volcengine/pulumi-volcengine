...
class GetBandwidthPackagesResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetBandwidthPackagesTagResult']]:
        """
        Tags.
        """
...
def get_bandwidth_packages(cen_bandwidth_package_names: Optional[Sequence[str]] = None,
                           ...
                           tags: Optional[Sequence[pulumi.InputType['GetBandwidthPackagesTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetBandwidthPackagesTagArgs']] tags: Tags.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cen/getBandwidthPackages:getBandwidthPackages', __args__, opts=opts, typ=GetBandwidthPackagesResult).value
...
def get_bandwidth_packages_output(cen_bandwidth_package_names: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                  ...
                                  tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetBandwidthPackagesTagArgs']]]]] = None,
