...
class GetRecordSetsResult:
    ...
    def record_sets(self) -> Sequence['outputs.GetRecordSetsRecordSetResult']:
        """
...
def get_record_sets(host: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:dns/getRecordSets:getRecordSets', __args__, opts=opts, typ=GetRecordSetsResult).value
...
@_utilities.lift_output_func(get_record_sets)
def get_record_sets_output(host: Optional[pulumi.Input[Optional[str]]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRecordSetsResult]:
    """
    Use this data source to query detailed information of dns record sets
    ## Example Usage
