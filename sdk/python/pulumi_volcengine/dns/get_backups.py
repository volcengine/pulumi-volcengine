...
class GetBackupsResult:
    ...
    def backup_infos(self) -> Sequence['outputs.GetBackupsBackupInfoResult']:
        """
...
def get_backups(name_regex: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:dns/getBackups:getBackups', __args__, opts=opts, typ=GetBackupsResult).value
...
def get_backups_output(name_regex: Optional[pulumi.Input[Optional[str]]] = None,
