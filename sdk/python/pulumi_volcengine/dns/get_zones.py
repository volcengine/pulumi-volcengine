...
class GetZonesResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetZonesTagResult']]:
        """
        Tags.
        """
...
def get_zones(key: Optional[str] = None,
              ...
              tags: Optional[Sequence[pulumi.InputType['GetZonesTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetZonesTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:dns/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(key: Optional[pulumi.Input[Optional[str]]] = None,
                     ...
                     tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetZonesTagArgs']]]]] = None,
