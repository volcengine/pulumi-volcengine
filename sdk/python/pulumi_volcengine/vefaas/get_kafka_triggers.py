...
class GetKafkaTriggersResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetKafkaTriggersItemResult']:
        """
...
def get_kafka_triggers(function_id: Optional[str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKafkaTriggersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vefaas/getKafkaTriggers:getKafkaTriggers', __args__, opts=opts, typ=GetKafkaTriggersResult).value
...
@_utilities.lift_output_func(get_kafka_triggers)
def get_kafka_triggers_output(function_id: Optional[pulumi.Input[str]] = None,
                              name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                              output_file: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKafkaTriggersResult]:
    """
    Use this data source to query detailed information of vefaas kafka triggers
    ## Example Usage
