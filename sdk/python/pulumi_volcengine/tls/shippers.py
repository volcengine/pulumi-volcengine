...
__all__ = [
    'ShippersResult',
    'AwaitableShippersResult',
    'shippers',
    'shippers_output',
]

warnings.warn("""volcengine.tls.Shippers has been deprecated in favor of volcengine.tls.getShippers""", DeprecationWarning)

@pulumi.output_type
class ShippersResult:
    """
    ...
    @property
    @pulumi.getter
    def shippers(self) -> Sequence['outputs.ShippersShipperResult']:
        """
...
class AwaitableShippersResult(ShippersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ShippersResult(
...
def shippers(iam_project_name: Optional[str] = None,
             ...
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableShippersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/shippers:Shippers', __args__, opts=opts, typ=ShippersResult).value

    return AwaitableShippersResult(
...
@_utilities.lift_output_func(shippers)
def shippers_output(iam_project_name: Optional[pulumi.Input[Optional[str]]] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ShippersResult]:
    """
    Use this data source to query detailed information of tls shippers
    ## Example Usage
