...
class GetHostsResult:
    ...
    def host_infos(self) -> Sequence['outputs.GetHostsHostInfoResult']:
        """
...
def get_hosts(heartbeat_status: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/getHosts:getHosts', __args__, opts=opts, typ=GetHostsResult).value
...
def get_hosts_output(heartbeat_status: Optional[pulumi.Input[Optional[int]]] = None,
