...
class GetShardsResult:
    ...
    @property
    @pulumi.getter
    def shards(self) -> Sequence['outputs.GetShardsShardResult']:
        """
...
def get_shards(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/getShards:getShards', __args__, opts=opts, typ=GetShardsResult).value
...
def get_shards_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
