...
__all__ = [
    'EtlTasksResult',
    'AwaitableEtlTasksResult',
    'etl_tasks',
    'etl_tasks_output',
]

warnings.warn("""volcengine.tls.EtlTasks has been deprecated in favor of volcengine.tls.getEtlTasks""", DeprecationWarning)

@pulumi.output_type
class EtlTasksResult:
    """
    ...
    @property
    @pulumi.getter
    def tasks(self) -> Sequence['outputs.EtlTasksTaskResult']:
        """
...
class AwaitableEtlTasksResult(EtlTasksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return EtlTasksResult(
...
def etl_tasks(iam_project_name: Optional[str] = None,
              ...
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableEtlTasksResult:
    """
    ...
    """
    pulumi.log.warn("""etl_tasks is deprecated: volcengine.tls.EtlTasks has been deprecated in favor of volcengine.tls.getEtlTasks""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/etlTasks:EtlTasks', __args__, opts=opts, typ=EtlTasksResult).value

    return AwaitableEtlTasksResult(
...
@_utilities.lift_output_func(etl_tasks)
def etl_tasks_output(iam_project_name: Optional[pulumi.Input[Optional[str]]] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[EtlTasksResult]:
    """
    Use this data source to query detailed information of tls etl tasks
    ## Example Usage
