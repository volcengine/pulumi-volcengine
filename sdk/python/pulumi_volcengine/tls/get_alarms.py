...
def get_alarms(alarm_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/getAlarms:getAlarms', __args__, opts=opts, typ=GetAlarmsResult).value
