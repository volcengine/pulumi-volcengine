...
__all__ = [
    ...
    'AwaitableGetCheckPointsResult',
    'get_check_points',
    'get_check_points_output',
]

@pulumi.output_type
class GetCheckPointsResult:
    """
    ...
    def check_points(self) -> Sequence['outputs.GetCheckPointsCheckPointResult']:
        """
...
class AwaitableGetCheckPointsResult(GetCheckPointsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCheckPointsResult(
...
def get_check_points(consumer_group_name: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCheckPointsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/getCheckPoints:getCheckPoints', __args__, opts=opts, typ=GetCheckPointsResult).value

    return AwaitableGetCheckPointsResult(
...
@_utilities.lift_output_func(get_check_points)
def get_check_points_output(consumer_group_name: Optional[pulumi.Input[Optional[str]]] = None,
                            output_file: Optional[pulumi.Input[Optional[str]]] = None,
                            project_id: Optional[pulumi.Input[str]] = None,
                            shard_id: Optional[pulumi.Input[str]] = None,
                            topic_id: Optional[pulumi.Input[str]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCheckPointsResult]:
    """
    Use this data source to query detailed information of tls check points
    ## Example Usage
