...
warnings.warn("""volcengine.tls.Tags has been deprecated in favor of volcengine.tls.getTags""", DeprecationWarning)
...
def tags(max_results: Optional[int] = None,
    ...
    :param Sequence[pulumi.InputType['TagsTagFilterArgs']] tag_filters: The tag filters.
    """
    pulumi.log.warn("""tags is deprecated: volcengine.tls.Tags has been deprecated in favor of volcengine.tls.getTags""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/tags:Tags', __args__, opts=opts, typ=TagsResult).value
...
def tags_output(max_results: Optional[pulumi.Input[Optional[int]]] = None,
