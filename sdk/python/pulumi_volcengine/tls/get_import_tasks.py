...
__all__ = [
    'GetImportTasksResult',
    'AwaitableGetImportTasksResult',
    'get_import_tasks',
    'get_import_tasks_output',
]

@pulumi.output_type
class GetImportTasksResult:
    """
    ...
    def task_infos(self) -> Sequence['outputs.GetImportTasksTaskInfoResult']:
        """
...
class AwaitableGetImportTasksResult(GetImportTasksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetImportTasksResult(
...
def get_import_tasks(iam_project_name: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImportTasksResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:tls/getImportTasks:getImportTasks', __args__, opts=opts, typ=GetImportTasksResult).value

    return AwaitableGetImportTasksResult(
...
@_utilities.lift_output_func(get_import_tasks)
def get_import_tasks_output(iam_project_name: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetImportTasksResult]:
    """
    Use this data source to query detailed information of tls import tasks
    ## Example Usage
