...
class GetCertificatesResult:
    ...
    def cert_infos(self) -> Sequence['outputs.GetCertificatesCertInfoResult']:
        """
...
def get_certificates(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:cdn/getCertificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value
...
def get_certificates_output(name: Optional[pulumi.Input[Optional[str]]] = None,
