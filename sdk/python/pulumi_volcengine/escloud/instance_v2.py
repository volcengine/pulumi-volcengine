...
class InstanceV2Args:
    def __init__(__self__, *,
                 ...
                 node_specs_assigns: pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]],
                 ...
                 network_specs: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NetworkSpecArgs']]]] = None,
                 period: Optional[pulumi.Input[int]] = None,
                 project_name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2TagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]] node_specs_assigns: The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceV2NetworkSpecArgs']]] network_specs: The public network config of the ESCloud instance.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceV2TagArgs']]] tags: Tags.
        """
    ...
    def node_specs_assigns(self) -> pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]]:
        """
    ...
    def node_specs_assigns(self, value: pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]]):
    ...
    def network_specs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NetworkSpecArgs']]]]:
        """
    ...
    def network_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NetworkSpecArgs']]]]):
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2TagArgs']]]]:
        """
        Tags.
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2TagArgs']]]]):
...
class _InstanceV2State:
    def __init__(__self__, *,
                 ...
                 maintenance_time: Optional[pulumi.Input[str]] = None,
                 network_specs: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NetworkSpecArgs']]]] = None,
                 node_specs_assigns: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]]] = None,
                 period: Optional[pulumi.Input[int]] = None,
                 project_name: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter(name="nodeSpecsAssigns")
    def node_specs_assigns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]]]:
        """
        The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
        """
        return pulumi.get(self, "node_specs_assigns")
    ...
    @node_specs_assigns.setter
    def node_specs_assigns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceV2NodeSpecsAssignArgs']]]]):
        pulumi.set(self, "node_specs_assigns", value)
...
class InstanceV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 maintenance_days: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 maintenance_time: Optional[pulumi.Input[str]] = None,
                 network_specs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2NetworkSpecArgs']]]]] = None,
                 node_specs_assigns: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2NodeSpecsAssignArgs']]]]] = None,
                 period: Optional[pulumi.Input[int]] = None,
                 project_name: Optional[pulumi.Input[str]] = None,
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2TagArgs']]]]] = None,
                 version: Optional[pulumi.Input[str]] = None,
                 zone_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] maintenance_days: The maintainable day for the instance. Valid values: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`. Works only on modified scenes.
        :param pulumi.Input[str] maintenance_time: The maintainable time period for the instance. Works only on modified scenes.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2NetworkSpecArgs']]]] network_specs: The public network config of the ESCloud instance.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2NodeSpecsAssignArgs']]]] node_specs_assigns: The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
        :param pulumi.Input[int] period: Purchase duration in prepaid scenarios. Unit: Monthly.
        :param pulumi.Input[str] project_name: The project name to which the ESCloud instance belongs.
        :param pulumi.Input[str] subnet_id: The id of subnet, the subnet must belong to the AZ selected.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2TagArgs']]]] tags: Tags.
        :param pulumi.Input[str] version: The version of instance. When creating ESCloud instance, the valid value is `V6_7` or `V7_10`. When creating OpenSearch instance, the valid value is `OPEN_SEARCH_2_9`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] zone_ids: The zone id of the ESCloud instance. Support specifying multiple availability zones.
               The first zone id is the primary availability zone, while the rest are backup availability zones.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="volcengine:escloud_v2/escloudInstanceV2:EscloudInstanceV2")])
        ...
        super(InstanceV2, __self__).__init__(
            'volcengine:escloud/instanceV2:InstanceV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceV2TagArgs']]]]] = None,
            version: Optional[pulumi.Input[str]] = None,
            zone_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'InstanceV2':
        """
    ...
    @property
    @pulumi.getter(name="networkSpecs")
    def network_specs(self) -> pulumi.Output[Optional[Sequence['outputs.InstanceV2NetworkSpec']]]:
        """
        The public network config of the ESCloud instance.
        """
        return pulumi.get(self, "network_specs")
    ...
    @property
    @pulumi.getter(name="nodeSpecsAssigns")
    def node_specs_assigns(self) -> pulumi.Output[Sequence['outputs.InstanceV2NodeSpecsAssign']]:
        """
        The number and configuration of various ESCloud instance node. Kibana NodeSpecsAssign should not be modified.
        """
        return pulumi.get(self, "node_specs_assigns")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.InstanceV2Tag']]]:
        """
        Tags.
        """
        return pulumi.get(self, "tags")
