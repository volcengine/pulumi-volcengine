...
class GetInstancesV2Result:
    ...
    @property
    @pulumi.getter
    def instances(self) -> Sequence['outputs.GetInstancesV2InstanceResult']:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetInstancesV2TagResult']]:
...
def get_instances_v2(charge_types: Optional[Sequence[str]] = None,
                     ids: Optional[Sequence[str]] = None,
                     instance_names: Optional[Sequence[str]] = None,
                     output_file: Optional[str] = None,
                     project_name: Optional[str] = None,
                     statuses: Optional[Sequence[str]] = None,
                     tags: Optional[Sequence[pulumi.InputType['GetInstancesV2TagArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:escloud/getInstancesV2:getInstancesV2', __args__, opts=opts, typ=GetInstancesV2Result).value
...
@_utilities.lift_output_func(get_instances_v2)
def get_instances_v2_output(charge_types: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            instance_names: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            output_file: Optional[pulumi.Input[Optional[str]]] = None,
                            project_name: Optional[pulumi.Input[Optional[str]]] = None,
                            statuses: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetInstancesV2TagArgs']]]]] = None,
                            versions: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            zone_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInstancesV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
