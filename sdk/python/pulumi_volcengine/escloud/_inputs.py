...
@pulumi.input_type
class InstanceV2NetworkSpecArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class InstanceV2NodeSpecsAssignArgs:
    def __init__(__self__, *,
                 number: pulumi.Input[int],
                 resource_spec_name: pulumi.Input[str],
                 ...
                 type: pulumi.Input[str],
                 extra_performance: Optional[pulumi.Input['InstanceV2NodeSpecsAssignExtraPerformanceArgs']] = None):
        """
        :param pulumi.Input[int] number: The number of node.
        ...
        :param pulumi.Input['InstanceV2NodeSpecsAssignExtraPerformanceArgs'] extra_performance: The extra performance of FlexPL storage spec.
        """
        pulumi.set(__self__, "number", number)
        pulumi.set(__self__, "resource_spec_name", resource_spec_name)
        pulumi.set(__self__, "storage_size", storage_size)
    ...
    def extra_performance(self) -> Optional[pulumi.Input['InstanceV2NodeSpecsAssignExtraPerformanceArgs']]:
        """
...
@pulumi.input_type
class InstanceV2NodeSpecsAssignExtraPerformanceArgs:
    def __init__(__self__, *,
