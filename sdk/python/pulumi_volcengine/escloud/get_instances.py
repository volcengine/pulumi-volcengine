...
def get_instances(charge_types: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:escloud/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(charge_types: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
