...
warnings.warn("""volcengine.nlb.ServerGroups has been deprecated in favor of volcengine.nlb.getServerGroups""", DeprecationWarning)
...
def server_groups(instance_ids: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""server_groups is deprecated: volcengine.nlb.ServerGroups has been deprecated in favor of volcengine.nlb.getServerGroups""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nlb/serverGroups:ServerGroups', __args__, opts=opts, typ=ServerGroupsResult).value
...
def server_groups_output(instance_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
