...
class GetNetworkLoadBalancersResult:
    ...
    def network_load_balancers(self) -> Sequence['outputs.GetNetworkLoadBalancersNetworkLoadBalancerResult']:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetNetworkLoadBalancersTagResult']]:
...
def get_network_load_balancers(ip_address_version: Optional[str] = None,
                               ...
                               tags: Optional[Sequence[pulumi.InputType['GetNetworkLoadBalancersTagArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nlb/getNetworkLoadBalancers:getNetworkLoadBalancers', __args__, opts=opts, typ=GetNetworkLoadBalancersResult).value
...
def get_network_load_balancers_output(ip_address_version: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNetworkLoadBalancersTagArgs']]]]] = None,
