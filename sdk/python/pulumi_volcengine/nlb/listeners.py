...
warnings.warn("""volcengine.nlb.Listeners has been deprecated in favor of volcengine.nlb.getListeners""", DeprecationWarning)
...
def listeners(listener_ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nlb/listeners:Listeners', __args__, opts=opts, typ=ListenersResult).value
...
def listeners_output(listener_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
