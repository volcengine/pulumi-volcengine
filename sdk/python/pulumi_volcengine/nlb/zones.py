...
warnings.warn("""volcengine.nlb.Zones has been deprecated in favor of volcengine.nlb.getZones""", DeprecationWarning)
...
def zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:nlb/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
