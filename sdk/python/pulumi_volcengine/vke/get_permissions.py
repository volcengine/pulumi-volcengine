...
class GetPermissionsResult:
    ...
    def access_policies(self) -> Sequence['outputs.GetPermissionsAccessPolicyResult']:
        """
...
def get_permissions(cluster_ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vke/getPermissions:getPermissions', __args__, opts=opts, typ=GetPermissionsResult).value
...
def get_permissions_output(cluster_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
