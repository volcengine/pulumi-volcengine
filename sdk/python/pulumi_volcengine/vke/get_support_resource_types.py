...
def get_support_resource_types(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vke/getSupportResourceTypes:getSupportResourceTypes', __args__, opts=opts, typ=GetSupportResourceTypesResult).value
