...
class GetNodePoolsResult:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetNodePoolsTagResult']]:
        """
...
def get_node_pools(auto_scaling_enabled: Optional[bool] = None,
                   ...
                   tags: Optional[Sequence[pulumi.InputType['GetNodePoolsTagArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetNodePoolsTagArgs']] tags: Tags.
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vke/getNodePools:getNodePools', __args__, opts=opts, typ=GetNodePoolsResult).value
...
def get_node_pools_output(auto_scaling_enabled: Optional[pulumi.Input[Optional[bool]]] = None,
                          ...
                          tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNodePoolsTagArgs']]]]] = None,
