...
__all__ = [
    'GetListenerDomainExtensionsResult',
    'AwaitableGetListenerDomainExtensionsResult',
    'get_listener_domain_extensions',
    'get_listener_domain_extensions_output',
]

@pulumi.output_type
class GetListenerDomainExtensionsResult:
    """
    ...
    def domain_extensions(self) -> Sequence['outputs.GetListenerDomainExtensionsDomainExtensionResult']:
        """
...
class AwaitableGetListenerDomainExtensionsResult(GetListenerDomainExtensionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetListenerDomainExtensionsResult(
...
def get_listener_domain_extensions(listener_id: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetListenerDomainExtensionsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:alb/getListenerDomainExtensions:getListenerDomainExtensions', __args__, opts=opts, typ=GetListenerDomainExtensionsResult).value

    return AwaitableGetListenerDomainExtensionsResult(
...
@_utilities.lift_output_func(get_listener_domain_extensions)
def get_listener_domain_extensions_output(listener_id: Optional[pulumi.Input[str]] = None,
                                          output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetListenerDomainExtensionsResult]:
    """
    Use this data source to query detailed information of alb listener domain extensions
    ## Example Usage
