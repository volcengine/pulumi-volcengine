...
__all__ = [
    'InstancePluginsResult',
    'AwaitableInstancePluginsResult',
    'instance_plugins',
...
class InstancePluginsResult:
    ...
    @property
    @pulumi.getter
    def plugins(self) -> Sequence['outputs.InstancePluginsPluginResult']:
        """
...
class AwaitableInstancePluginsResult(InstancePluginsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return InstancePluginsResult(
            id=self.id,
...
def instance_plugins(instance_id: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableInstancePluginsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rabbitmq/instancePlugins:InstancePlugins', __args__, opts=opts, typ=InstancePluginsResult).value

    return AwaitableInstancePluginsResult(
...
@_utilities.lift_output_func(instance_plugins)
def instance_plugins_output(instance_id: Optional[pulumi.Input[str]] = None,
                            name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                            output_file: Optional[pulumi.Input[Optional[str]]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[InstancePluginsResult]:
    """
    Use this data source to query detailed information of rabbitmq instance plugins
    ## Example Usage
