...
class InstancesResult:
    ...
    def rabbitmq_instances(self) -> Sequence['outputs.InstancesRabbitmqInstanceResult']:
        """
...
def instances(charge_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rabbitmq/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
