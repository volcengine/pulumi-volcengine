...
warnings.warn("""volcengine.rabbitmq.Zones has been deprecated in favor of volcengine.rabbitmq.getZones""", DeprecationWarning)
...
def zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rabbitmq/zones:Zones', __args__, opts=opts, typ=ZonesResult).value
