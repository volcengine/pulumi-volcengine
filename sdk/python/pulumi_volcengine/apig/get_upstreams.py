...
class GetUpstreamsResult:
    ...
    @property
    @pulumi.getter
    def upstreams(self) -> Sequence['outputs.GetUpstreamsUpstreamResult']:
        """
...
def get_upstreams(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:apig/getUpstreams:getUpstreams', __args__, opts=opts, typ=GetUpstreamsResult).value
...
def get_upstreams_output(gateway_id: Optional[pulumi.Input[Optional[str]]] = None,
