...
__all__ = [
    ...
    'AwaitableUpstreamSourcesResult',
    'upstream_sources',
    'upstream_sources_output',
]

warnings.warn("""volcengine.apig.UpstreamSources has been deprecated in favor of volcengine.apig.getUpstreamSources""", DeprecationWarning)
...
class UpstreamSourcesResult:
    ...
    def upstream_sources(self) -> Sequence['outputs.UpstreamSourcesUpstreamSourceResult']:
        """
...
class AwaitableUpstreamSourcesResult(UpstreamSourcesResult):
...
def upstream_sources(enable_ingress: Optional[bool] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableUpstreamSourcesResult:
    """
    ...
    """
    pulumi.log.warn("""upstream_sources is deprecated: volcengine.apig.UpstreamSources has been deprecated in favor of volcengine.apig.getUpstreamSources""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:apig/upstreamSources:UpstreamSources', __args__, opts=opts, typ=UpstreamSourcesResult).value

    return AwaitableUpstreamSourcesResult(
...
@_utilities.lift_output_func(upstream_sources)
def upstream_sources_output(enable_ingress: Optional[pulumi.Input[Optional[bool]]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[UpstreamSourcesResult]:
    """
    Use this data source to query detailed information of apig upstream sources
    ## Example Usage
