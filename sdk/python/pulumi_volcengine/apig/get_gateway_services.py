...
class GetGatewayServicesResult:
    ...
    def gateway_services(self) -> Sequence['outputs.GetGatewayServicesGatewayServiceResult']:
        """
...
def get_gateway_services(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:apig/getGatewayServices:getGatewayServices', __args__, opts=opts, typ=GetGatewayServicesResult).value
...
def get_gateway_services_output(gateway_id: Optional[pulumi.Input[Optional[str]]] = None,
