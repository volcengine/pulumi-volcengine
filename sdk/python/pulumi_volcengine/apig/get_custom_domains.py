...
def get_custom_domains(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:apig/getCustomDomains:getCustomDomains', __args__, opts=opts, typ=GetCustomDomainsResult).value
...
def get_custom_domains_output(gateway_id: Optional[pulumi.Input[Optional[str]]] = None,
