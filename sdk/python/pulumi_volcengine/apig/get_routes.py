...
def get_routes(gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:apig/getRoutes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value
...
def get_routes_output(gateway_id: Optional[pulumi.Input[Optional[str]]] = None,
