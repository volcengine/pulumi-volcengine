...
class GetInstancesResult:
    ...
    def rocketmq_instances(self) -> Sequence['outputs.GetInstancesRocketmqInstanceResult']:
        """
...
def get_instances(charge_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rocketmq/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
