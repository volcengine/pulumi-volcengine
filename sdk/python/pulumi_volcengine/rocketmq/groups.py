...
class GroupsResult:
    ...
    def rocketmq_groups(self) -> Sequence['outputs.GroupsRocketmqGroupResult']:
        """
...
def groups(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rocketmq/groups:Groups', __args__, opts=opts, typ=GroupsResult).value
