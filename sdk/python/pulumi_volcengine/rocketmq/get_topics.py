...
class GetTopicsResult:
    ...
    def rocketmq_topics(self) -> Sequence['outputs.GetTopicsRocketmqTopicResult']:
        """
...
def get_topics(instance_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rocketmq/getTopics:getTopics', __args__, opts=opts, typ=GetTopicsResult).value
