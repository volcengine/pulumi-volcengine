...
class AccessKeysResult:
    ...
    def access_keys(self) -> Sequence['outputs.AccessKeysAccessKeyResult']:
        """
...
def access_keys(access_key: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rocketmq/accessKeys:AccessKeys', __args__, opts=opts, typ=AccessKeysResult).value
...
def access_keys_output(access_key: Optional[pulumi.Input[Optional[str]]] = None,
