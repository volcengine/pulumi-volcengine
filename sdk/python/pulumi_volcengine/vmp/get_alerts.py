...
def get_alerts(alerting_rule_ids: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/getAlerts:getAlerts', __args__, opts=opts, typ=GetAlertsResult).value
...
def get_alerts_output(alerting_rule_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
