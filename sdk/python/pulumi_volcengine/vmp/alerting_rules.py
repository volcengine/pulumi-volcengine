...
__all__ = [
    'AlertingRulesResult',
    'AwaitableAlertingRulesResult',
    'alerting_rules',
    'alerting_rules_output',
]

warnings.warn("""volcengine.vmp.AlertingRules has been deprecated in favor of volcengine.vmp.getAlertingRules""", DeprecationWarning)

@pulumi.output_type
class AlertingRulesResult:
    """
    ...
    def alerting_rules(self) -> Sequence['outputs.AlertingRulesAlertingRuleResult']:
        """
...
class AwaitableAlertingRulesResult(AlertingRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return AlertingRulesResult(
...
def alerting_rules(ids: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""alerting_rules is deprecated: volcengine.vmp.AlertingRules has been deprecated in favor of volcengine.vmp.getAlertingRules""")
    __args__ = dict()
    __args__['ids'] = ids
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/alertingRules:AlertingRules', __args__, opts=opts, typ=AlertingRulesResult).value

    return AwaitableAlertingRulesResult(
...
@_utilities.lift_output_func(alerting_rules)
def alerting_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
