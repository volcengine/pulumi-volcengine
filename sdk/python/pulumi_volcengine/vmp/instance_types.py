...
warnings.warn("""volcengine.vmp.InstanceTypes has been deprecated in favor of volcengine.vmp.getInstanceTypes""", DeprecationWarning)
...
class InstanceTypesResult:
    ...
    def instance_types(self) -> Sequence['outputs.InstanceTypesInstanceTypeResult']:
        """
...
def instance_types(ids: Optional[Sequence[str]] = None,
    ...
    """
    pulumi.log.warn("""instance_types is deprecated: volcengine.vmp.InstanceTypes has been deprecated in favor of volcengine.vmp.getInstanceTypes""")
    __args__ = dict()
    __args__['ids'] = ids
    __args__['outputFile'] = output_file
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/instanceTypes:InstanceTypes', __args__, opts=opts, typ=InstanceTypesResult).value
