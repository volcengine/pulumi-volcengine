...
warnings.warn("""volcengine.vmp.Rules has been deprecated in favor of volcengine.vmp.getRules""", DeprecationWarning)
...
def rules(kind: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/rules:Rules', __args__, opts=opts, typ=RulesResult).value
...
def rules_output(kind: Optional[pulumi.Input[str]] = None,
