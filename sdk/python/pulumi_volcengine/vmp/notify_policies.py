...
__all__ = [
    'NotifyPoliciesResult',
    'AwaitableNotifyPoliciesResult',
    'notify_policies',
    'notify_policies_output',
]

warnings.warn("""volcengine.vmp.NotifyPolicies has been deprecated in favor of volcengine.vmp.getNotifyPolicies""", DeprecationWarning)

@pulumi.output_type
class NotifyPoliciesResult:
    """
    ...
    def notify_policies(self) -> Sequence['outputs.NotifyPoliciesNotifyPolicyResult']:
        """
...
class AwaitableNotifyPoliciesResult(NotifyPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return NotifyPoliciesResult(
...
def notify_policies(channel_notify_template_ids: Optional[Sequence[str]] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableNotifyPoliciesResult:
    """
    ...
    """
    pulumi.log.warn("""notify_policies is deprecated: volcengine.vmp.NotifyPolicies has been deprecated in favor of volcengine.vmp.getNotifyPolicies""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/notifyPolicies:NotifyPolicies', __args__, opts=opts, typ=NotifyPoliciesResult).value

    return AwaitableNotifyPoliciesResult(
...
@_utilities.lift_output_func(notify_policies)
def notify_policies_output(channel_notify_template_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                           contact_group_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                           ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                           name: Optional[pulumi.Input[Optional[str]]] = None,
                           output_file: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[NotifyPoliciesResult]:
    """
    Use this data source to query detailed information of vmp notify policies
    ## Example Usage
