...
__all__ = [
    'RuleFilesResult',
    'AwaitableRuleFilesResult',
    'rule_files',
    'rule_files_output',
]

warnings.warn("""volcengine.vmp.RuleFiles has been deprecated in favor of volcengine.vmp.getRuleFiles""", DeprecationWarning)

@pulumi.output_type
class RuleFilesResult:
    """
    ...
    @property
    @pulumi.getter
    def files(self) -> Sequence['outputs.RuleFilesFileResult']:
        """
...
class AwaitableRuleFilesResult(RuleFilesResult):
...
def rule_files(ids: Optional[Sequence[str]] = None,
               name: Optional[str] = None,
               output_file: Optional[str] = None,
               status: Optional[str] = None,
               workspace_id: Optional[str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableRuleFilesResult:
    """
    ...
    """
    pulumi.log.warn("""rule_files is deprecated: volcengine.vmp.RuleFiles has been deprecated in favor of volcengine.vmp.getRuleFiles""")
    __args__ = dict()
    __args__['ids'] = ids
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/ruleFiles:RuleFiles', __args__, opts=opts, typ=RuleFilesResult).value

    return AwaitableRuleFilesResult(
...
@_utilities.lift_output_func(rule_files)
def rule_files_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                      name: Optional[pulumi.Input[Optional[str]]] = None,
                      output_file: Optional[pulumi.Input[Optional[str]]] = None,
                      status: Optional[pulumi.Input[Optional[str]]] = None,
                      workspace_id: Optional[pulumi.Input[str]] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[RuleFilesResult]:
    """
    Use this data source to query detailed information of vmp rule files
    ## Example Usage
