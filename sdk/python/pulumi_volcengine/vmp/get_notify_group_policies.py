...
__all__ = [
    'GetNotifyGroupPoliciesResult',
    'AwaitableGetNotifyGroupPoliciesResult',
    'get_notify_group_policies',
    'get_notify_group_policies_output',
]

@pulumi.output_type
class GetNotifyGroupPoliciesResult:
    """
    ...
    def notify_policies(self) -> Sequence['outputs.GetNotifyGroupPoliciesNotifyPolicyResult']:
        """
...
class AwaitableGetNotifyGroupPoliciesResult(GetNotifyGroupPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNotifyGroupPoliciesResult(
            id=self.id,
            ids=self.ids,
            name=self.name,
...
def get_notify_group_policies(ids: Optional[Sequence[str]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNotifyGroupPoliciesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/getNotifyGroupPolicies:getNotifyGroupPolicies', __args__, opts=opts, typ=GetNotifyGroupPoliciesResult).value

    return AwaitableGetNotifyGroupPoliciesResult(
...
@_utilities.lift_output_func(get_notify_group_policies)
def get_notify_group_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                     name: Optional[pulumi.Input[Optional[str]]] = None,
                                     output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNotifyGroupPoliciesResult]:
    """
    Use this data source to query detailed information of vmp notify group policies
    ## Example Usage
