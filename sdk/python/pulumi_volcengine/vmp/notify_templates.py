...
__all__ = [
    'NotifyTemplatesResult',
    'AwaitableNotifyTemplatesResult',
    'notify_templates',
    'notify_templates_output',
]

warnings.warn("""volcengine.vmp.NotifyTemplates has been deprecated in favor of volcengine.vmp.getNotifyTemplates""", DeprecationWarning)

@pulumi.output_type
class NotifyTemplatesResult:
    """
    ...
    def notify_templates(self) -> Sequence['outputs.NotifyTemplatesNotifyTemplateResult']:
        """
...
class AwaitableNotifyTemplatesResult(NotifyTemplatesResult):
...
def notify_templates(channel: Optional[str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableNotifyTemplatesResult:
    """
    ...
    """
    pulumi.log.warn("""notify_templates is deprecated: volcengine.vmp.NotifyTemplates has been deprecated in favor of volcengine.vmp.getNotifyTemplates""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:vmp/notifyTemplates:NotifyTemplates', __args__, opts=opts, typ=NotifyTemplatesResult).value

    return AwaitableNotifyTemplatesResult(
...
@_utilities.lift_output_func(notify_templates)
def notify_templates_output(channel: Optional[pulumi.Input[Optional[str]]] = None,
                            ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                            name: Optional[pulumi.Input[Optional[str]]] = None,
                            name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                            output_file: Optional[pulumi.Input[Optional[str]]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[NotifyTemplatesResult]:
    """
    Use this data source to query detailed information of vmp notify templates
    ## Example Usage
