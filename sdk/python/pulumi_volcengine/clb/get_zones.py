...
class GetZonesResult:
    ...
    def master_zones(self) -> Sequence['outputs.GetZonesMasterZoneResult']:
        """
...
def get_zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:clb/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
