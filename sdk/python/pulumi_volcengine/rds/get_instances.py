...
class GetInstancesResult:
    ...
    def rds_instances(self) -> Sequence['outputs.GetInstancesRdsInstanceResult']:
        """
...
def get_instances(create_end_time: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(create_end_time: Optional[pulumi.Input[Optional[str]]] = None,
