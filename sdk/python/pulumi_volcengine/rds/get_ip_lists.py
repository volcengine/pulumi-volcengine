...
__all__ = [
    'GetIpListsResult',
    'AwaitableGetIpListsResult',
    'get_ip_lists',
    'get_ip_lists_output',
]

@pulumi.output_type
class GetIpListsResult:
    """
    ...
    def rds_ip_lists(self) -> Sequence['outputs.GetIpListsRdsIpListResult']:
        """
...
class AwaitableGetIpListsResult(GetIpListsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIpListsResult(
            id=self.id,
...
def get_ip_lists(instance_id: Optional[str] = None,
                 name_regex: Optional[str] = None,
                 output_file: Optional[str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIpListsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds/getIpLists:getIpLists', __args__, opts=opts, typ=GetIpListsResult).value

    return AwaitableGetIpListsResult(
...
@_utilities.lift_output_func(get_ip_lists)
def get_ip_lists_output(instance_id: Optional[pulumi.Input[str]] = None,
                        name_regex: Optional[pulumi.Input[Optional[str]]] = None,
                        output_file: Optional[pulumi.Input[Optional[str]]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIpListsResult]:
    """
    (Deprecated! Recommend use volcengine_rds_mysql_*** replace) Use this data source to query detailed information of rds ip lists
    ## Example Usage
