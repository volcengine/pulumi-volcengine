...
class GetAccountsResult:
    ...
    def rds_accounts(self) -> Sequence['outputs.GetAccountsRdsAccountResult']:
        """
...
def get_accounts(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcengine:rds/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult).value
